try {
  !(function () {
    ...
    n &&
      ...
      (e._sentryDebugIds[n] = "bbb949eb-3e52-48e6-8ef8-e6edbc0880e6"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-bbb949eb-3e52-48e6-8ef8-e6edbc0880e6"));
  })();
} catch (e) {}
("use strict");
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6295],
  {
	...
	return dot( weights, rgb );
        ...
        let A = R + a + m,
          b = R + l + h,
          C = eK(f, f.VERTEX_SHADER, A),
          L = eK(f, f.FRAGMENT_SHADER, b);
        function P(n) {
          if (e.debug.checkShaderErrors) {
            let t = f.getProgramInfoLog(x) || "",
              r = f.getShaderInfoLog(C) || "",
            ...
            if (!1 === f.getProgramParameter(x, f.LINK_STATUS))
              if (((d = !1), "function" == typeof e.debug.onShaderError))
        ...
        return {
          getParameters: function (o, c, f, v, E) {
            let S,
              ...
              L = C && C.mapping === r.Om ? C.image.height : null,
              P = _[o.type];
            null !== o.precision &&
        ...
        function q(n, t, r) {
          n
            ? (H(e.POLYGON_OFFSET_FILL),
              (C !== t || L !== r) && (e.polygonOffset(t, r), (C = t), (L = r)))
      ...
      function ng(e, n, t, i, a, o, l) {
        ...
        function b(n, r) {
          ...
          if (
            ...
            if (null === e)
              ...
              if (!1 !== e.complete) return void I(a, n, r);
              console.warn(
        ...
        function F(n) {
          ...
          if (n.depthTexture && !r.__autoAllocateDepthBuffer) {
            ...
            e && e.length > 0
              ? O(r.__webglFramebuffer[0], n)
              : O(r.__webglFramebuffer, n);
          } else if (a) {
        ...
        constructor(e, n) {
          ...
          function w() {
            a.removeEventListener("select", D),
              ...
              a.removeEventListener("inputsourceschange", I);
            for (let e = 0; e < T.length; e++) {
              let n = M[e];
              null !== n && ((M[e] = null), T[e].disconnect(n));
            }
            for (let e in ((P = null), (U = null), _.reset(), g)) delete g[e];
            e.setRenderTarget(E),
              (m = null),
              (p = null),
              (f = null),
            ...
            (this.setSession = async function (i) {
              if (null !== (a = i)) {
                if (
                  ...
                  a.addEventListener("inputsourceschange", I),
                  !0 !== v.xrCompatible && (await n.makeXRCompatible()),
                  (R = e.getPixelRatio()),
                  e.getSize(x),
                  ...
                  let t = null,
                    ...
                    l = null;
                  v.depth &&
                    ((l = v.stencil ? n.DEPTH24_STENCIL8 : n.DEPTH_COMPONENT24),
                    (t = v.stencil ? r.dcC : r.zdS),
                    (i = v.stencil ? r.V3x : r.bkx));
                  let s = {
                    colorFormat: n.RGBA8,
                    depthFormat: l,
                    scaleFactor: o,
                  ...
                  (p = f.createProjectionLayer(s)),
                    ...
                    (S = new r.nWS(p.textureWidth, p.textureHeight, {
                      format: r.GWd,
                      type: r.OUM,
                  ...
                  (m = new XRWebGLLayer(a, n, t)),
                    ...
                    (S = new r.nWS(m.framebufferWidth, m.framebufferHeight, {
                      format: r.GWd,
                      type: r.OUM,
                      colorSpace: e.outputColorSpace,
                      stencilBuffer: v.stencil,
          ...
          (this.updateCamera = function (e) {
            ...
            null !== _.texture &&
              ...
              (A.layers.mask = 3 & L.layers.mask),
              (b.layers.mask = 5 & L.layers.mask);
            let s = e.parent,
              c = L.cameras;
            O(L, s);
          ...
          let F = null,
            B = new i();
          B.setAnimationLoop(function (n, i) {
            if (((u = i.getViewerPose(d || l)), (h = i), null !== u)) {
              ...
              if (
                ...
                let e = f.getDepthInformation(n[0]);
                e && e.isValid && e.texture && _.init(e, a.renderState);
              }
              if (
                i &&
                i.includes("camera-access") &&
                (e.state.unbindTexture(), f)
              )
      ...
      function nb(e, n) {
        ...
        return {
          ...
          refreshMaterialUniforms: function (e, a, o, l, s) {
            var c, d, u, f, p, m, h, _, g, v, E, S, T, M, x, R, A, b, C, L, P;
        ...
        constructor(e = {}) {
          ...
          try {
            if (
              ...
              k.addEventListener("webglcontextlost", eB, !1),
              k.addEventListener("webglcontextrestored", eG, !1),
              k.addEventListener("webglcontextcreationerror", eH, !1),
              null === ey)
            ) {
              let e = "webgl2";
              if (
          ...
          function eV(e) {
            var n;
            let t = e.target;
            t.removeEventListener("dispose", eV),
              (function (e) {
          ...
          (this.xr = eF),
                ...
                if (e) {
                  ...
                  n
                    ? ((J[0] = a),
                      ...
                      (J[2] = l),
                      (J[3] = i),
                      ey.clearBufferuiv(ey.COLOR, 0, J))
                    : ((ee[0] = a),
                      (ee[1] = o),
                      (ee[2] = l),
                      (ee[3] = i),
                      ey.clearBufferiv(ey.COLOR, 0, ee));
                } else i |= ey.COLOR_BUFFER_BIT;
              }
              n && (i |= ey.DEPTH_BUFFER_BIT),
                t &&
                  ((i |= ey.STENCIL_BUFFER_BIT),
            ...
            (this.dispose = function () {
              k.removeEventListener("webglcontextlost", eB, !1),
                k.removeEventListener("webglcontextrestored", eG, !1),
                k.removeEventListener("webglcontextcreationerror", eH, !1),
                L.dispose(),
                R.dispose(),
                A.dispose(),
                c.dispose(),
                ...
                M.dispose(),
                eF.dispose(),
                eF.removeEventListener("sessionstart", ez),
                eF.removeEventListener("sessionend", eK),
                eq.stop();
            }),
                ...
                h = (function (e, n, t, i, a) {
                        ...
                        ? a.isSkinnedMesh && !1 === L.skinning
                          ...
                          ? (a.isInstancedMesh &&
                            ...
                            (void 0 !== L.numClippingPlanes &&
                              (L.numClippingPlanes !== b.numPlanes ||
                                L.numIntersection !== b.numIntersection)) ||
                            L.vertexAlphas !== g ||
                            L.vertexTangents !== E ||
                            L.morphTargets !== S ||
                            L.morphNormals !== T ||
                  ...
                  if (
                    ...
                    l.buffers.depth.getReversed() &&
                      ...
                      F.setValue(ey, "projectionMatrix", e.projectionMatrix),
                      F.setValue(ey, "viewMatrix", e.matrixWorldInverse);
                    let n = F.map.cameraPosition;
                    void 0 !== n &&
                      n.setValue(ey, eP.setFromMatrixPosition(e.matrixWorld)),
                  ...
                  if (a.isSkinnedMesh) {
                    F.setOptional(ey, a, "bindMatrix"),
                      F.setOptional(ey, a, "bindMatrixInverse");
                    let e = a.skeleton;
                    e &&
                      (null === e.boneTexture && e.computeBoneTexture(),
                      F.setValue(ey, "boneTexture", e.boneTexture, d));
                  }
                  a.isBatchedMesh &&
                    (F.setOptional(ey, a, "batchingTexture"),
                    F.setValue(ey, "batchingTexture", a._matricesTexture, d),
                    F.setOptional(ey, a, "batchingIdTexture"),
                    F.setValue(ey, "batchingIdTexture", a._indirectTexture, d),
                    F.setOptional(ey, a, "batchingColorTexture"),
                  ...
                  if (
                    ...
                    (N || L.receiveShadow !== a.receiveShadow) &&
                      ...
                      F.setValue(ey, "receiveShadow", a.receiveShadow)),
                    ...
                    N &&
                      ...
                      eX.upload(ey, e0(L), B, d)),
                    i.isShaderMaterial &&
                      !0 === i.uniformsNeedUpdate &&
                      (eX.upload(ey, e0(L), B, d), (i.uniformsNeedUpdate = !1)),
                    i.isSpriteMaterial && F.setValue(ey, "center", a.center),
                    F.setValue(ey, "modelViewMatrix", a.modelViewMatrix),
                    F.setValue(ey, "normalMatrix", a.normalMatrix),
                    F.setValue(ey, "modelMatrix", a.matrixWorld),
              ...
              if (
                ...
                void 0 === e && (e = 1),
                  ...
                  s.isLineSegments
                    ? L.setMode(ey.LINES)
                    : s.isLineLoop
                    ? L.setMode(ey.LINE_LOOP)
                    : L.setMode(ey.LINE_STRIP);
              } else
                s.isPoints
                  ? L.setMode(ey.POINTS)
                  : s.isSprite && L.setMode(ey.TRIANGLES);
              if (s.isBatchedMesh)
                if (null !== s._multiDrawInstances)
                  ...
                  for (let a = 0; a < t; a++)
                    i.setValue(ey, "_gl_DrawID", a), L.render(e[a] / r, n[a]);
                }
                  ...
                  (r &&
                    (void 0 !== e.boundingSphere
                      ? (null === e.boundingSphere && e.computeBoundingSphere(),
                        eU.copy(e.boundingSphere.center))
                      : (null === n.boundingSphere && n.computeBoundingSphere(),
                        eU.copy(n.boundingSphere.center)),
                    eU.applyMatrix4(e.matrixWorld).applyMatrix4(eL)),
                  Array.isArray(i))
                ) {
                  let r = n.groups;
                  for (let a = 0, o = r.length; a < o; a++) {
          ...
          function eZ(e, n, t) {
            ...
            for (let i = 0, a = e.length; i < a; i++) {
              ...
              !0 === c.allowOverride && null !== r && (c = r),
                o.layers.test(t.layers) && e$(o, n, t, l, c, s);
            }
          }
          ...
          eq.setAnimationLoop(function (e) {
            ...
            eF.addEventListener("sessionstart", ez),
            eF.addEventListener("sessionend", eK),
            (this.render = function (e, n) {
              ...
              if (
                ...
                !0 === eF.enabled &&
                  !0 === eF.isPresenting &&
                  (!0 === eF.cameraAutoUpdate && eF.updateCamera(n),
                  (n = eF.getCamera())),
                ...
                eA.setFromProjectionMatrix(eL, r.TdN, n.reversedDepth),
              ...
              eY(e, n, 0, ea.sortObjects),
                en.finish(),
                !0 === ea.sortObjects && en.sort(eS, eT),
                (ew =
                  !1 === eF.enabled ||
                  !1 === eF.isPresenting ||
                  !1 === eF.hasDepthSensing()) && L.addToRenderList(en, e),
              ...
              if ((et.setupLights(), n.isArrayCamera)) {
                let t = n.cameras;
                if (a.length > 0)
                  for (let n = 0, r = t.length; n < r; n++) eQ(i, a, e, t[n]);
                ew && L.render(e);
                ...
                a.length > 0 && eQ(i, a, e, n), ew && L.render(e), ej(en, e, n);
              null !== ec &&
                0 === es &&
          ...
          (this.setRenderTarget = function (e, n = 0, t = 0) {
            ...
            if (e) {
              ...
              if (void 0 !== s.__useDefaultFramebuffer)
                l.bindFramebuffer(ey.FRAMEBUFFER, null), (r = !1);
            ...
            if (
              (0 !== t && (i = e3),
              l.bindFramebuffer(ey.FRAMEBUFFER, i) && r && l.drawBuffers(e, i),
              l.viewport(ef),
              l.scissor(ep),
              l.setScissorTest(em),
              a)
              ...
              ey.framebufferTexture2D(
                ey.FRAMEBUFFER,
                ey.COLOR_ATTACHMENT0,
                ey.TEXTURE_CUBE_MAP_POSITIVE_X + n,
                r.__webglTexture,
                t
              );
            } else if (o)
              for (let r = 0; r < e.textures.length; r++) {
                ...
                ey.framebufferTextureLayer(
                  ey.FRAMEBUFFER,
                  ey.COLOR_ATTACHMENT0 + r,
                  i.__webglTexture,
                  t,
                  n
                );
            ...
            (this.readRenderTargetPixels = function (
              ...
              if (
                (e.isWebGLCubeRenderTarget && void 0 !== s && (u = u[s]), u)
              ) {
                ...
                try {
                  ...
                  n >= 0 &&
                    ...
                    t <= e.height - i &&
                    (e.textures.length > 1 &&
                      ey.readBuffer(ey.COLOR_ATTACHMENT0 + d),
                    ey.readPixels(n, t, r, i, w.convert(s), w.convert(c), a));
                } finally {
            ...
            (this.readRenderTargetPixelsAsync = async function (
              ...
              if ((e.isWebGLCubeRenderTarget && void 0 !== d && (f = f[d]), f))
                if (n >= 0 && n <= e.width - i && t >= 0 && t <= e.height - a) {
                  ...
                  ey.bindBuffer(ey.PIXEL_PACK_BUFFER, h),
                    ey.bufferData(
                      ey.PIXEL_PACK_BUFFER,
                      s.byteLength,
                      ey.STREAM_READ
                    ),
                    e.textures.length > 1 &&
                      ey.readBuffer(ey.COLOR_ATTACHMENT0 + u),
                    ey.readPixels(n, t, i, a, w.convert(p), w.convert(m), 0);
                  ...
                  return (
                    ey.flush(),
                    await (0, r.jej)(ey, g, 4),
                    ey.bindBuffer(ey.PIXEL_PACK_BUFFER, h),
                    ey.getBufferSubData(ey.PIXEL_PACK_BUFFER, 0, s),
                    ey.deleteBuffer(h),
                    ey.deleteSync(g),
                    s
                  );
            ...
            (this.copyFramebufferToTexture = function (e, n = null, t = 0) {
              let r = Math.pow(2, -t),
                ...
                s = null !== n ? n.y : 0;
              d.setTexture2D(e, 0),
                ey.copyTexSubImage2D(ey.TEXTURE_2D, t, 0, 0, o, s, i, a),
                l.unbindTexture();
            });
          let e2 = ey.createFramebuffer(),
          ...
          (this.copyTextureToTexture = function (
            ...
            let T = w.convert(n.format),
              M = w.convert(n.type);
            n.isData3DTexture
              ? (d.setTexture3D(n, 0), (E = ey.TEXTURE_3D))
              : n.isDataArrayTexture || n.isCompressedArrayTexture
              ? (d.setTexture2DArray(n, 0), (E = ey.TEXTURE_2D_ARRAY))
              : (d.setTexture2D(n, 0), (E = ey.TEXTURE_2D)),
              ey.pixelStorei(ey.UNPACK_FLIP_Y_WEBGL, n.flipY),
              ey.pixelStorei(
                ey.UNPACK_PREMULTIPLY_ALPHA_WEBGL,
                n.premultiplyAlpha
              ),
              ey.pixelStorei(ey.UNPACK_ALIGNMENT, n.unpackAlignment);
            let x = ey.getParameter(ey.UNPACK_ROW_LENGTH),
              ...
              b = ey.getParameter(ey.UNPACK_SKIP_ROWS),
              C = ey.getParameter(ey.UNPACK_SKIP_IMAGES);
            ey.pixelStorei(ey.UNPACK_ROW_LENGTH, S.width),
              ey.pixelStorei(ey.UNPACK_IMAGE_HEIGHT, S.height),
              ey.pixelStorei(ey.UNPACK_SKIP_PIXELS, p),
              ey.pixelStorei(ey.UNPACK_SKIP_ROWS, m),
              ey.pixelStorei(ey.UNPACK_SKIP_IMAGES, h);
            ...
            if (e.isDepthTexture) {
              ...
              l.bindFramebuffer(ey.READ_FRAMEBUFFER, i.__webglFramebuffer),
                l.bindFramebuffer(ey.DRAW_FRAMEBUFFER, d.__webglFramebuffer);
              for (let t = 0; t < f; t++)
                L &&
                  (ey.framebufferTextureLayer(
                    ey.READ_FRAMEBUFFER,
              ...
              l.bindFramebuffer(ey.READ_FRAMEBUFFER, null),
                l.bindFramebuffer(ey.DRAW_FRAMEBUFFER, null);
            } else if (0 !== a || e.isRenderTargetTexture || c.has(e)) {
              let t = c.get(e),
                r = c.get(n);
              l.bindFramebuffer(ey.READ_FRAMEBUFFER, e2),
                l.bindFramebuffer(ey.DRAW_FRAMEBUFFER, e4);
              for (let e = 0; e < f; e++)
                L
                  ? ey.framebufferTextureLayer(
                      ey.READ_FRAMEBUFFER,
                  ...
                  0 !== a
                    ...
                    : P
                    ? ey.copyTexSubImage3D(E, o, _, g, v + e, p, m, s, u)
                    : ey.copyTexSubImage2D(E, o, _, g, p, m, s, u);
              l.bindFramebuffer(ey.READ_FRAMEBUFFER, null),
                l.bindFramebuffer(ey.DRAW_FRAMEBUFFER, null);
            } else
              P
                ? e.isDataTexture || e.isData3DTexture
                  ? ey.texSubImage3D(E, o, _, g, v, s, u, f, T, M, S.data)
                  : n.isCompressedArrayTexture
                  ? ey.compressedTexSubImage3D(
                      E,
                      o,
                      _,
                      g,
                  ...
                  : ey.texSubImage3D(E, o, _, g, v, s, u, f, T, M, S)
                : e.isDataTexture
                ? ey.texSubImage2D(ey.TEXTURE_2D, o, _, g, s, u, T, M, S.data)
                : e.isCompressedTexture
                ? ey.compressedTexSubImage2D(
                    ey.TEXTURE_2D,
                    o,
                    _,
                    g,
                ...
                : ey.texSubImage2D(ey.TEXTURE_2D, o, _, g, s, u, T, M, S);
            ey.pixelStorei(ey.UNPACK_ROW_LENGTH, x),
              ey.pixelStorei(ey.UNPACK_IMAGE_HEIGHT, R),
              ey.pixelStorei(ey.UNPACK_SKIP_PIXELS, A),
              ey.pixelStorei(ey.UNPACK_SKIP_ROWS, b),
              ey.pixelStorei(ey.UNPACK_SKIP_IMAGES, C),
              0 === o && n.generateMipmaps && ey.generateMipmap(E),
              l.unbindTexture();
          }),
