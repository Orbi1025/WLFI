try {
  !(function () {
    ...
    e &&
      ...
      (t._sentryDebugIds[e] = "7eeac75a-1183-41c5-a505-699000a5d739"),
      (t._sentryDebugIdIdentifier =
        "sentry-dbid-7eeac75a-1183-41c5-a505-699000a5d739"));
  })();
} catch (t) {}
("use strict");
  ...
  [5715],
  {
    ...
    55715: (t, e, r) => {
      ...
      let n = r(99682),
        ...
        h = [],
        d = [];
      for (let t = 0, e = i, r = 1, n = 0; t < 24; t++) {
        ([r, n] = [n, (2 * r + 3 * n) % 5]),
          c.push(2 * (5 * n + r)),
          h.push((((t + 1) * (t + 2)) / 2) % 64);
        let o = s;
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        (e.hexToBytes = function (t) {
          ...
          for (let e = 0, o = 0; e < r; e++, o += 2) {
            let r = h(t.charCodeAt(o)),
              s = h(t.charCodeAt(o + 1));
        ...
        (e.kdfInputToBytes = function (t) {
          return "string" == typeof t && (t = p(t)), i(t), t;
        }),
    ...
    99682: (t, e) => {
      ...
      let i = (t, e) => (BigInt(t >>> 0) << n) | BigInt(e >>> 0);
      e.toBig = i;
      let a = (t, e, r) => t >>> r;
      e.shrSH = a;
      ...
      e.rotrSH = l;
      let f = (t, e, r) => (t << (32 - r)) | (e >>> r);
      e.rotrSL = f;
      let c = (t, e, r) => (t << (64 - r)) | (e >>> (r - 32));
      e.rotrBH = c;
      let h = (t, e, r) => (t >>> (r - 32)) | (e << (64 - r));
      e.rotrBL = h;
      let d = (t, e) => e;
      e.rotr32H = d;
      let p = (t, e) => t;
