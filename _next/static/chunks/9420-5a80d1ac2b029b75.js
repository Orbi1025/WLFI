try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "97dcca2b-f5c0-4327-878c-4055763d6530"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-97dcca2b-f5c0-4327-878c-4055763d6530"));
  })();
} catch (e) {}
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9420],
  {
    10408: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { randomBytes: () => n.p, shuffled: () => i.A });
      var n = r(8676),
        i = r(68697);
    },
    24559: (e, t, r) => {
      ...
      var n = r(95257),
        i = r(65738);
      let o = async (e, t, r) => {
        let o = await t.getNetwork();
        if (
          o.chainId === i.nU.zksync &&
          e.from &&
          "0x" !== (await t.getCode(e.from))
        )
          return n.gH.from(35e4);
        let a = await t.estimateGas(e);
        return o.chainId === i.nU.polygon
          ? a.add(a.mul(60).div(100))
          : a.add(a.mul(null != r ? r : 30).div(100));
      };
      var a = r(96654);
      class s {
        constructor(e, t) {
          (this.getContractInstance = (e) => (
            this.contractInstances[e] ||
              (this.contractInstances[e] = this.contractFactory.connect(
                e,
                this.provider
              )),
            this.contractInstances[e]
            ...
            (this.generateTxCallback =
              ...
              async () => {
                let u = Object.assign(Object.assign({}, await e()), {
                  from: t,
                  value: null != r ? r : a.pc,
                });
                return (
                  (u.gasLimit = await o(u, this.provider, i)),
                  s &&
                    a.ZD[s] &&
                    u.gasLimit.lte(n.gH.from(a.ZD[s].limit)) &&
                    (u.gasLimit = n.gH.from(a.ZD[s].recommended)),
                  u
                );
              }),
            (this.generateTxPriceEstimation =
              (e, t, r = i.ld.default) =>
              async (n = !1) => {
                let o = await this.provider.getGasPrice();
                if (!e.find((e) => e.txType === i.lY.ERC20_APPROVAL) || n) {
                  let { gasLimit: e, gasPrice: r } = await t();
                  if (!e) throw Error("Transaction calculation error");
                  return {
                    gasLimit: e.toString(),
                    gasPrice: r ? r.toString() : o.toString(),
                  };
                }
                return {
                  gasLimit: a.ZD[r].recommended,
                  gasPrice: o.toString(),
                };
              }),
            (this.estimateGasLimit = async ({
              tx: e,
              gasSurplus: t,
              action: r,
              skipGasEstimation: s,
              ...
              let u = r
                ? n.gH.from(a.ZD[r].limit)
                : n.gH.from(a.ZD[i.ld.default].limit);
              if (s) return (e.gasLimit = u), e;
              let d = n.gH.from("0");
              try {
                d = await o(
                  Object.assign(Object.assign({}, e), {
                    value: e.value ? e.value.toHexString() : a.pc,
                  }),
                  this.provider,
                  t
                );
              } catch (e) {}
              return d.gt(u) ? (e.gasLimit = d) : (e.gasLimit = u), e;
            }),
            (this.contractFactory = t),
            (this.provider = e),
    ...
    29233: (e, t, r) => {
      ...
      !(function (e) {
        !(function (t) {
          ...
          void 0 === n.Reflect ? (n.Reflect = e) : (i = o(n.Reflect, i)), t(i);
        })(function (e) {
              ...
              l || "function" != typeof WeakMap
                ? (function () {
                    ...
                    function o(e, n) {
                      if (!t.call(e, r)) {
                        if (!n) return;
                        Object.defineProperty(e, r, { value: d.create() });
                      }
                      return e[r];
                    }
                    function a(e, t) {
          ...
          e("decorate", function (e, t, r, n) {
            if (O(r)) {
              if (!j(e) || !_(t)) throw TypeError();
              for (var i = e, o = t, a = i.length - 1; a >= 0; --a) {
                var s = (0, i[a])(o);
                if (!O(s) && !A(s)) {
                  if (!_(s)) throw TypeError();
                  o = s;
                }
              }
              return o;
            }
            if (!j(e) || !E(t) || (!E(n) && !O(n) && !A(n))) throw TypeError();
            return (
              A(n) && (n = void 0),
              (function (e, t, r, n) {
            ...
            e("getMetadata", function (e, t, r) {
              ...
              return (
                O(r) || (r = w(r)),
                (function e(t, r, n) {
                  if (y(t, r, n)) return b(t, r, n);
                  var i = C(r);
                  if (!A(i)) return e(t, i, n);
                })(e, t, r)
              );
            }),
            e("getOwnMetadata", function (e, t, r) {
              if (!E(t)) throw TypeError();
              return O(r) || (r = w(r)), b(e, t, r);
            }),
            e("getMetadataKeys", function (e, t) {
              ...
              return (
                ...
                (function e(t, r) {
                  ...
                  for (var a = new p(), s = [], u = 0; u < n.length; u++) {
                    var d = n[u],
                      c = a.has(d);
                    c || (a.add(d), s.push(d));
                  }
            ...
            e("getOwnMetadataKeys", function (e, t) {
              if (!E(e)) throw TypeError();
              return O(t) || (t = w(t)), v(e, t);
            }),
            e("deleteMetadata", function (e, t, r) {
              if (!E(t)) throw TypeError();
              O(r) || (r = w(r));
              var n = m(t, r, !1);
              if (O(n) || !n.delete(e)) return !1;
    ...
    61454: (e, t, r) => {
      ...
      var n = r(13679),
        ...
        a = r(50887).Buffer;
      function s(e, t, r, i) {
        let a = Reflect.getOwnMetadata(o.eA, e, t);
        a &&
          a.forEach((e) => {
            if (e.field) {
              if (r[0][e.field] && !n.isAddress(r[0][e.field]))
                throw Error(
                  `Address: ${r[0][e.field]} is not a valid ethereum Address`
                );
            } else {
              let t = null == i ? void 0 : i[e.index];
              if (r[e.index] && !t && !n.isAddress(r[e.index]))
                throw Error(
                  `Address: ${r[e.index]} is not a valid ethereum Address`
                );
            }
          });
      }
      function u(e, t, r, i) {
        let a = Reflect.getOwnMetadata(o.nQ, e, t);
        a &&
          a.forEach((e) => {
            if (e.field)
              r[0][e.field] &&
                r[0][e.field].length > 0 &&
                r[0][e.field].forEach((e) => {
                  if (!n.isAddress(e))
                    throw Error(
                      `Address: ${e} is not a valid ethereum Address`
                    );
                });
            else {
              let t = null == i ? void 0 : i[e.index];
      ...
      function d(e, t, r, n) {
        let i = Reflect.getOwnMetadata(o._D, e, t);
        i &&
          i.forEach((e) => {
            if (e.field) {
              if (r[0][e.field] && !(Number(r[0][e.field]) > 0))
                throw Error(
                  `Amount: ${r[0][e.field]} needs to be greater than 0`
                );
            } else if (
              !(null == n ? void 0 : n[e.index]) &&
              !(Number(r[e.index]) > 0)
            )
              throw Error(`Amount: ${r[e.index]} needs to be greater than 0`);
          });
      }
      function c(e, t, r, n) {
        let i = Reflect.getOwnMetadata(o.Fb, e, t);
        i &&
          i.forEach((e) => {
            if (e.field) {
              if (r[0][e.field] && !(Number(r[0][e.field]) >= 0))
                throw Error(
                  `Amount: ${r[0][e.field]} needs to be greater or equal than 0`
                );
            } else if (
              !(null == n ? void 0 : n[e.index]) &&
              !(Number(r[e.index]) >= 0)
              ...
              throw Error(
                `Amount: ${r[e.index]} needs to be greater or equal than 0`
              );
          });
      }
      function l(e, t, r, n) {
        let i = Reflect.getOwnMetadata(o.FE, e, t);
        i &&
          i.forEach((e) => {
            if (e.field) {
              if (
                r[0][e.field] &&
                !(Number(r[0][e.field]) > 0 || "-1" === r[0][e.field])
              )
                throw Error(
                  `Amount: ${r[0][e.field]} needs to be greater than 0 or -1`
                );
            } else if (
              !(null == n ? void 0 : n[e.index]) &&
              !(Number(r[e.index]) > 0 || "-1" === r[e.index])
            )
              throw Error(
                `Amount: ${r[e.index]} needs to be greater than 0 or -1`
              );
          });
      }
      function f(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.lendingPoolAddress) &&
            n.isAddress(this.flashLiquidationAddress)
            ? (s(e, t, arguments),
              d(e, t, arguments),
              l(e, t, arguments),
      ...
      function p(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.poolAddress) &&
            n.isAddress(this.flashLiquidationAddress)
            ? (s(e, t, arguments),
              d(e, t, arguments),
              l(e, t, arguments),
      ...
      function h(e, t, r) {
        ...
        r.value = function () {
          return n.isAddress(this.lendingPoolAddress) &&
            n.isAddress(this.repayWithCollateralAddress)
            ? (s(e, t, arguments), d(e, t, arguments), i.apply(this, arguments))
            : (console.error(
      ...
      function m(e, t, r) {
        ...
        r.value = function () {
          return n.isAddress(this.lendingPoolAddress) &&
            n.isAddress(this.swapCollateralAddress)
            ? (s(e, t, arguments), d(e, t, arguments), i.apply(this, arguments))
            : (console.error(
        ...
        r.value = function () {
          return n.isAddress(this.lendingPoolAddress)
            ? (s(e, t, arguments),
              ...
              i.apply(this, arguments))
            : (console.error(
                "[LendingPoolValidator] You need to pass valid addresses"
              ),
              []);
        };
      }
      function v(e, t, r) {
        ...
        r.value = function () {
          if (
            !n.isAddress(this.l2PoolAddress) ||
            !n.isAddress(this.encoderAddress)
          )
            return (
              console.error(
          ...
          var r = arguments;
          let s = Reflect.getOwnMetadata(o.o8, e, t);
          return (
            s &&
              s.forEach((e) => {
                if (e.field) {
                  if (r[0][e.field] && a.byteLength(r[0][e.field], "utf8") > 32)
                    throw Error(
                      `Deadline: ${r[0][e.field]} is bigger than 32 bytes`
                    );
                } else if (r[e.index] && a.byteLength(r[e.index], "utf8") > 32)
                  throw Error(
                    `Deadline: ${r[e.index]} is bigger than 32 bytes`
                  );
              }),
            i.apply(this, arguments)
          );
        ...
        r.value = function () {
          return n.isAddress(this.poolAddress)
            ? (s(e, t, arguments),
              ...
              i.apply(this, arguments))
            : (console.error(
                "[PoolValidator] You need to pass valid addresses"
              ),
              []);
        };
      }
      function O(e, t, r) {
        let i = r.value;
        r.value = function () {
          if (!n.isAddress(this.uiIncentiveDataProviderAddress))
            throw (
              (console.error(
          ...
          return s(e, t, arguments), i.apply(this, arguments);
        };
      }
      function A(e, t, r) {
        let n = r.value;
        r.value = function () {
          return (
            s(e, t, arguments), u(e, t, arguments), n.apply(this, arguments)
          );
        };
      }
      function E(e, t, r) {
        ...
        r.value = function () {
          return (
            s(e, t, arguments), d(e, t, arguments), n.apply(this, arguments)
          );
        };
      }
      function w(e, t, r) {
      ...
      function S(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.liquiditySwapAdapterAddress)
            ? (s(e, t, arguments),
              d(e, t, arguments),
              l(e, t, arguments),
              i.apply(this, arguments))
      ...
      function _(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.withdrawAndSwitchAdapterAddress)
            ? (s(e, t, arguments),
              d(e, t, arguments),
              l(e, t, arguments),
              i.apply(this, arguments))
      ...
      function k(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.repayWithCollateralAddress)
            ? (s(e, t, arguments),
              d(e, t, arguments),
              l(e, t, arguments),
              i.apply(this, arguments))
      ...
      function C(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.stakingContractAddress)
            ? (s(e, t, arguments),
              d(e, t, arguments),
              l(e, t, arguments),
              i.apply(this, arguments))
            : (console.error(
                "[StakingValidator] You need to pass valid addresses"
              ),
              []);
        };
      }
      ...
      function T(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.faucetAddress)
            ? (s(e, t, arguments), d(e, t, arguments), i.apply(this, arguments))
            : (console.error(
                "[FaucetValidator] You need to pass valid addresses"
              ),
              []);
        };
      }
      function R(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.wethGatewayAddress)
            ? (s(e, t, arguments),
              d(e, t, arguments),
              l(e, t, arguments),
              c(e, t, arguments),
              i.apply(this, arguments))
            : (console.error(
                "[WethGatewayValidator] You need to pass valid addresses"
              ),
              []);
        };
      }
      function M(e, t, r) {
        let i = r.value;
        r.value = function () {
          return n.isAddress(this.aaveGovernanceV2Address) &&
            n.isAddress(this.aaveGovernanceV2HelperAddress)
            ? (s(e, t, arguments),
              c(e, t, arguments),
              u(e, t, arguments),
              i.apply(this, arguments))
            : (console.error(
                "[GovernanceValidator] You need to pass valid addresses"
              ),
              []);
        };
      }
      function U(e, t, r) {
        ...
        r.value = function () {
          return n.isAddress(this.aaveGovernanceV2Address)
            ? (s(e, t, arguments), c(e, t, arguments), i.apply(this, arguments))
            : (console.error(
                "[GovernanceValidator] You need to pass valid addresses"
              ),
              []);
      ...
      function D(e, t, r) {
        ...
        r.value = function () {
          s(e, t, arguments);
          var r = arguments;
          let u = Reflect.getOwnMetadata(o.NM, e, t);
          return (
            u &&
              u.forEach((e) => {
                if (e.field) {
    ...
    66733: function (e, t, r) {
      ...
      Object.defineProperty(t, "defaultPath", {
        ...
        Object.defineProperty(t, "entropyToMnemonic", {
          enumerable: !0,
          get: function () {
            return l.entropyToMnemonic;
          },
        }),
        Object.defineProperty(t, "getAccountPath", {
          enumerable: !0,
          get: function () {
            return l.getAccountPath;
          },
        }),
        ...
        Object.defineProperty(t, "isValidMnemonic", {
          enumerable: !0,
          get: function () {
            return l.isValidMnemonic;
          },
        }),
        Object.defineProperty(t, "mnemonicToEntropy", {
          enumerable: !0,
          get: function () {
            return l.mnemonicToEntropy;
          },
        }),
    ...
    70795: (e, t, r) => {
      ...
      r.d(t, {
        ...
        r(29233);
      let n = Symbol("ethAddress"),
        i = Symbol("deadline32Bytes"),
        o = Symbol("ethAddressArray"),
        a = Symbol("ethOrENSAddress"),
        s = Symbol("isPositive"),
        u = Symbol("isPositiveOrMinusOne"),
        d = Symbol("is0OrPositiveMetadataKey");
      function c(e) {
        return function (t, r, n) {
          let o = Reflect.getOwnMetadata(i, t, r) || [];
          o.push({ index: n, field: e }), Reflect.defineMetadata(i, o, t, r);
        };
      }
      function l(e) {
        return function (t, r, i) {
          let o = Reflect.getOwnMetadata(n, t, r) || [];
          o.push({ index: i, field: e }), Reflect.defineMetadata(n, o, t, r);
        };
      }
      function f(e) {
        return function (t, r, n) {
          let i = Reflect.getOwnMetadata(o, t, r) || [];
          i.push({ index: n, field: e }), Reflect.defineMetadata(o, i, t, r);
        };
      }
      function p(e) {
        return function (t, r, n) {
          let i = Reflect.getOwnMetadata(a, t, r) || [];
          i.push({ index: n, field: e }), Reflect.defineMetadata(a, i, t, r);
        };
      }
      function h(e) {
        return function (t, r, n) {
          let i = Reflect.getOwnMetadata(s, t, r) || [];
          i.push({ index: n, field: e }), Reflect.defineMetadata(s, i, t, r);
        };
      }
      function m(e) {
        return function (t, r, n) {
          let i = Reflect.getOwnMetadata(d, t, r) || [];
          i.push({ index: n, field: e }), Reflect.defineMetadata(d, i, t, r);
        };
      }
      function y(e) {
        return function (t, r, n) {
          let i = Reflect.getOwnMetadata(u, t, r) || [];
          i.push({ index: n, field: e }), Reflect.defineMetadata(u, i, t, r);
        };
      }
    ...
    84007: (e, t, r) => {
      ...
      var d = class extends a.Q {
          ...
          #f(e, t) {
            return t
              ? ((this.#o && this.#t === this.#s && t === this.#a) ||
                  ((this.#a = t),
                  (this.#s = this.#t),
                  (this.#o = (0, s.BH)(this.#o, t(e)))),
                this.#o)
              : e;
          }
          #c(e) {
      ...
      function m(e, t) {
          ...
          b = n.useMemo(
            () =>
              r.map((e) => {
                ...
                return (
                  (t._optimisticResults = m ? "isRestoring" : "optimistic"), t
                );
              }),
            [r, u, m]
          );
        b.forEach((e) => {
          ...
          (0, p.wZ)(y);
        let [g] = n.useState(() => new d(u, b, a)),
          [v, P, O] = g.getOptimisticResult(b, a.combine),
          A = !m && !1 !== a.subscribed;
        n.useSyncExternalStore(
          n.useCallback(
            (e) => (A ? g.subscribe(i.jG.batchCalls(e)) : s.lQ),
            [g, A]
          ),
          () => g.getCurrentResult(),
          () => g.getCurrentResult()
        ...
        let E = v.some((e, t) => (0, h.EU)(b[t], e))
          ? v.flatMap((e, t) => {
              let r = b[t];
              if (r) {
                let t = new o.$(u, r);
                if ((0, h.EU)(r, e)) return (0, h.iL)(r, t, y);
                (0, h.nE)(e, m) && (0, h.iL)(r, t, y);
              }
              return [];
            })
          : [];
    ...
    96654: (e, t, r) => {
      ...
      var n = r(37653),
        ...
        s = r(34062),
        u = r(65738);
      let d = (e, t) => new n.g(e).shiftedBy(t).toFixed(0),
        c = (e) => e.toLowerCase().endsWith(".eth"),
        l = (e, t) => new n.g(e).shiftedBy(-1 * t).toFixed(),
        f = (e, t) => (e.toLowerCase() === b.toLowerCase() ? t : p),
        p = i.gH.from(0).toHexString(),
        h = o.Is.toString(),
        m =
        ...
        v = "0.05",
        P = {
          [u.ld.default]: { limit: "210000", recommended: "210000" },
          [u.ld.approval]: { limit: "65000", recommended: "65000" },
          [u.ld.creditDelegationApproval]: {
            limit: "55000",
            recommended: "55000",
          },
          [u.ld.supply]: { limit: "300000", recommended: "300000" },
          [u.ld.deposit]: { limit: "300000", recommended: "300000" },
          [u.ld.borrow]: { limit: "400000", recommended: "400000" },
          [u.ld.withdraw]: { limit: "230000", recommended: "300000" },
          [u.ld.liquidationCall]: { limit: "700000", recommended: "700000" },
          [u.ld.liquidationFlash]: { limit: "995000", recommended: "995000" },
          [u.ld.repay]: { limit: "300000", recommended: "300000" },
          [u.ld.repayETH]: { limit: "350000", recommended: "300000" },
          [u.ld.borrowETH]: { limit: "450000", recommended: "450000" },
          [u.ld.withdrawETH]: { limit: "640000", recommended: "640000" },
          [u.ld.swapCollateral]: { limit: "1000000", recommended: "1000000" },
          [u.ld.repayCollateral]: { limit: "700000", recommended: "700000" },
          [u.ld.migrateV3]: { limit: "700000", recommended: "700000" },
          [u.ld.supplyWithPermit]: { limit: "350000", recommended: "350000" },
          [u.ld.repayWithPermit]: { limit: "350000", recommended: "350000" },
          [u.ld.stake]: { limit: "350000", recommended: "350000" },
          [u.ld.stakeWithPermit]: { limit: "400000", recommended: "400000" },
          [u.ld.vote]: { limit: "125000", recommended: "125000" },
          [u.ld.claimRewards]: { limit: "275000", recommended: "275000" },
          [u.ld.setUsageAsCollateral]: {
            limit: "138000",
            recommended: "138000",
          },
          [u.ld.repayWithATokens]: { limit: "300000", recommended: "300000" },
          [u.ld.withdrawAndSwitch]: {
            limit: "1000000",
            recommended: "1000000",
          },
          [u.ld.batchMetaDelegate]: { limit: "400000", recommended: "400000" },
          [u.ld.updateRepresentatives]: {
            limit: "60000",
            recommended: "60000",
          },
          [u.ld.migrateABPT]: { limit: "750000", recommended: "750000" },
          [u.ld.umbrellaStake]: { limit: "400000", recommended: "400000" },
          [u.ld.umbrellaStakeWithPermit]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeWithATokens]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeWithATokensWithPermit]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaRedeem]: { limit: "310000", recommended: "310000" },
          [u.ld.umbrellaRedeemATokens]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeTokenCooldown]: {
            limit: "60000",
            recommended: "60000",
          },
          [u.ld.umbrellaStakeTokenDeposit]: {
            limit: "200000",
            recommended: "200000",
          },
          [u.ld.umbrellaStakeTokenDepositWithPermit]: {
            limit: "300000",
            recommended: "300000",
          },
          [u.ld.umbrellaStakeTokenRedeem]: {
            limit: "200000",
            recommended: "200000",
          },
          [u.ld.umbrellaClaimAllRewards]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaClaimSelectedRewards]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayStake]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayStakeWithPermit]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayStakeATokens]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayStakeATokensWithPermit]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayStakeNativeTokens]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayRedeem]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayRedeemATokens]: {
            limit: "310000",
            recommended: "310000",
          },
          [u.ld.umbrellaStakeGatewayRedeemNativeTokens]: {
            limit: "310000",
            recommended: "310000",
          },
        },
        ...
        A = (e) => {
          switch (e.slice(0, 10)) {
            ...
            case "0x5e94e28d":
              return 196;
            default:
              throw Error("Unrecognized function selector for Augustus");
          }
        },
        E = (e) =>
          Object.assign(Object.assign({}, e), {
            value: e.value ? i.gH.from(e.value) : i.gH.from("0"),
          }),
        w = (e) => {
          let t = a.id(e),
            r = s.computeAddress(t);
          return { privateKey: t, address: r };
        },
        j = "0xCcCCccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC",
        S = (e, t, r, n) => ({
          domain: {
            name: "Mocked token",
            version: "1",
          ...
          value: { owner: e, spender: t, value: r, nonce: "0", deadline: n },
        });
      function _(e) {
