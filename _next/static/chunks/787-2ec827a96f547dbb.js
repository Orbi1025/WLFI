try {
  !(function () {
    ...
    e &&
      ...
      (t._sentryDebugIds[e] = "76debd62-a94f-4bf0-b5f7-61160f1c2eaa"),
      (t._sentryDebugIdIdentifier =
        "sentry-dbid-76debd62-a94f-4bf0-b5f7-61160f1c2eaa"));
  })();
} catch (t) {}
("use strict");
  ...
  [787],
  {
    30787: (t, e, i) => {
      ...
      let r = (t, e, i) => {
          ...
          return (
            n && Object.assign(s, n),
            null == a || a.forEach((t) => s.appendChild(t)),
            s
          );
        },
        l = (String.raw, String.raw),
        o = (() => {
          try {
            document
              .createElement("div")
      ...
      class A extends C {
        ...
        set animated(t) {
          ...
          this.animated !== t &&
            ...
            null == (e = this.shadowRoot) ||
              e.getAnimations().forEach((t) => t.finish()));
        }
        set data(t) {
          var e;
          if (null == t) return;
          let { pre: i, integer: n, fraction: a, post: r, value: l } = t;
          if (this.created) {
            let s = this._data;
            (this._data = t),
              (this.computedTrend =
                "function" == typeof this.trend
                  ? this.trend(s.value, l)
                  : this.trend),
            ...
            if (
              ...
              s || (s = new CSSStyleSheet()).replaceSync(S),
                (this.shadowRoot.adoptedStyleSheets = [s]);
            else {
              let t = document.createElement("style");
              (t.textContent = S), this.shadowRoot.appendChild(t);
            }
            (this._pre = new k(this, i, { justify: "right", part: "left" })),
              this.shadowRoot.appendChild(this._pre.el),
              (this._num = new E(this, n, a)),
              this.shadowRoot.appendChild(this._num.el),
              (this._post = new k(this, r, { justify: "left", part: "right" })),
        ...
        didUpdate() {
          ...
          Promise.all(
            this.shadowRoot.getAnimations().map((t) => t.finished)
          ).then(() => {
            t.signal.aborted ||
      ...
      class E {
        constructor(t, e, i, { className: s, ...n } = {}) {
          (this.flow = t),
            (this._integer = new R(t, e, {
              justify: "right",
              part: "integer",
            })),
            (this._fraction = new R(t, i, {
              justify: "left",
              part: "fraction",
            })),
            ...
            (this.el = r(
              "span",
              { ...n, part: "number", className: `number ${s ?? ""}` },
              [this._inner]
            ));
        }
        willUpdate() {
      ...
      class x {
        constructor(t, e, { justify: i, className: s, ...n }, a) {
          ...
          this.el = r(
            "span",
            { ...n, className: `section section--justify-${i} ${s ?? ""}` },
            a ? a(l) : l
          );
        }
        addChar(t, { startDigitsAtZero: e = !1, ...i } = {}) {
          let s =
            "integer" === t.type || "fraction" === t.type
              ? new P(this, t.type, e ? 0 : t.value, t.pos, {
                  ...i,
                  onRemove: this.onCharRemove(t.key),
                })
              : new N(this, t.type, t.value, {
                  ...i,
                  onRemove: this.onCharRemove(t.key),
                });
        ...
        addNewAndUpdateExisting(t) {
          ...
          if (
            ((function (t, e, { reverse: i = !1 } = {}) {
              let s = t.length;
              for (let n = i ? s - 1 : 0; i ? n >= 0 : n < s; i ? n-- : n++)
                e(t[n], n);
            })(
              t,
              (t) => {
      ...
      class P extends j {
        constructor(t, e, i, s, n) {
          var a, l;
          let o =
              ((null == (l = null == (a = t.flow.digits) ? void 0 : a[s])
                ? void 0
                : l.max) ?? 9) + 1,
            h = Array.from({ length: o }).map((t, e) => {
              let s = r("span", { className: "digit__num" }, [
                document.createTextNode(String(e)),
              ]);
              return (
                e !== i && s.setAttribute("inert", ""),
                s.style.setProperty("--n", String(e)),
                s
              );
            }),
            d = r("span", { part: `digit ${e}-digit`, className: "digit" }, h);
          d.style.setProperty("--current", String(i)),
            d.style.setProperty("--length", String(o)),
            super(t, i, d, n),
            (this.pos = s),
          ...
          if (this.flow.plugins)
            for (let e of this.flow.plugins) {
              let i =
                null == (t = e.getDelta)
                  ? void 0
                  : t.call(e, this.value, this._prevValue, this);
              if (null != i) return i;
            }
      ...
      class N extends j {
        constructor(t, e, i, s) {
          let n = r("span", { className: "symbol__value", textContent: i });
          super(
            t,
            i,
            r("span", { part: `symbol ${e}`, className: "symbol" }, [n]),
            s
          ),
            (this.type = e),
            ...
            this._children.set(
              i,
              new U(this.flow, n, { onRemove: this._onChildRemove(i) })
            );
        }
        willUpdate(t) {
        ...
        update(t) {
          if (this.value !== t) {
            let e = this._children.get(this.value);
            e && (e.present = !1);
      ...
      let T =
        parseInt(null == (n = a.version.match(/^(\d+)\./)) ? void 0 : n[1]) >=
        19;
      class M extends A {
      ...
      (M.observedAttributes = T ? [] : ["data", "digits"]),
        ((t, e) => {
          customElements.get(t) || customElements.define(t, e);
        })("number-flow-react", M);
      let L = {},
        I = T ? (t) => t : JSON.stringify;
      function F(t) {
        let {
          transformTiming: e,
          spinTiming: i,
      ...
      class D extends a.Component {
        updateProperties(t) {
          ...
          Object.entries(e).forEach((t) => {
            let [e, i] = t;
            this.el[e] = null != i ? i : M.defaultProps[e];
          }),
            (null == t ? void 0 : t.onAnimationsStart) &&
            ...
            (null == t ? void 0 : t.onAnimationsFinish) &&
              this.el.removeEventListener(
                "animationsfinish",
          ...
          if ((this.updateProperties(t), t.data !== this.props.data)) {
            if (this.props.group)
              return (
                ...
                () => {
                  var t;
                  return null == (t = this.props.group)
                    ? void 0
                    : t.didUpdate();
                }
              );
            if (!this.props.isolate) {
              var e;
              return (
                null == (e = this.el) || e.willUpdate(),
                () => {
                  var t;
                  return null == (t = this.el) ? void 0 : t.didUpdate();
                }
              );
            }
          }
      ...
      let O = a.forwardRef(function (t, e) {
          let {
            value: i,
            locales: s,
            format: n,
          ...
          a.useImperativeHandle(e, () => h.current, []);
          let h = a.useRef(),
            d = a.useContext(V);
          null == d || d.useRegister(h);
          let p = a.useMemo(() => (s ? JSON.stringify(s) : ""), [s]),
            u = a.useMemo(() => (n ? JSON.stringify(n) : ""), [n]),
            c = a.useMemo(() => {
              var t, e;
              return (function (t, e, i, s) {
                let n = e.formatToParts(t);
                i && n.unshift({ type: "prefix", value: i }),
                  s && n.push({ type: "suffix", value: s });
                let a = [],
                  r = [],
                  l = [],
                  o = [],
                ...
                for (let t of n) {
                  p += t.value;
                  let e =
                    "minusSign" === t.type || "plusSign" === t.type
                      ? "sign"
                      : t.type;
                  "integer" === e
                    ? ((u = !0),
                    ...
                    : "decimal" === e
                    ? ((c = !0), l.push({ type: e, value: t.value, key: d(e) }))
                    : "fraction" === e
                    ? l.push(
                        ...t.value
                          .split("")
                ...
                i,
                null != (e = L[(t = "".concat(p, ":").concat(u))])
                  ? e
                  : (L[t] = new Intl.NumberFormat(s, n)),
                r,
                l
              );
            }, [i, p, u, r, l]);
          return a.createElement(D, { ...o, group: d, data: c, innerRef: h });
        }),
        V = a.createContext(void 0);
    },
  },
]);
