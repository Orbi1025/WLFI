try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "241e686a-6c8f-473c-8443-21c0a63f35a5"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-241e686a-6c8f-473c-8443-21c0a63f35a5"));
  })();
} catch (e) {}
("use strict");
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7091],
  {
    26643: (e, t, n) => {
      ...
      function d(e) {
        let { children: t, isPresent: n, anchorX: i, root: l } = e,
          s = (0, o.useId)(),
          f = (0, o.useRef)(null),
        ...
        return (
          (0, o.useInsertionEffect)(() => {
            let { width: e, height: t, top: r, left: o, right: u } = c.current;
            if (n || !f.current || !e || !t) return;
              ...
              a.sheet &&
                a.sheet.insertRule(
                  '\n          [data-motion-pop-id="'
                    ...
                    .concat(
                      "left" === i ? "left: ".concat(o) : "right: ".concat(u),
                      "px !important;\n            top: "
                    )
                    .concat(r, "px !important;\n          }\n        ")
                ),
              () => {
                h.contains(a) && h.removeChild(a);
              }
            );
          }, [n]),
          (0, r.jsx)(a, {
            ...
            childRef: f,
            sizeRef: c,
            children: o.cloneElement(t, { ref: f }),
          })
        );
      }
      let h = (e) => {
        ...
        return (
          ...
          (0, r.jsx)(f.t.Provider, { value: y, children: t })
        );
      };
      function g() {
        return new Map();
      ...
      let w = (e) => {
        let {
          ...
          [O, P] = (0, o.useState)(E);
        (0, s.E)(() => {
          (b.current = !1), (W.current = E);
          for (let e = 0; e < O.length; e++) {
            let t = m(O[e]);
            L.includes(t) ? R.delete(t) : !0 !== R.get(t) && R.set(t, !1);
          }
        }, [O, L.length, L.join("-")]);
        let k = [];
        if (E !== C) {
          ...
          for (let t = 0; t < O.length; t++) {
            let n = O[t],
              r = m(n);
            L.includes(r) || (e.splice(t, 0, n), k.push(n));
          }
          return "wait" === a && k.length && (e = k), P(v(e)), M(E), null;
        }
        let { forceRender: z } = (0, o.useContext)(i.L);
        return (0, r.jsx)(r.Fragment, {
          children: O.map((e) => {
            let t = m(e),
              o = (!d || !!y) && (E === O || L.includes(t));
            return (0, r.jsx)(
              h,
              {
                isPresent: o,
                initial: (!b.current || !!f) && void 0,
                custom: n,
                presenceAffectsLayout: u,
                mode: a,
                root: w,
    ...
    49645: (e, t, n) => {
      ...
      function R(e, t, n, r) {
        ...
        (o.current = e[`scroll${l}`]),
          ...
          (o.progress = (0, E.q)(0, o.scrollLength, o.current));
        let c = r - f;
        o.velocity = c > 50 ? 0 : (0, L.f)(o.current - s, c);
      }
      var C = n(50180),
        M = n(90825),
        O = n(94713),
      ...
      function _(e, { container: t = document.scrollingElement, ...n } = {}) {
        if (!t) return f.l;
        let i = N.get(t);
              ...
              !(function (e, t = e, n) {
                ...
                (r.offset || r.target) &&
                  (function (e, t, n) {
                    ...
                    u &&
                      ((t[i].interpolate = (0, C.G)(t[i].offset, (0, M.Z)(r), {
                        clamp: !1,
                      })),
                  ...
                  : (function (e, t) {
                      r ||
                        ("undefined" != typeof ResizeObserver &&
                          (r = new ResizeObserver(y)));
                      let n = (0, h.K)(e);
                      return (
                        n.forEach((e) => {
                          let n = g.get(e);
                          n || ((n = new Set()), g.set(e, n)),
                            n.add(t),
                            r?.observe(e);
                        }),
                        () => {
      ...
      let j = new Map();
      function Q({ source: e, container: t, ...n }) {
        let { axis: r } = n;
        e && (t = e);
        let o = j.get(t) ?? new Map();
        j.set(t, o);
        let i = n.target ?? "self",
          l = o.get(i) ?? {},
          s = r + (n.offset ?? []).join(",");
      ...
      let D = () => ({
        ...
        U = (e) => !!e && !e.current;
      function V({ container: e, target: t, ...n } = {}) {
        let r = (0, X.M)(D),
          o = (0, s.useRef)(null),
          i = (0, s.useRef)(!1),
          c = (0, s.useCallback)(
        ...
        return (
          (0, A.E)(() => {
            if (((i.current = !1), !(U(e) || U(t)))) return c();
            i.current = !0;
          }, [c]),
          (0, s.useEffect)(
            () =>
