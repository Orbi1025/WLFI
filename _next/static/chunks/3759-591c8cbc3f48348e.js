try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "5c8667de-4b77-4e05-acf1-6f95e26bf164"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-5c8667de-4b77-4e05-acf1-6f95e26bf164"));
  })();
} catch (e) {}
("use strict");
  ...
  [3759],
  {
    7297: (e, t, r) => {
      ...
      var n = r(7620),
        ...
        l = n.forwardRef((e, t) => {
          var r;
          let { decorative: n, orientation: l = u, ...s } = e,
            c = ((r = l), i.includes(r)) ? l : u;
    ...
    37723: (e, t, r) => {
            ...
            ((c = function (e, t) {
              ...
              return (
                s(e)
                  ...
                  : (r =
                      "number" == typeof e || t
                        ? n((a = "number" == typeof e ? g(e) : e))
                        : n((a = o(e, void 0)))),
                { formattedValue: r, numAsString: a }
              );
            }),
            ((f = (0, a.useRef)(c)).current = c),
            (0, a.useRef)(function () {
              for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
              return f.current.apply(f, e);
            }).current),
      ...
      function O(e) {
        ...
        var B = e.isCharacterSame,
          ...
          L = M[1],
          P = (0, a.useRef)(),
          G = (0, a.useRef)({ formattedValue: _, numAsString: K }),
          U = function (e, t) {
            (G.current = {
          ...
          Z = $[1],
          q = (0, a.useRef)(null),
          H = (0, a.useRef)({ setCaretTimeout: null, focusTimeout: null });
          ...
          et = function (e) {
            ...
            if (n) {
              var i = e.inputValue || n.value,
                l = b(n);
              (n.value = r), void 0 !== (t = ee(i, r, l)) && X(n, t, r);
            }
            r !== _ && U(Q(r, u), { event: o, source: a });
          };
        (0, a.useEffect)(
          function () {
            var e = G.current,
              ...
              r = e.numAsString;
            (_ !== t || K !== r) &&
              U(Q(_, K), { event: void 0, source: n.props });
          },
          [_, K]
        );
        var er = q.current ? b(q.current) : void 0;
        ("undefined" != typeof window ? a.useLayoutEffect : a.useEffect)(
          function () {
            var e = q.current;
            if (_ !== G.current.formattedValue && e) {
              var t = ee(G.current.formattedValue, _, er);
              (e.value = _), X(e, t, _);
            }
          },
          [_]
        ...
        var en = function (e, t, r) {
            var n = t.target,
              a = Object.assign(
                Object.assign(
                  {},
                  P.current ? S(P.current, n.selectionEnd) : h(_, e)
                ),
                { lastValue: _ }
              ),
              o = d(e, a),
              u = J(o);
            if (((o = d(u, void 0)), O && !O(Q(u, o)))) {
              var i = t.target,
                l = ee(e, _, b(i));
              return (i.value = _), X(i, l, _), !1;
            }
            return (
              et({
                formattedValue: u,
          ...
          eo = Object.assign(
            ...
            F,
            {
              ...
              value: _,
              onChange: function (e) {
                en(e.target.value, e, n.event) && E(e), (P.current = void 0);
              },
              onKeyDown: function (e) {
                ...
                var s = t;
                l
                  ? (s = Y(u, t, "ArrowLeft" === n ? "left" : "right")) !== t &&
                    e.preventDefault()
                  : "Delete" !== n || k(u[t])
                  ? "Backspace" !== n || k(u[t]) || (s = Y(u, t, "left"))
                  : (s = Y(u, t, "right")),
                  s !== t && X(r, s, u),
                  I(e),
                  ea(r, i);
        ...
        return "text" === r
          ? s
            ? a.createElement(a.Fragment, null, s(_, F) || null)
            : a.createElement("span", Object.assign({}, F, { ref: c }), _)
          : l
          ? a.createElement(l, Object.assign({}, eo, { ref: c }))
          : a.createElement("input", Object.assign({}, eo, { ref: c }));
      }
      function E(e, t) {
        var r,
          n,
        ...
        var v = I(t),
          g = v.thousandSeparator,
          m = v.decimalSeparator,
          p = (0 !== o && -1 !== e.indexOf(".")) || (o && u),
          h = f(e, s),
          S = h.beforeDecimal,
          b = h.afterDecimal,
          y = h.addNegation;
        return (
          ...
          g &&
            ...
            (S =
              r.substring(0, a) +
              r.substring(a, r.length).replace(n, "$1" + g))),
          i && (S = i + S),
          l && (b += l),
          y && (S = "-" + S),
          (e = S + ((p && m) || "") + b)
      ...
      function T(e) {
        var t,
          ...
          Z =
            ...
            (r = t.suffix),
            (d = t.allowNegative),
            (v = t.allowLeadingZeros),
            void 0 === (S = t.onKeyDown) && (S = u),
            void 0 === (b = t.onBlur) && (b = u),
            (y = t.thousandSeparator),
            (V = t.decimalScale),
            (w = t.fixedDecimalScale),
            void 0 === (D = t.prefix) && (D = ""),
            (N = t.defaultValue),
            (T = t.value),
            ...
            (k = (R = I(t)).decimalSeparator),
            (B = R.allowedDecimalSeparators),
            (F = function (e) {
              return E(e, t);
            }),
            (M = function (e, r) {
              return (function (e, t, r) {
                ...
                var x = function (e, t, r) {
                    ...
                    s.startsWith("-")
                      ...
                      : e.startsWith("--")
                      ? ((n = !1), (a = !0))
                      : d.startsWith("-") && e.length === d.length
                      ? (n = !1)
                      : "-" === e[0] && (n = !0);
                    var o = +!!n;
                    return (
                  ...
                  D = x(e, p, h),
                  N = D.hasNegation;
                (e = D.value), (p = D.start), (h = D.end);
                var O = x(t.lastValue, g.start, g.end),
                  E = O.start,
                  T = O.end,
                  C = O.value,
                  A = e.substring(p, h);
                e.length &&
                  C.length &&
                  (E > C.length - d.length || T < s.length) &&
                  !(A && d.startsWith(A)) &&
                  (e = C);
                var j = 0;
                e.startsWith(s) ? (j += s.length) : p < s.length && (j = p),
                  (e = e.substring(j)),
                  (h -= j);
                var R = e.length,
                  k = e.length - d.length;
                e.endsWith(d)
                  ...
                  o && !u && l && (n = "-" + n);
                var B = (e = (
                    (e = n).match(RegExp("(^-)|[0-9]|" + c(y), "g")) || []
                  ).join("")).indexOf(y),
                  F = f(
                    (e = e.replace(RegExp(c(y), "g"), function (e, t) {
                      return t === B ? "." : "";
                    })),
                    l
                  ),
            ...
            Object.assign(Object.assign({}, j), {
              ...
              isCharacterSame: function (e) {
                ...
                return (
                  ...
                  ((!!(a >= l.start && a < l.end && B && B.includes(u)) &&
                    i === k) ||
                    u === i)
                );
              },
              ...
              onKeyDown: function (e) {
                ...
                if (
                  (void 0 === o && (o = ""),
                  ("Backspace" === r || "Delete" === r) && a < D.length)
                )
                  return void e.preventDefault();
                if (n !== a) return void S(e);
                "Backspace" === r &&
                  "-" === o[0] &&
                  n === D.length + 1 &&
                  d &&
                  ...
                  V &&
                    w &&
                    ("Backspace" === r && o[n - 1] === k
                      ? (p(t, n - 1), e.preventDefault())
                      : "Delete" === r && o[n] === k && e.preventDefault()),
                  (null == B ? void 0 : B.includes(r)) &&
                    o[n] === k &&
                    p(t, n + 1);
                var u = !0 === y ? "," : y;
                "Backspace" === r && o[n - 1] === u && p(t, n - 1),
                  "Delete" === r && o[n] === u && p(t, n + 1),
                  S(e);
              },
              onBlur: function (e) {
                var r = U;
        ...
        return a.createElement(O, Object.assign({}, Z));
      }
    },
  },
]);
