try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "eca8d258-b36f-40cf-97e5-923c68b4eb1c"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-eca8d258-b36f-40cf-97e5-923c68b4eb1c"));
  })();
} catch (e) {}
("use strict");
  ...
  [4731],
  {
    36332: (e, t, n) => {
                ...
                },
                {
                  components: [
                    ...
                    },
                    {
                      ...
                      internalType:
                        "struct IUiIncentiveDataProviderV3.RewardInfo[]",
                      name: "rewardsTokenInformation",
                      type: "tuple[]",
                    },
                  ],
                  internalType:
                    "struct IUiIncentiveDataProviderV3.IncentiveData",
                  name: "aIncentiveData",
                  type: "tuple",
                },
                {
            ...
            },
            {
              components: [
                ...
                },
                {
                  ...
                  internalType:
                    "struct IUiIncentiveDataProviderV3.UserIncentiveData",
      ...
      class y extends r.A {
        constructor({
          provider: e,
          uiIncentiveDataProviderAddress: t,
          chainId: n,
        }) {
          super(e, p),
            (this.uiIncentiveDataProviderAddress = t),
            (this.chainId = n);
        }
        async getFullReservesIncentiveData({
          user: e,
          lendingPoolAddressProvider: t,
        }) {
          return this.getContractInstance(
            this.uiIncentiveDataProviderAddress
          ).getFullReservesIncentiveData(t, e);
        }
        async getReservesIncentivesData({ lendingPoolAddressProvider: e }) {
          return this.getContractInstance(
            this.uiIncentiveDataProviderAddress
          ).getReservesIncentivesData(e);
        }
        async getUserReservesIncentivesData({
          ...
          return this.getContractInstance(
            this.uiIncentiveDataProviderAddress
          ).getUserReservesIncentivesData(t, e);
        }
        async getReservesIncentivesDataHumanized({
          lendingPoolAddressProvider: e,
        }) {
          return (
            await this.getReservesIncentivesData({
              lendingPoolAddressProvider: e,
            })
          ).map((t) => ({
            id: `${this.chainId}-${t.underlyingAsset}-${e}`.toLowerCase(),
            underlyingAsset: t.underlyingAsset.toLowerCase(),
            aIncentiveData: this._formatIncentiveData(t.aIncentiveData),
            vIncentiveData: this._formatIncentiveData(t.vIncentiveData),
          }));
        }
        async getUserReservesIncentivesDataHumanized({
          ...
          return (
            ...
            id: `${this.chainId}-${e}-${n.underlyingAsset}-${t}`.toLowerCase(),
            underlyingAsset: n.underlyingAsset.toLowerCase(),
            aTokenIncentivesUserData: this._formatUserIncentiveData(
              n.aTokenIncentivesUserData
            ),
            vTokenIncentivesUserData: this._formatUserIncentiveData(
              n.vTokenIncentivesUserData
            ),
          }));
        }
        _formatIncentiveData(e) {
          return {
            tokenAddress: e.tokenAddress,
            incentiveControllerAddress: e.incentiveControllerAddress,
            rewardsTokenInformation: e.rewardsTokenInformation.map((e) => ({
              precision: e.precision,
              rewardTokenAddress: e.rewardTokenAddress,
              rewardTokenDecimals: e.rewardTokenDecimals,
              emissionPerSecond: e.emissionPerSecond.toString(),
              incentivesLastUpdateTimestamp:
                e.incentivesLastUpdateTimestamp.toNumber(),
              tokenIncentivesIndex: e.tokenIncentivesIndex.toString(),
              emissionEndTimestamp: e.emissionEndTimestamp.toNumber(),
              rewardTokenSymbol: e.rewardTokenSymbol,
              rewardOracleAddress: e.rewardOracleAddress,
              rewardPriceFeed: e.rewardPriceFeed.toString(),
              priceFeedDecimals: e.priceFeedDecimals,
            })),
          };
        }
        _formatUserIncentiveData(e) {
          return {
            tokenAddress: e.tokenAddress,
            incentiveControllerAddress: e.incentiveControllerAddress,
            userRewardsInformation: e.userRewardsInformation.map((e) => ({
              rewardTokenAddress: e.rewardTokenAddress,
              rewardTokenDecimals: e.rewardTokenDecimals,
              tokenIncentivesUserIndex: e.tokenIncentivesUserIndex.toString(),
              userUnclaimedRewards: e.userUnclaimedRewards.toString(),
              rewardTokenSymbol: e.rewardTokenSymbol,
              rewardOracleAddress: e.rewardOracleAddress,
              rewardPriceFeed: e.rewardPriceFeed.toString(),
              priceFeedDecimals: e.priceFeedDecimals,
      ...
      (0, a.__decorate)(
        [
          i.bb,
          (0, a.__param)(0, (0, s.Ub)("user")),
          (0, a.__param)(0, (0, s.Ub)("lendingPoolAddressProvider")),
          (0, a.__metadata)("design:type", Function),
          (0, a.__metadata)("design:paramtypes", [Object]),
          (0, a.__metadata)("design:returntype", Promise),
        ],
        y.prototype,
    ...
    46751: (e, t, n) => {
      ...
      class l {
        constructor(e) {
          if (!(0, a.isAddress)(e.uiPoolDataProviderAddress))
            throw Error("contract address is not valid");
          (this._contract = d.connect(e.uiPoolDataProviderAddress, e.provider)),
            (this.chainId = e.chainId);
        }
        async getReservesList({ lendingPoolAddressProvider: e }) {
          if (!(0, a.isAddress)(e))
            throw Error("Lending pool address is not valid");
          return this._contract.getReservesList(e);
        }
        async getReservesData({ lendingPoolAddressProvider: e }) {
          if (!(0, a.isAddress)(e))
            throw Error("Lending pool address is not valid");
          return this._contract.getReservesData(e);
        }
        async getUserReservesData({ lendingPoolAddressProvider: e, user: t }) {
          if (!(0, a.isAddress)(e))
            throw Error("Lending pool address is not valid");
          if (!(0, a.isAddress)(t))
            throw Error("User address is not a valid ethereum address");
          return this._contract.getUserReservesData(e, t);
        }
        async getReservesHumanized({ lendingPoolAddressProvider: e }) {
          let { 0: t, 1: n } = await this.getReservesData({
            lendingPoolAddressProvider: e,
          });
          return {
            reservesData: t.map((t, n) => {
              let a = t.virtualUnderlyingBalance.toString(),
                { virtualAccActive: r } = t;
              return {
                originalId: n,
                id: `${this.chainId}-${t.underlyingAsset}-${e}`.toLowerCase(),
                underlyingAsset: t.underlyingAsset.toLowerCase(),
                name: t.name,
                symbol: o[t.underlyingAsset.toLowerCase()]
                  ? o[t.underlyingAsset.toLowerCase()]
                  : t.symbol,
                decimals: t.decimals.toNumber(),
                baseLTVasCollateral: t.baseLTVasCollateral.toString(),
                reserveLiquidationThreshold:
                  t.reserveLiquidationThreshold.toString(),
                reserveLiquidationBonus: t.reserveLiquidationBonus.toString(),
                reserveFactor: t.reserveFactor.toString(),
                usageAsCollateralEnabled: t.usageAsCollateralEnabled,
                borrowingEnabled: t.borrowingEnabled,
                isActive: t.isActive,
                isFrozen: t.isFrozen,
                liquidityIndex: t.liquidityIndex.toString(),
                variableBorrowIndex: t.variableBorrowIndex.toString(),
                liquidityRate: t.liquidityRate.toString(),
                variableBorrowRate: t.variableBorrowRate.toString(),
                lastUpdateTimestamp: t.lastUpdateTimestamp,
                aTokenAddress: t.aTokenAddress.toString(),
                variableDebtTokenAddress: t.variableDebtTokenAddress.toString(),
                interestRateStrategyAddress:
                  t.interestRateStrategyAddress.toString(),
                availableLiquidity: t.availableLiquidity.toString(),
                totalScaledVariableDebt: t.totalScaledVariableDebt.toString(),
                priceInMarketReferenceCurrency:
                  t.priceInMarketReferenceCurrency.toString(),
                priceOracle: t.priceOracle,
                variableRateSlope1: t.variableRateSlope1.toString(),
                variableRateSlope2: t.variableRateSlope2.toString(),
                baseVariableBorrowRate: t.baseVariableBorrowRate.toString(),
                optimalUsageRatio: t.optimalUsageRatio.toString(),
                isPaused: t.isPaused,
                debtCeiling: t.debtCeiling.toString(),
                borrowCap: t.borrowCap.toString(),
                supplyCap: t.supplyCap.toString(),
                borrowableInIsolation: t.borrowableInIsolation,
                accruedToTreasury: t.accruedToTreasury.toString(),
                unbacked: t.unbacked.toString(),
                isolationModeTotalDebt: t.isolationModeTotalDebt.toString(),
                debtCeilingDecimals: t.debtCeilingDecimals.toNumber(),
                isSiloedBorrowing: t.isSiloedBorrowing,
                flashLoanEnabled: t.flashLoanEnabled,
                virtualAccActive: r,
                virtualUnderlyingBalance: a,
              };
            }),
            baseCurrencyData: {
              marketReferenceCurrencyDecimals:
                n.marketReferenceCurrencyUnit.toString().length - 1,
              marketReferenceCurrencyPriceInUsd:
                n.marketReferenceCurrencyPriceInUsd.toString(),
              networkBaseTokenPriceInUsd:
                n.networkBaseTokenPriceInUsd.toString(),
              networkBaseTokenPriceDecimals: n.networkBaseTokenPriceDecimals,
            },
          };
        }
        async getUserReservesHumanized({
          ...
          let { 0: n, 1: a } = await this.getUserReservesData({
            lendingPoolAddressProvider: e,
            user: t,
          });
          return {
            userReserves: n.map((n) => ({
              id: `${this.chainId}-${t}-${n.underlyingAsset}-${e}`.toLowerCase(),
              underlyingAsset: n.underlyingAsset.toLowerCase(),
              scaledATokenBalance: n.scaledATokenBalance.toString(),
              usageAsCollateralEnabledOnUser: n.usageAsCollateralEnabledOnUser,
              scaledVariableDebt: n.scaledVariableDebt.toString(),
            })),
            userEmodeCategoryId: a,
          };
        }
        async getEModes({ lendingPoolAddressProvider: e }) {
          if (!(0, a.isAddress)(e))
            throw Error("Lending pool address is not valid");
          return this._contract.getEModes(e);
        }
        async getEModesHumanized({ lendingPoolAddressProvider: e }) {
          if (!(0, a.isAddress)(e))
            throw Error("Lending pool address is not valid");
          return (await this.getEModes({ lendingPoolAddressProvider: e })).map(
            (e) => ({
              id: e.id,
              eMode: {
                ...
                collateralBitmap: e.eMode.collateralBitmap
                  .toBigInt()
                  .toString(2)
                  .padStart(256, "0"),
                label: e.eMode.label,
                borrowableBitmap: e.eMode.borrowableBitmap
                  .toBigInt()
                  .toString(2)
                  .padStart(256, "0"),
              },
        ...
        async getReservesHumanized({ lendingPoolAddressProvider: e }) {
          ...
          return {
            reservesData: t.map((t, n) => ({
              ...
              usageAsCollateralEnabled: t.usageAsCollateralEnabled,
              borrowingEnabled: t.borrowingEnabled,
              stableBorrowRateEnabled: t.stableBorrowRateEnabled,
              isActive: t.isActive,
              isFrozen: t.isFrozen,
              liquidityIndex: t.liquidityIndex.toString(),
              variableBorrowIndex: t.variableBorrowIndex.toString(),
              liquidityRate: t.liquidityRate.toString(),
              variableBorrowRate: t.variableBorrowRate.toString(),
              stableBorrowRate: t.stableBorrowRate.toString(),
              lastUpdateTimestamp: t.lastUpdateTimestamp,
              aTokenAddress: t.aTokenAddress.toString(),
              stableDebtTokenAddress: t.stableDebtTokenAddress.toString(),
              variableDebtTokenAddress: t.variableDebtTokenAddress.toString(),
              interestRateStrategyAddress:
                t.interestRateStrategyAddress.toString(),
              availableLiquidity: t.availableLiquidity.toString(),
              totalPrincipalStableDebt: t.totalPrincipalStableDebt.toString(),
              averageStableRate: t.averageStableRate.toString(),
              stableDebtLastUpdateTimestamp:
                t.stableDebtLastUpdateTimestamp.toNumber(),
              totalScaledVariableDebt: t.totalScaledVariableDebt.toString(),
              priceInMarketReferenceCurrency:
                t.priceInMarketReferenceCurrency.toString(),
              priceOracle: t.priceOracle,
              variableRateSlope1: t.variableRateSlope1.toString(),
              variableRateSlope2: t.variableRateSlope2.toString(),
              stableRateSlope1: t.stableRateSlope1.toString(),
              stableRateSlope2: t.stableRateSlope2.toString(),
              baseStableBorrowRate: t.baseStableBorrowRate.toString(),
              baseVariableBorrowRate: t.baseVariableBorrowRate.toString(),
              optimalUsageRatio: t.optimalUsageRatio.toString(),
              isPaused: t.isPaused,
              debtCeiling: t.debtCeiling.toString(),
              eModeCategoryId: t.eModeCategoryId,
              borrowCap: t.borrowCap.toString(),
              supplyCap: t.supplyCap.toString(),
              eModeLtv: t.eModeLtv,
              eModeLiquidationThreshold: t.eModeLiquidationThreshold,
              eModeLiquidationBonus: t.eModeLiquidationBonus,
              eModePriceSource: t.eModePriceSource.toString(),
              eModeLabel: t.eModeLabel.toString(),
              borrowableInIsolation: t.borrowableInIsolation,
              accruedToTreasury: t.accruedToTreasury.toString(),
              unbacked: t.unbacked.toString(),
              isolationModeTotalDebt: t.isolationModeTotalDebt.toString(),
    ...
    91478: (e, t, n) => {
      ...
      var a = n(66733),
        r = n(55206);
      class i extends r.ContractFactory {
        constructor(e) {
          super(s, d, e);
        }
        static connect(e, t) {
          return new r.Contract(e, s, t);
        }
      }
      let s = [
          {
      ...
      class o {
        constructor(e) {
          this._contract = i.connect(
            e.walletBalanceProviderAddress,
            e.provider
          );
        }
        async balanceOf(e, t) {
          if (!(0, a.isAddress)(e))
            throw Error("User address is not a valid ethereum address");
          if (!(0, a.isAddress)(t))
            throw Error("Token address is not a valid ethereum address");
          return this._contract.balanceOf(e, t);
        }
        async batchBalanceOf(e, t, n = {}) {
          if (!e.every((e) => (0, a.isAddress)(e)))
            throw Error(
              "One of the user address is not a valid ethereum address"
            );
          if (!t.every((e) => (0, a.isAddress)(e)))
            throw Error(
              "One of the token address is not a valid ethereum address"
            );
          let r = n.blockTag ? n.blockTag : "latest";
          return this._contract.batchBalanceOf(e, t, { blockTag: r });
        }
        async getUserWalletBalancesForLendingPoolProvider(e, t) {
          if (!(0, a.isAddress)(e))
            throw Error("User address is not a valid ethereum address");
          if (!(0, a.isAddress)(t))
            throw Error(
          ...
          return this._contract.getUserWalletBalances(t, e);
        }
      }
    },
  },
