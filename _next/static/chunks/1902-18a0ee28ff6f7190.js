try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "4e904167-3944-4965-90c8-eebbe5fb1d45"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-4e904167-3944-4965-90c8-eebbe5fb1d45"));
  })();
} catch (e) {}
  ...
  [1902],
  {
    ...
    3605: (e, t, r) => {
      ...
      function i(e) {
        ...
        return s
          ? ((s.status = h(s)),
            ...
            a && s.kind === u.PrefetchKind.TEMPORARY && (s.kind = a),
            s)
          : c({
              tree: n,
              url: t,
      ...
      function s(e) {
        let {
          ...
          s = o.couldBeIntercepted ? a(l, i, t) : a(l, i),
          c = {
      ...
      function c(e) {
        let { url: t, kind: r, tree: o, nextUrl: i, prefetchCache: s } = e,
          c = a(t, r),
    ...
    16699: (e, t, r) => {
      ...
      async function _(e, t) {
        ...
        try {
          ...
          let t = l
            ...
            v = !!(null == (c = r.headers.get("vary"))
              ? void 0
              : c.includes(u.NEXT_URL)),
          ...
          let E = g
              ...
              : r.body,
            O = await b(E);
          if ((0, s.getAppBuildId)() !== O.b) return p(r.url);
          return {
      ...
      async function y(e, t, r, n) {
        let l = new URL(e);
        (0, c.setCacheBustingSearchParam)(l, t);
        let o = await fetch(l, {
        ...
        Object.defineProperty(t, "invalidateCacheBelowFlightSegmentPath", {
          ...
          get: function () {
            return function e(t, r, l) {
              ...
              if (
                ((f && f !== c) ||
                  ((f = new Map(c)), t.parallelRoutes.set(a, f)),
                o)
              )
    ...
    23221: (e, t, r) => {
      ...
      let n = r(83156).createRenderParamsFromClient;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, "__esModule", { value: !0 }),
    ...
    24693: (e, t, r) => {
      ...
      let n = r(15295),
        ...
        l = r(81868),
        o = r(67018);
      function a(e, t, r, a, i, s) {
        let { segmentPath: c, seedData: f, tree: d, head: p } = a,
          h = t,
          _ = r;
        for (let t = 0; t < c.length; t += 2) {
          ...
          if (y) {
            if (f && (!R || !R.lazyData || R === m)) {
              ...
              (R = {
                lazyData: null,
                rsc: s || t !== o.PAGE_SEGMENT_KEY ? r : null,
                prefetchRsc: null,
                head: null,
                prefetchHead: null,
                loading: l,
                parallelRoutes: s && m ? new Map(m.parallelRoutes) : new Map(),
                navigatedAt: e,
              }),
                m && s && (0, n.invalidateCacheByRouterState)(R, m, d),
                s && (0, u.fillLazyItemsTillLeafWithHead)(e, R, m, d, f, p, i),
                g.set(b, R);
            }
            continue;
          }
    ...
    24970: (e, t, r) => {
      ...
      function c(e) {
        ...
        let {
          ...
          v = d.join("/"),
          g = (0, s.getFlightDataPartsFromPath)(f[0]),
        ...
        let j = new Map();
        (null === p || 0 === p.size) &&
          (0, u.fillLazyItemsTillLeafWithHead)(c, O, void 0, m, R, E, void 0);
        let T = {
          tree: m,
          cache: O,
          prefetchCache: j,
        ...
        Object.defineProperty(t, "applyRouterStatePatchToTree", {
          ...
          get: function () {
            return function e(t, r, n, i) {
              ...
              let [_, y] = t;
              if (!(0, l.matchSegment)(_, c)) return null;
              if (2 === t.length) s = a(f[y], n);
              else if (
                null === (s = e((0, u.getNextFlightSegmentPath)(t), f[y], n, i))
              )
                return null;
              let b = [t[0], { ...f, [y]: s }, d, p];
              return (
        ...
        Object.defineProperty(t, "clearCacheNodeDataForSegmentPath", {
          ...
          get: function () {
            return function e(t, r, l) {
              let o = l.length <= 2,
                [a, i] = l,
                s = (0, u.createRouterCacheKey)(i),
                c = r.parallelRoutes.get(a),
                f = t.parallelRoutes.get(a);
              (f && f !== c) || ((f = new Map(c)), t.parallelRoutes.set(a, f));
    ...
    35912: (e, t, r) => {
      ...
      function c(e, t, r, c, d) {
        ...
        for (let t of r) {
          ...
          let { seedData: o, isRootRender: s, pathToSegment: d } = t,
            b = ["", ...d];
          r = f(r, Object.fromEntries(c.searchParams));
    ...
    42418: (e, t, r) => {
      ...
      function d() {
        return (
          null == c || c("usePathname()"), (0, n.useContext)(l.PathnameContext)
        );
      }
      function p() {
      ...
      function h() {
        return (
          null == c || c("useParams()"), (0, n.useContext)(l.PathParamsContext)
        );
      }
      function _(e) {
        void 0 === e && (e = "children"),
    ...
    42704: (e, t, r) => {
      ...
      let n = r(13351).createRenderSearchParamsFromClient;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, "__esModule", { value: !0 }),
    ...
    43781: (e, t, r) => {
      ...
      function c(e) {
        (0, o.startTransition)(() => {
          null == a || a.setOptimisticLinkStatus(s),
        ...
        return b.lazyData.then(
          async (r) => {
            ...
            for (let r of ((b.lazyData = null), n)) {
              ...
              let E = c ? (0, u.createHrefFromUrl)(c) : void 0;
    ...
    45504: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(70452);
      let n = r(82865),
        u = r(73053);
      (0, n.appBootstrap)(() => {
    ...
    45573: (e, t, r) => {
      ...
      function f(e) {
        let { children: t } = e,
          r = (0, o.useRouter)();
        return (0, u.jsx)(c, { router: r, children: t });
      }
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    47132: (e, t, r) => {
      ...
      function j(e) {
        let { segmentPath: t, children: r } = e,
          n = (0, a.useContext)(s.GlobalLayoutRouterContext);
        if (!n)
          throw Object.defineProperty(
      ...
      function T(e) {
        let { tree: t, segmentPath: r, cacheNode: n, url: u } = e,
          i = (0, a.useContext)(s.GlobalLayoutRouterContext);
        if (!i)
          throw Object.defineProperty(
            Error("invariant global layout router not mounted"),
            "__NEXT_ERROR_CODE",
        ...
        if (!y) {
          ...
          if (null === e) {
            let t = (function e(t, r) {
              ...
              s = Date.now();
            (n.lazyData = e =
              (0, c.fetchServerResponse)(new URL(u, location.origin), {
                flightRouterState: t,
      ...
      function M(e) {
        let {
          ...
          R = (0, a.useContext)(s.LayoutRouterContext);
        if (!R)
          throw Object.defineProperty(
    ...
    47159: (e, t, r) => {
      ...
      function s(e, t, r, o, a, s, d, p, h) {
        return (function e(t, r, o, a, s, d, p, h, _, y, b) {
          let v = o[1],
            g = a[1],
            m = null !== d ? d[2] : null;
          s || (!0 === a[4] && (s = !0));
              ...
              (o =
                w === n.DEFAULT_SEGMENT_KEY
                  ? void 0 !== f
                    ...
                    : c(t, f, a, x, s, void 0 !== S ? S : null, p, h, M, b)
                  : _ && 0 === Object.keys(a[1]).length
                  ? c(t, f, a, x, s, void 0 !== S ? S : null, p, h, M, b)
                  : void 0 !== f &&
                    void 0 !== C &&
                    (0, u.matchSegment)(w, C) &&
                    void 0 !== x &&
                    void 0 !== f
                  ? e(t, x, f, a, s, S, p, h, _, M, b)
                  : c(t, f, a, x, s, void 0 !== S ? S : null, p, h, M, b))
            ) {
      ...
      function c(e, t, r, n, u, s, c, p, h, _) {
        return !u && (void 0 === t || (0, o.isNavigatingToNewRootLayout)(t, r))
          ? i
          : (function e(t, r, n, u, o, i, s, c) {
              let p,
                h,
                _,
                y,
              ...
              else if (null === u) return d(t, r, null, o, i, s, c);
              else if (
                ((p = u[1]),
                (h = u[3]),
                (_ = v ? o : null),
      ...
      function v(e, t, r, u) {
        ...
        null !== o && o(e, t),
          (0, a.dispatchAppRouterAction)({
            ...
            url: l,
            isExternalUrl: (0, s.isExternalURL)(l),
          ...
          !(function e(t, r, n, o, a) {
                    ...
                    (w(a) &&
                      ...
                      (s =
                        ...
                        (null == a.key || (t && t.key === a.key)
                          ...
                          : ("" + a.key).replace(M, "$&/") + "/") +
                        d),
                      (a = S(i.type, s, void 0, void 0, void 0, i.props))),
                    r.push(a)),
                1
              );
            d = 0;
            ...
            if (O(t))
              ...
              for (t = y.call(t), y = 0; !(o = t.next()).done; )
                (f = p + A((o = o.value), y++)), (d += e(o, r, n, f, a));
            else if ("object" === f) {
              ...
              return (
                ...
                x.then(
                  (d) => {
                    ...
                    if ("string" == typeof y) return g(t, T, y, M);
                    let N = E ? (0, u.createHrefFromUrl)(E) : w;
                    if (
                      S &&
                    ...
                    for (let e of y) {
                      let {
                        ...
                        v = e.tree,
                        E = ["", ...r],
                        P = (0, o.applyRouterStatePatchToTree)(E, D, v, w);
                      if (
                        (null === P &&
                          (P = (0, o.applyRouterStatePatchToTree)(E, C, v, w)),
                        null !== P)
                      ) {
                        if (u && y && O) {
                          ...
                          if (null !== e) {
                            if (null === e.route) return g(t, T, w, M);
                            P = e.route;
                            let r = e.node;
                            null !== r && (T.cache = r);
                          ...
                          for (let t of (A.status !==
                            ...
                            ? (u = (0, f.applyFlightData)(j, U, n, e, A))
                            : ((u = (function (e, t, r, n) {
                                let u = !1;
    ...
    73053: (e, t, r) => {
      ...
      (globalThis._sentryRewritesTunnelPath = void 0),
        (globalThis.SENTRY_RELEASE = { id: "3.21.11" }),
        ...
        (globalThis._sentryRouteManifest =
          '{"dynamicRoutes":[{"path":"/app/:not-found*","regex":"^/app/(.+)$","paramNames":["not-found"]},{"path":"/landing/:not-found*","regex":"^/landing/(.+)$","paramNames":["not-found"]},{"path":"/landing/bridge/activity/:hash","regex":"^/landing/bridge/activity/([^/]+)$","paramNames":["hash"]},{"path":"/pro/:not-found*","regex":"^/pro/(.+)$","paramNames":["not-found"]},{"path":"/pro/reserve/:slug","regex":"^/pro/reserve/([^/]+)$","paramNames":["slug"]},{"path":"/pro/wallet/watch/:slug","regex":"^/pro/wallet/watch/([^/]+)$","paramNames":["slug"]}],"staticRoutes":[{"path":"/app"},{"path":"/landing"},{"path":"/landing/about"},{"path":"/landing/brand"},{"path":"/landing/bridge"},{"path":"/landing/bridge/activity"},{"path":"/landing/contact"},{"path":"/landing/governance"},{"path":"/landing/privacy"},{"path":"/landing/providers"},{"path":"/landing/terms"},{"path":"/landing/trade"},{"path":"/landing/trade/activity"},{"path":"/landing/unlock"},{"path":"/landing/usd1"},{"path":"/landing/usd1/risk-disclosures"},{"path":"/landing/wlfi/risk-disclosures"},{"path":"/landing/wlfi/terms"},{"path":"/landing/docs"},{"path":"/pro"},{"path":"/pro/faucet"},{"path":"/pro/history"},{"path":"/pro/markets"},{"path":"/pro/privacy"},{"path":"/pro/terms"}]}'),
        (e.exports = r(43398));
    },
    73887: (e, t, r) => {
      "use strict";
      ...
      function l(e, t, r, l, o) {
        let { tree: a, seedData: i, head: s, isRootRender: c } = l;
        if (null === i) return !1;
        if (c) {
          let u = i[1];
          (r.loading = i[3]),
            (r.rsc = u),
            (r.prefetchRsc = null),
            (0, n.fillLazyItemsTillLeafWithHead)(e, r, t, a, i, s, o);
        } else
          (r.rsc = t.rsc),
    ...
    77343: (e, t, r) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        Object.defineProperty(t, "fillLazyItemsTillLeafWithHead", {
          enumerable: !0,
          get: function () {
            return function e(t, r, l, o, a, i, s) {
              ...
              for (let c in o[1]) {
                let f,
                  ...
                  _ = null !== a && void 0 !== a[2][c] ? a[2][c] : null;
                if (l) {
                  let n = l.parallelRoutes.get(c);
                  if (n) {
                    let l,
                      o =
                        (null == s ? void 0 : s.kind) === "auto" &&
                        s.status === u.PrefetchCacheEntryStatus.reusable,
                      a = new Map(n),
                      f = a.get(h);
                    (l =
                      null !== _
                      ...
                      a.set(h, l),
                      e(t, l, f, d, _ || null, i, s),
                      r.parallelRoutes.set(c, a);
                    continue;
                  }
                }
                if (null !== _) {
                ...
                let y = r.parallelRoutes.get(c);
                y ? y.set(h, f) : r.parallelRoutes.set(c, new Map([[h, f]])),
                  e(t, f, void 0, d, _, i, s);
              }
            };
          },
        });
    ...
    77377: (e, t, r) => {
      ...
      function K(e, t, r, n) {
        ...
        if (l) t.bound && (l = Promise.all([l, t.bound]));
          ...
          if (!t.bound) return R((l = s(u)), t.id, t.bound), l;
                ...
                if (t[0] === p) {
                  if (
                    ...
                    if (((N = (t = N).parent), t.errored))
                      e = k((e = new E("rejected", null, t.value)));
                    else if (0 < t.deps) {
            ...
            if (a.done) r || I(e, Error("Connection closed."));
              ...
              for (
                ...
                if (-1 < b)
                  ...
                  })(e, a, p, _, (h = new Uint8Array(s.buffer, v, b - c))),
                    (c = b),
                    3 === f && c++,
                    (h = a = p = f = 0),
                    (_.length = 0);
                else {
                  (s = new Uint8Array(s.buffer, v, s.byteLength - c)),
                    _.push(s),
                    (h -= s.byteLength);
                  break;
                }
          ...
          return new Promise(function (r, n) {
            var u = (function (e, t, r, n, u) {
                      ...
                      try {
                        ...
                        return (
                          ...
                          r.read().then(function e(i) {
                            if (i.done) l.append(t + a, "C"), 0 == --s && n(l);
                            else
                              try {
                                var c = JSON.stringify(i.value, o);
                                l.append(t + a, c), r.read().then(e, u);
                              } catch (e) {
                                u(e);
                              }
                          }, u),
              ...
              var i = 1,
                ...
                R = a(e, 0);
              return (
                null === c ? n(R) : (c.set(t + "0", R), 0 === s && n(c)),
                function () {
    ...
    94271: (e, t, r) => {
      ...
      function U(e) {
        ...
        let { pushRef: M } = p;
        if (M.mpaNavigation) {
          if (w.pendingMpaPath !== h) {
            let e = window.location;
            M.pendingPush ? e.assign(h) : e.replace(h), (w.pendingMpaPath = h);
          }
        ...
        let { cache: A, tree: x, nextUrl: U, focusAndScrollRef: I } = p,
          k = (0, o.useMemo)(() => (0, v.findHeadInCache)(A, x[1]), [A, x]),
          L = (0, o.useMemo)(() => (0, E.getSelectedParams)(x), [x]),
          F = (0, o.useMemo)(
            () => ({
              parentTree: x,
              parentCacheNode: A,
        ...
        let K = (0, l.jsxs)(b.RedirectBoundary, {
          children: [t, A.rsc, (0, l.jsx)(y.AppRouterAnnouncer, { tree: x })],
        });
        return (
          (K = s
    ...
    96242: (e, t, r) => {
      ...
      async function S(e, t, r) {
        ...
        let S = E
            ...
            : void 0,
          M = v.headers.get("content-type"),
          A = !!(M && M.startsWith(l.RSC_CONTENT_TYPE_HEADER));
        if (!A && !S)
          throw Object.defineProperty(
            Error(
              v.status >= 400 && "text/plain" === M
                ? await v.text()
        ...
        if (A) {
          ...
          (c = S ? void 0 : e.a), (f = (0, g.normalizeFlightData)(e.f));
        } else (c = void 0), (f = void 0);
        return {
          actionResult: c,
          actionFlightData: f,
          redirectLocation: S,
          ...
          async (y) => {
            ...
            if (
              (S &&
                ...
                (u.canonicalUrl = g = (0, s.createHrefFromUrl)(S, !1))),
              !T)
            )
              return (r(j), S)
            ...
            for (let n of T) {
              let { tree: a, seedData: s, head: p, isRootRender: y } = n;
              ...
              S && g
                ? (C ||
                    ((0, E.createSeededPrefetchCacheEntry)({
                      ...
                      prefetchCache: e.prefetchCache,
                      nextUrl: e.nextUrl,
                      kind: M ? a.PrefetchKind.FULL : a.PrefetchKind.AUTO,
                    }),
