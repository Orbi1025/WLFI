try {
  !(function () {
    ...
    r &&
      ...
      (e._sentryDebugIds[r] = "8a7339b4-53b8-4beb-917d-2c5ecf354304"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-8a7339b4-53b8-4beb-917d-2c5ecf354304"));
  })();
} catch (e) {}
("use strict");
      ...
      let F = () => {
          ...
          return {
            ...
            theme: {
              ...
              gradientColorStopPositions: [I, j],
              inset: q(),
              margin: q(),
              opacity: X(),
              padding: B(),
            ...
            classGroups: {
              ...
              grow: [{ grow: U() }],
              shrink: [{ shrink: U() }],
              order: [{ order: ["first", "last", "none", G, P] }],
              "grid-cols": [{ "grid-cols": [D] }],
              "col-start-end": [{ col: ["auto", { span: ["full", G, P] }, P] }],
              "col-start": [{ "col-start": H() }],
              "col-end": [{ "col-end": H() }],
              "grid-rows": [{ "grid-rows": [D] }],
              "row-start-end": [{ row: ["auto", { span: [G, P] }, P] }],
              ...
              "line-clamp": [{ "line-clamp": ["none", C, S] }],
              leading: [
                {
                  leading: [
                    "none",
              ...
              "outline-w": [{ outline: [z, j] }],
              "outline-color": [{ outline: [e] }],
              "ring-w": [{ ring: F() }],
              "ring-w-inset": ["ring-inset"],
              "ring-color": [{ ring: [e] }],
              "ring-opacity": [{ "ring-opacity": [y] }],
              "ring-offset-w": [{ "ring-offset": [z, j] }],
              "ring-offset-color": [{ "ring-offset": [e] }],
              shadow: [{ shadow: ["", "inner", "none", N, T] }],
            ...
            : b(
                () =>
                  ((
                    ...
                    for (let l in (H(e, "cacheSize", r),
                    H(e, "prefix", o),
                    H(e, "separator", t),
                    H(e, "experimentalParseClassName", n),
                    s))
                      J(e[l], s[l]);
                    for (let r in l) K(e[r], l[r]);
                    return e;
                  })(F(), e),
                ...r
              );
