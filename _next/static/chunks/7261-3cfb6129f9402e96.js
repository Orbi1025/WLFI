try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "636a6943-654c-4eff-ada7-7423db0975ef"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-636a6943-654c-4eff-ada7-7423db0975ef"));
  })();
} catch (e) {}
("use strict");
    ...
    27261: (e, t, n) => {
      ...
      function g(e) {
        let t,
          n,
          r,
          [i, g] = (0, u.useOptimistic)(d.IDLE_LINK_STATUS),
          m = (0, u.useRef)(null),
          {
            href: _,
            as: P,
        ...
        w && (n = u.default.Children.only(t));
        let K = w ? n && "object" == typeof n && n.ref : L,
          B = u.default.useCallback(
            (e) => (
              null !== U &&
                (m.current = (0, d.mountLinkInstance)(e, D, U, R, k, g)),
              () => {
                m.current &&
                  ((0, d.unmountLinkForCurrentNavigation)(m.current),
                  (m.current = null)),
          ...
          z = {
            ...
            onMouseEnter(e) {
              w || "function" != typeof S || S(e),
                ...
                U && k && (0, d.onNavigationIntent)(e.currentTarget, !0 === x);
            },
        ...
        return (
          (0, c.isAbsoluteUrl)(F)
            ? (z.href = F)
            : (w && !O && ("a" !== n.type || "href" in n.props)) ||
              (z.href = (0, s.addBasePath)(F)),
          (r = w
            ? u.default.cloneElement(n, z)
            : (0, o.jsx)("a", { ...M, ...z, children: t })),
          (0, o.jsx)(b.Provider, { value: i, children: r })
        );
      }
      n(76355);
