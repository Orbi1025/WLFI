try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "a1e3a083-ca92-448c-9b59-022a36da89a2"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-a1e3a083-ca92-448c-9b59-022a36da89a2"));
  })();
} catch (e) {}
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3354],
  {
      ...
      !(function (t) {
        ...
        (_.prototype._prepare = function () {
          ...
          for (
            ...
            (a = t >> 2),
              (this._Ke[a][t % 4] = i[t]),
              (this._Kd[e - a][t % 4] = i[t]);
          for (var a, o, s = 0, c = n; c < r; ) {
            if (
              ((o = i[n - 1]),
              (i[0] ^=
                (u[(o >> 16) & 255] << 24) ^
          ...
          (_.prototype.encrypt = function (e) {
            ...
            for (
              var t = this._Ke.length - 1, r = [0, 0, 0, 0], n = S(e), i = 0;
              i < 4;
              i++
            )
              n[i] ^= this._Ke[0][i];
            ...
            for (var s, c = a(16), i = 0; i < 4; i++)
              (s = this._Ke[t][i]),
                (c[4 * i] = (u[(n[i] >> 24) & 255] ^ (s >> 24)) & 255),
                (c[4 * i + 1] =
                  (u[(n[(i + 1) % 4] >> 16) & 255] ^ (s >> 16)) & 255),
                (c[4 * i + 2] =
                  (u[(n[(i + 2) % 4] >> 8) & 255] ^ (s >> 8)) & 255),
                (c[4 * i + 3] = (u[255 & n[(i + 3) % 4]] ^ s) & 255);
            return c;
          }),
          (_.prototype.decrypt = function (e) {
            ...
            for (
              var t = this._Kd.length - 1, r = [0, 0, 0, 0], n = S(e), i = 0;
              i < 4;
              i++
            )
              n[i] ^= this._Kd[0][i];
            ...
            for (var s, c = a(16), i = 0; i < 4; i++)
              (s = this._Kd[t][i]),
                (c[4 * i] = (d[(n[i] >> 24) & 255] ^ (s >> 24)) & 255),
                (c[4 * i + 1] =
                  (d[(n[(i + 3) % 4] >> 16) & 255] ^ (s >> 16)) & 255),
                (c[4 * i + 2] =
                  (d[(n[(i + 2) % 4] >> 8) & 255] ^ (s >> 8)) & 255),
                (c[4 * i + 3] = (d[255 & n[(i + 1) % 4]] ^ s) & 255);
            return c;
          });
        var P = function (e) {
        ...
        var M = function (e) {
          ...
          0 === e || e || (e = 1),
            "number" == typeof e
              ? ((this._counter = a(16)), this.setValue(e))
              : this.setBytes(e);
        };
        ...
        (I.prototype.encrypt = function (e) {
          ...
          (e.exports = {
            AES: _,
            Counter: M,
            ModeOfOperation: { ecb: P, cbc: R, cfb: N, ofb: C, ctr: I },
            utils: {
              hex: c,
              utf8: {
                toBytes: function (e) {
    ...
    6865: (e, t, r) => {
      ...
      var n, i;
      r.r(t),
        r.d(t, { ErrorCode: () => i, LogLevel: () => n, Logger: () => d });
      let a = !1,
        o = !1,
      ...
      class d {
        ...
        _log(e, t) {
          ...
          null == s[r] &&
            ...
            c > s[r] || console.log.apply(console, t);
        }
        debug(...e) {
          this._log(d.levels.DEBUG, e);
        }
        info(...e) {
          this._log(d.levels.INFO, e);
        }
        warn(...e) {
          this._log(d.levels.WARNING, e);
        }
        makeError(e, t, r) {
          if (o) return this.makeError("censored error", t, {});
          t || (t = d.errors.UNKNOWN_ERROR), r || (r = {});
          let n = [];
        ...
        throwArgumentError(e, t, r) {
          return this.throwError(e, d.errors.INVALID_ARGUMENT, {
            argument: t,
            value: r,
          });
        }
        ...
        checkSafeUint53(e, t) {
          "number" == typeof e &&
            ...
            (e < 0 || e >= 0x1fffffffffffff) &&
              this.throwError(t, d.errors.NUMERIC_FAULT, {
        ...
        checkNew(e, t) {
          (e === Object || null == e) &&
            this.throwError("missing new", d.errors.MISSING_NEW, {
              name: t.name,
            });
        }
        checkAbstract(e, t) {
        ...
        static globalLogger() {
          return l || (l = new d("logger/5.8.0")), l;
        }
        ...
        static setLogLevel(e) {
          ...
          if (null == t)
            return void d.globalLogger().warn("invalid log level - " + e);
          c = t;
        }
        static from(e) {
          return new d(e);
      ...
      (d.errors = i), (d.levels = n);
    },
    8511: (e, t, r) => {
      "use strict";
      var n = r(88546).rotr32;
      function i(e, t, r) {
        return (e & t) ^ (e & r) ^ (t & r);
      }
    ...
    8676: (e, t, r) => {
      ...
      var n = r(20037),
        i = r(6865);
      let a = new i.Logger("random/5.8.0"),
        o = (function () {
      ...
      function c(e) {
        (e <= 0 || e > 1024 || e % 1 || e != e) &&
          a.throwArgumentError("invalid length", "length", e);
        let t = new Uint8Array(e);
        return s.getRandomValues(t), (0, n.arrayify)(t);
      }
      (s && s.getRandomValues) ||
        (a.warn("WARNING: Missing strong random number source"),
        (s = {
    ...
    8898: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { Base32: () => o, Base58: () => s, BaseX: () => a });
      var n = r(20037),
        i = r(71182);
      class a {
        constructor(e) {
    ...
    13679: (e, t, r) => {
      ...
      var n = r(20037),
        ...
        a = r(40138),
        o = r(16421);
      let s = new (r(6865).Logger)("address/5.8.0");
      function c(e) {
        ...
        let i = (0, n.arrayify)((0, a.keccak256)(r));
        ...
        if (
          ...
          "0x" !== e.substring(0, 2) && (e = "0x" + e),
            ...
            e.match(/([A-F].*[a-f])|([a-f].*[A-F])/) &&
              t !== e &&
              s.throwArgumentError("bad address checksum", "address", e);
        else if (e.match(/^XE[0-9]{2}[0-9A-Za-z]{30,31}$/)) {
          for (
            e.substring(2, 4) !== u(e) &&
              s.throwArgumentError("bad icap checksum", "address", e),
              t = (0, i.Os)(e.substring(4));
            t.length < 40;
      ...
      function x(e) {
        let t = (0, i.ii)(d(e).substring(2)).toUpperCase();
      ...
      function p(e) {
        ...
        let r = (0, n.stripZeros)(
          (0, n.arrayify)(i.gH.from(e.nonce).toHexString())
        );
        return d(
          (0, n.hexDataSlice)((0, a.keccak256)((0, o.encode)([t, r])), 12)
        );
      }
      function g(e, t, r) {
        return (
          32 !== (0, n.hexDataLength)(t) &&
            s.throwArgumentError("salt must be 32 bytes", "salt", t),
          ...
          d(
            (0, n.hexDataSlice)(
              (0, a.keccak256)((0, n.concat)(["0xff", d(e), t, r])),
              12
            )
          )
        );
    ...
    14408: (e, t, r) => {
      ...
      function s(e) {
        return (
          "string" == typeof e && (e = (0, a.YW)(e)),
          (0, i.keccak256)(
            (0, n.concat)([(0, a.YW)(o), (0, a.YW)(String(e.length)), e])
          )
        );
      }
    },
    14546: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { keccak256: () => x, pack: () => h, sha256: () => p });
      var n = r(95257),
        i = r(20037),
        a = r(40138),
        o = r(92921),
              ...
              (function e(t, r, a) {
                ...
                if (o) {
                  ...
                  return (
                    ...
                    a && (e = 256),
                    (r = n.gH.from(r).toTwos(e)),
                    (0, i.zeroPad)(r, e / 8)
                  );
                }
                if ((o = t.match(l))) {
                  let e = parseInt(o[1]);
                  return ((String(e) !== o[1] || 0 === e || e > 32) &&
                ...
                if ((o = t.match(u)) && Array.isArray(r)) {
                  let n = o[1];
    ...
    15940: (e, t, r) => {
      ...
      var n = r(71182),
        ...
        a = r(65994),
        o = r(87709);
      let s = new i.Logger(a.r),
        c = 1;
      function l(e, t) {
        let r = "Web3LegacyFetcher";
        return function (e, i) {
          let a = { method: e, params: i, id: c++, jsonrpc: "2.0" };
          return new Promise((e, i) => {
            this.emit("debug", {
              action: "request",
              fetcher: r,
              request: (0, n.deepCopy)(a),
              provider: this,
            }),
              t(a, (t, n) => {
                if (t)
      ...
      class f extends o.F {
        constructor(e, t) {
          ...
          let r = null,
            i = null,
            a = null;
          if ("function" == typeof e) (r = "unknown:"), (i = e);
          else {
            if (
              ((r = e.host || e.path || "") ||
                !e.isMetaMask ||
          ...
          super(r, t),
            ...
            (0, n.defineReadOnly)(this, "provider", a);
        }
        send(e, t) {
    ...
    16421: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { decode: () => u, encode: () => c });
      var n = r(20037),
        i = r(6865);
      let a = new i.Logger("rlp/5.8.0");
      function o(e) {
        let t = [];
      ...
      function f(e, t) {
        ...
        if (e[t] >= 184) {
          ...
          let c = (0, n.hexlify)(e.slice(t + 1 + r, t + 1 + r + o));
          return { consumed: 1 + r + o, result: c };
        }
        if (e[t] >= 128) {
          let r = e[t] - 128;
          t + 1 + r > e.length &&
            a.throwError("data too short", i.Logger.errors.BUFFER_OVERRUN, {});
          let o = (0, n.hexlify)(e.slice(t + 1, t + 1 + r));
      ...
      function u(e) {
        ...
        return (
          r.consumed !== t.length &&
            a.throwArgumentError("invalid rlp data", "data", e),
          r.result
        );
      }
    },
    19744: (e, t, r) => {
      ...
      var n,
        i,
        a = r(20037);
      let o = new (r(6865).Logger)("strings/5.8.0");
      ...
      function l(e, t) {
        ...
        for (; n < e.length; ) {
          ...
          if (null !== c) {
            if (c > 1114111) {
              n += t(i.OUT_OF_RANGE, n - 1 - o, e, r, c);
              continue;
            }
            if (c >= 55296 && c <= 57343) {
              n += t(i.UTF16_SURROGATE, n - 1 - o, e, r, c);
              continue;
            }
            if (c <= s) {
              n += t(i.OVERLONG, n - 1 - o, e, r, c);
              continue;
            }
            r.push(c);
          }
    ...
    20037: (e, t, r) => {
      ...
      let n = new (r(6865).Logger)("bytes/5.8.0");
      function i(e) {
      ...
      function p(e, t) {
        if ((t || (t = {}), "number" == typeof e)) {
          ...
          let t = "";
          for (; e; ) (t = x[15 & e] + t), (e = Math.floor(e / 16));
      ...
      function y(e) {
        let t = v(p(e, { hexPad: "left" }));
        return "0x" === t ? "0x0" : t;
      }
      function v(e) {
        "string" != typeof e && (e = p(e)),
          h(e) || n.throwArgumentError("invalid hex string", "value", e),
          (e = e.substring(2));
        let t = 0;
      ...
      function E(e) {
        return p(f([(e = A(e)).r, e.s, e.recoveryParam ? "0x1c" : "0x1b"]));
      }
    },
    22437: (e, t, r) => {
      "use strict";
      ...
      function o(e) {
        ...
        return (0, i.hexlify)((0, i.concat)([t, n.j]).slice(0, 32));
      }
      function s(e) {
        ...
        (y.prototype._prepareBlock = function (e, t) {
          ...
          for (; n < r.length; n += 2) {
            var i = (function (e, t) {
              ...
              g = r[n - 32],
              m = r[n - 31];
            (r[n] = h(i, a, f, u, d, p, g, m)),
              (r[n + 1] = x(i, a, f, u, d, p, g, m));
          }
        }),
        (y.prototype._update = function (e, t) {
          ...
          for (var P = 0; P < r.length; P += 2) {
            var R = S,
              ...
              L = r[P],
              F = r[P + 1],
              D = p(R, N, C, M, I, T, O, B, L, F),
              U = g(R, N, C, M, I, T, O, B, L, F);
            (R = (function (e, t) {
    ...
    25667: (e, t, r) => {
      ...
      r.r(t),
        r.d(t, {
          decryptCrowdsale: () => g,
          decryptJsonWallet: () => y,
          decryptJsonWalletSync: () => v,
          decryptKeystore: () => b.Yc,
          decryptKeystoreSync: () => b.xQ,
          encryptKeystore: () => b.w,
          getJsonWalletAddress: () => m.cZ,
          isCrowdsaleWallet: () => m.y2,
          isKeystoreWallet: () => m.kZ,
        });
      var n = r(704),
        i = r.n(n),
        a = r(13679),
      ...
      function g(e, t) {
        let r = JSON.parse(e);
        t = (0, h.Qq)(t);
        let n = (0, a.getAddress)((0, h.oe)(r, "ethaddr")),
          f = (0, h.m0)((0, h.oe)(r, "encseed"));
        (f && f.length % 16 == 0) ||
          x.throwArgumentError("invalid encseed", "json", e);
        let u = (0, o.arrayify)((0, c.A)(t, t, 2e3, 32, "sha256")).slice(0, 16),
          d = f.slice(0, 16),
          g = f.slice(16),
          m = new (i().ModeOfOperation.cbc)(u, d),
          b = i().padding.pkcs7.strip((0, o.arrayify)(m.decrypt(g))),
          y = "";
        for (let e = 0; e < b.length; e++) y += String.fromCharCode(b[e]);
        let v = (0, l.YW)(y);
        return new p({
          _isCrowdsaleAccount: !0,
          address: n,
          privateKey: (0, s.keccak256)(v),
        });
      }
      var m = r(1582),
        b = r(72490);
      ...
      function v(e, t) {
        if ((0, m.y2)(e)) return g(e, t);
        if ((0, m.kZ)(e)) return (0, b.xQ)(e, t);
        throw Error("invalid JSON wallet");
      }
    },
    27167: (e, t, r) => {
      "use strict";
      r.d(t, { Wh: () => P, Q8: () => k, uV: () => S, kM: () => _ });
      var n = r(20037),
        i = r(19744),
        a = r(40138),
        o = r(6865),
      ...
      function u(e, t) {
        ...
        for (let e = 0; e < n; e++)
          for (let t = 0; t < a[e]; t++) r.push(i[e] + t);
      ...
      let h = (function () {
          ...
          return (
            (e = (function (e) {
              ...
              for (;;) {
                ...
                if (0 == t) break;
                d.push(t);
                let o = h + Math.floor((x * a[t]) / i),
                  s = h + Math.floor((x * a[t + 1]) / i) - 1;
                for (; ((o ^ s) & 0x40000000) == 0; )
                  (u = ((u << 1) & 0x7fffffff) | f()),
                    (o = (o << 1) & 0x7fffffff),
                    (s = ((s << 1) & 0x7fffffff) | 1);
                for (; o & ~s & 0x20000000; )
                  (u = (0x40000000 & u) | ((u << 1) & 0x3fffffff) | f()),
                    (o = (o << 1) ^ 0x40000000),
        ...
        g = (function (e) {
          ...
          for (;;) {
            ...
            t.push(
              ((r = i),
              d(1 + (n = e)(), 1 + r, n).map((e) => [e[0], e.slice(1)]))
            );
          }
          return (function (e) {
            let t = {};
      ...
      function E(e) {
        let t = (0, i.YW)(
            y(
              (function (e, t) {
                ...
                for (; r.length; ) {
                  let e = (function (e, t) {
                    ...
                    for (; s; ) {
                      ...
                      if (
                        !(a =
                          null == (r = a.branches.find((e) => e.set.has(c)))
                            ? void 0
                            : r.node)
                      )
                        break;
                      if (a.save) i = c;
                      else if (a.check && c === i) break;
                      o.push(c),
                        a.fe0f &&
                          (o.push(65039), s > 0 && 65039 == e[s - 1] && s--),
                        a.valid &&
                          ((n = o.slice()),
                ...
                return y(String.fromCodePoint(...n).normalize("NFC"));
              })(e, b)
            )
          ),
          r = [];
        ...
        let n = 0;
        for (let e = 0; e < t.length; e++)
          46 === t[e] && (r.push(A(t.slice(n, e))), (n = e + 1));
        if (n >= t.length) throw Error("invalid ENS name; empty component");
        return r.push(A(t.slice(n))), r;
      }
      function k(e) {
        return E(e)
          .map((e) => (0, i._v)(e))
      ...
      function _(e) {
        "string" != typeof e &&
          v.throwArgumentError("invalid ENS name; not a string", "name", e);
        let t = w,
          r = E(e);
        for (; r.length; )
          t = (0, a.keccak256)((0, n.concat)([t, (0, a.keccak256)(r.pop())]));
    ...
    27570: (e, t, r) => {
      ...
      function k(e) {
        ...
        } else if (Array.isArray(e)) return "filter:*:" + E(e);
        else if (n.Rj.isForkEvent(e))
          throw (w.warn("not implemented"), Error("not implemented"));
        else if (e && "object" == typeof e)
          return "filter:" + (e.address || "*") + ":" + E(e.topics || []);
      ...
      let P = ["block", "network", "pending", "poll"];
      class R {
        constructor(e, t, r) {
      ...
      function C(e) {
        return (0, s.hexZeroPad)(o.gH.from(e).toHexString(), 32);
      }
      function M(e) {
        return a.Base58.encode(
          (0, s.concat)([e, (0, s.hexDataSlice)((0, d.sc)((0, d.sc)(e)), 0, 4)])
        );
      }
      let I = RegExp("^(ipfs)://(.*)$", "i"),
        T = [
      ...
      function B(e, t) {
        if ("0x" === e) return null;
        let r = o.gH.from((0, s.hexDataSlice)(e, t, t + 32)).toNumber(),
          n = o.gH.from((0, s.hexDataSlice)(e, r, r + 32)).toNumber();
        return (0, s.hexDataSlice)(e, r + 32, r + 32 + n);
      }
      function L(e) {
        return (
          e.match(/^ipfs:\/\/ipfs\//i)
      ...
      class U {
          ...
          return (
            this._supportsEip2544 ||
              (this._supportsEip2544 = this.provider
                ...
                .catch((e) => {
                  if (e.code === m.Logger.errors.CALL_EXCEPTION) return !1;
        ...
        _fetch(e, t) {
          return v(this, void 0, void 0, function* () {
            ...
            (yield this.supportsWildcard()) &&
              ((n = !0),
              (r.data = (0, s.hexConcat)([
                "0x9061b923",
                D([(0, l.Wh)(this.name), r.data]),
              ])));
            try {
              ...
              if (e.code === m.Logger.errors.CALL_EXCEPTION) return null;
              throw e;
            }
          });
        }
        ...
        _getAddress(e, t) {
          ...
          if (null != r.p2sh) {
            ...
            if (e) {
              let t = parseInt(e[1], 16);
              if (e[2].length === 2 * t && t >= 1 && t <= 75)
                return M((0, s.concat)([[r.p2sh], "0x" + e[2]]));
            }
          }
          if (null != r.prefix) {
            let e = n[1],
            ...
            if (
              ...
              let e = g().toWords(n.slice(2));
              return e.unshift(t), g().encode(r.prefix, e);
            }
          }
          return null;
        }
        getAddress(e) {
          return v(this, void 0, void 0, function* () {
            ...
            let t = yield this._fetchBytes("0xf1cb7e06", C(e));
                ...
                switch (i) {
                  ...
                  case "erc1155": {
                    ...
                    let l = yield this.provider.formatter.address(c[0]),
                      f = (0, s.hexZeroPad)(o.gH.from(c[1]).toHexString(), 32);
                    if ("erc721" === i) {
                      let t = this.provider.formatter.callAddress(
                        yield this.provider.call({
                          to: l,
                          data: (0, s.hexConcat)(["0x6352211e", f]),
                        })
                      );
                      if (a !== t) return null;
                    ...
                    if (p.match(/^(https:\/\/|data:)/i));
                      ...
                      let t = p.match(I);
                      if (null == t) return null;
                      e.push({ type: "url-ipfs", content: p }), (p = L(p));
                    }
                    return (
        ...
        getContentHash() {
          return v(this, void 0, void 0, function* () {
            ...
            if (r) {
              ...
              if (r[4].length === 2 * e)
                return "ipns://" + a.Base58.encode("0x" + r[1]);
            }
            ...
            if (o && 68 === o[1].length) {
              let e = { "=": "", "+": "-", "/": "_" };
              return (
                "sia://" + (0, i.l)("0x" + o[1]).replace(/[=+\/]/g, (t) => e[t])
              );
            }
            return w.throwError(
        ...
        getText(e) {
          return v(this, void 0, void 0, function* () {
            let t = (0, h.YW)(e);
            (t = (0, s.concat)([C(64), C(t.length), t])).length % 32 != 0 &&
              (t = (0, s.concat)([
                t,
                (0, s.hexZeroPad)("0x", 32 - (e.length % 32)),
              ]));
            let r = yield this._fetchBytes("0x59d1d43c", (0, s.hexlify)(t));
            return null == r || "0x" === r ? null : (0, h._v)(r);
          });
        }
      }
      let H = null,
        j = 1;
      class z extends n.Kq {
        constructor(e) {
          if (
            (super(),
            (this._events = []),
            ...
            (0, u.defineReadOnly)(this, "anyNetwork", "any" === e),
            ...
            let t = (0, u.getStatic)(new.target, "getNetwork")(e);
            t
        ...
        get ready() {
          return (0, x.poll)(() =>
            this._ready().then(
              ...
              (e) => {
                if (
                  e.code !== m.Logger.errors.NETWORK_ERROR ||
                  "noNetwork" !== e.event
                )
                  throw e;
              }
        ...
        static getFormatter() {
          return null == H && (H = new y.ZA()), H;
        }
        static getNetwork(e) {
          return (0, f.N)(null == e ? "homestead" : e);
        }
        ccipReadFetch(e, t, r) {
          return v(this, void 0, void 0, function* () {
            ...
            for (let e = 0; e < r.length; e++) {
              let t = r[e],
                o = t.replace("{sender}", n).replace("{data}", i),
                s =
                  t.indexOf("{data}") >= 0
                    ? null
                    : JSON.stringify({ data: i, sender: n }),
                c = yield (0, x.fetchJson)(
          ...
          return v(this, void 0, void 0, function* () {
            if ((yield this._ready(), e > 0))
              for (; this._internalBlockNumber; ) {
                ...
                try {
                  let r = yield t;
                  if (S() - r.respTime <= e) return r.blockNumber;
                  break;
                } catch (e) {
        ...
        getBalance(e, t) {
          return v(this, void 0, void 0, function* () {
            yield this.getNetwork();
            let r = yield (0, u.resolveProperties)({
            ...
            try {
              ...
              return w.throwError(
                "bad result from backend",
                m.Logger.errors.SERVER_ERROR,
                { method: "getBalance", params: r, result: n, error: e }
              );
            }
          });
        }
          ...
          return v(this, void 0, void 0, function* () {
            ...
            try {
              ...
              return w.throwError(
                "bad result from backend",
                m.Logger.errors.SERVER_ERROR,
                { method: "getCode", params: r, result: n, error: e }
              );
            }
          });
        }
        getStorageAt(e, t, r) {
          return v(this, void 0, void 0, function* () {
            yield this.getNetwork();
            let n = yield (0, u.resolveProperties)({
                address: this._getAddress(e),
            ...
            try {
              ...
              return w.throwError(
                "bad result from backend",
                m.Logger.errors.SERVER_ERROR,
                { method: "getStorageAt", params: n, result: i, error: e }
              );
            }
          });
        }
          ...
          return (
            ...
            (e.wait = (t, n) =>
              v(this, void 0, void 0, function* () {
                ...
                let a = yield this._waitForTransaction(e.hash, t, n, i);
                return null == a && 0 === t
                  ? null
                  : ((this._emitted["t:" + e.hash] = a.blockNumber),
                    0 === a.status &&
                      w.throwError(
                        "transaction failed",
                        m.Logger.errors.CALL_EXCEPTION,
                        { transactionHash: e.hash, transaction: e, receipt: a }
                      ),
                    a);
              })),
            e
        ...
        _getFilter(e) {
          return v(this, void 0, void 0, function* () {
            ...
            return (
              ...
              this.formatter.filter(yield (0, u.resolveProperties)(t))
            );
          });
        }
        _call(e, t, r) {
          return v(this, void 0, void 0, function* () {
            ...
            if (
              ...
              (0, s.hexDataLength)(i) % 32 == 4
            )
              try {
                let a = (0, s.hexDataSlice)(i, 4),
                  c = (0, s.hexDataSlice)(a, 0, 32);
                o.gH.from(c).eq(n) ||
                  w.throwError(
                ...
                let l = [],
                  f = o.gH.from((0, s.hexDataSlice)(a, 32, 64)).toNumber(),
                  u = o.gH.from((0, s.hexDataSlice)(a, f, f + 32)).toNumber(),
                  d = (0, s.hexDataSlice)(a, f + 32);
                for (let t = 0; t < u; t++) {
                  let r = O(d, 32 * t);
                  null == r &&
                    w.throwError(
                ...
                let h = B(a, 64);
                o.gH.from((0, s.hexDataSlice)(a, 100, 128)).isZero() ||
                  w.throwError(
                ...
                let x = (0, s.hexDataSlice)(a, 96, 100),
                  p = B(a, 128),
                  g = yield this.ccipReadFetch(e, h, l);
                null == g &&
                  w.throwError(
                ...
                let b = { to: n, data: (0, s.hexConcat)([x, D([g, p])]) };
        ...
        estimateGas(e) {
          return v(this, void 0, void 0, function* () {
            yield this.getNetwork();
            let t = yield (0, u.resolveProperties)({
                transaction: this._getTransactionRequest(e),
              }),
        ...
        _getBlock(e, t) {
          return v(this, void 0, void 0, function* () {
            ...
            if ((0, s.isHexString)(e, 32)) n.blockHash = e;
            else
              try {
                (n.blockTag = yield this._getBlockTag(e)),
                  (0, s.isHexString)(n.blockTag) &&
        ...
        getLogs(e) {
          return v(this, void 0, void 0, function* () {
            ...
            return (
              ...
              y.ZA.arrayOf(this.formatter.filterLog.bind(this.formatter))(r)
            );
          });
        }
        getEtherPrice() {
          ...
          return v(this, void 0, void 0, function* () {
            ...
            if ((0, s.isHexString)(e)) {
              ...
              try {
                ...
                if (e.code !== m.Logger.errors.CALL_EXCEPTION) throw e;
              }
              try {
                let e = O(
                  yield this.call({
                    to: n,
                    data: "0x691f3431" + (0, l.kM)(r).substring(2),
                  }),
                  0
                );
      ...
      function a(e, t, r, a, o) {
        ...
        for (let h = 1; h <= f; h++) {
          (d[t.length] = (h >> 24) & 255),
            ...
            (d[t.length + 3] = 255 & h);
          let x = (0, n.arrayify)((0, i.L5)(o, e, d));
          s ||
            ((l = new Uint8Array((s = x.length))),
            (f = Math.ceil(a / s)),
            (c = a - (f - 1) * s)),
            l.set(x);
          for (let t = 1; t < r; t++) {
            x = (0, n.arrayify)((0, i.L5)(o, e, x));
            for (let e = 0; e < s; e++) l[e] ^= x[e];
          }
          let p = (h - 1) * s,
            g = h === f ? c : s;
          u.set((0, n.arrayify)(l).slice(0, g), p);
        }
    ...
    29923: function (e) {
      ...
      !(function (t) {
        function r(e) {
          ...
          let d,
            h = e.length % 64,
            x = (e.length / 0x20000000) | 0,
            p = e.length << 3,
            g = h < 56 ? 56 : 120,
            m = e.slice(e.length - h, e.length);
          for (m.push(128), d = h + 1; d < g; d++) m.push(0);
          return (
            m.push((x >>> 24) & 255),
            m.push((x >>> 16) & 255),
            m.push((x >>> 8) & 255),
        ...
        function n(e, t, n) {
          ...
          for (; n >= 32; ) l(), (c = c.concat(r(s.concat(r(o))))), (n -= 32);
          return (
            n > 0 && (l(), (c = c.concat(r(s.concat(r(o))).slice(0, n)))), c
          );
        }
        function i(e, t, r, n, i) {
          let c;
          for (s(e, (2 * r - 1) * 16, i, 0, 16), c = 0; c < 2 * r; c++)
            o(e, 16 * c, i, 16),
              (function (e, t) {
                s(e, 0, t, 0, 16);
                for (let e = 8; e > 0; e -= 2)
              ...
              s(i, 0, e, t + 16 * c, 16);
          for (c = 0; c < r; c++) s(e, t + 2 * c * 16, e, 16 * c, 16);
          for (c = 0; c < r; c++)
            s(e, t + (2 * c + 1) * 16, e, (c + r) * 16, 16);
        }
        function a(e, t) {
          return (e << t) | (e >>> (32 - t));
        }
        ...
        function f(e, t, r, a, f, u, d) {
          ...
          if (r > 0x7fffffff / 128 / a) throw Error("N too large");
          if (a > 0x7fffffff / 128 / f) throw Error("r too large");
          if (!c(e)) throw Error("password must be an array or buffer");
          if (((e = Array.prototype.slice.call(e)), !c(t)))
            throw Error("salt must be an array or buffer");
          t = Array.prototype.slice.call(t);
          let x = n(e, t, 128 * f * a),
            p = new Uint32Array(32 * f * a);
          ...
          let g = new Uint32Array(64 * a),
            m = new Uint32Array(32 * a * r),
            b = 32 * a,
            ...
            _ = 0,
            P,
            R = d ? parseInt(1e3 / a) : 0xffffffff,
            N = "undefined" != typeof setImmediate ? setImmediate : setTimeout,
            C = function () {
              let t;
              if (k) return d(Error("cancelled"), A / w);
              switch (S) {
                case 0:
                  s(p, (h = 32 * _ * a), g, 0, b), (S = 1), (P = 0);
                case 1:
                  (t = r - P) > R && (t = R);
                  for (let e = 0; e < t; e++)
                    s(g, 0, m, (P + e) * b, b), i(g, b, a, y, v);
                  if (((P += t), (A += t), d)) {
                    let e = parseInt((1e3 * A) / w);
                    if (e !== E) {
                      if ((k = d(null, A / w))) break;
                      E = e;
                    }
                  }
                  if (P < r) break;
        ...
        e.exports = {
          scrypt: function (e, t, r, n, i, a, o) {
            return new Promise(function (s, c) {
              let l = 0;
              o && o(0),
                f(e, t, r, n, i, a, function (e, t, r) {
                  if (e) c(e);
                  else if (r) o && 1 !== l && o(1), s(new Uint8Array(r));
                  else if (o && t !== l) return (l = t), o(t);
                });
            });
          },
          syncScrypt: function (e, t, r, n, i, a) {
            return new Uint8Array(f(e, t, r, n, i, a));
          },
        };
      })(0);
    },
    ...
    30925: (e, t, r) => {
      ...
      class i extends Error {
        constructor(e, t) {
          ...
          let r = `https://errors.authjs.dev#${this.type.toLowerCase()}`;
      ...
      s.type = "AccessDenied";
      class c extends i {}
      c.type = "CallbackRouteError";
      class l extends i {}
      l.type = "ErrorPageLoop";
      class f extends i {}
      f.type = "EventError";
      class u extends i {}
      ...
      d.type = "CredentialsSignin";
      class h extends i {}
      h.type = "InvalidEndpoints";
      class x extends i {}
      x.type = "InvalidCheck";
      class p extends i {}
      p.type = "JWTSessionError";
      class g extends i {}
      ...
      class E extends i {}
      E.type = "SessionTokenError";
      class k extends a {}
      k.type = "OAuthSignInError";
      class S extends a {}
      S.type = "EmailSignInError";
      class _ extends i {}
      _.type = "SignOutError";
      class P extends i {}
      P.type = "UnknownAction";
      class R extends i {}
      R.type = "UnsupportedStrategy";
      class N extends i {}
      N.type = "InvalidProvider";
      class C extends i {}
      C.type = "UntrustedHost";
      class M extends i {}
      M.type = "Verification";
      class I extends a {}
      I.type = "MissingCSRF";
      class T extends i {}
      T.type = "DuplicateConditionalUI";
      class O extends i {}
      ...
      async function H(e, t, r, n = {}) {
        ...
        try {
          ...
          return r.error(new D(e.message, e)), null;
        }
      }
      function j() {
      ...
      function z(e) {
        let t = new URL(
          ...
          r = "/" === t.pathname ? "/api/auth" : t.pathname.replace(/\/$/, ""),
          n = `${t.origin}${r}`;
        return {
          origin: t.origin,
          host: t.host,
        ...
        G = class e {
          ...
          createDefaultConfig() {
            return {
              baseUrl:
                "undefined" != typeof window
                  ? z(window.location.origin).origin
                  : "",
              basePath:
                "undefined" != typeof window
                  ? z(window.location.origin).path
                  : "/api/auth",
          ...
          initializeConfig(e) {
            this.config.lastSync = e ? j() : 0;
          }
        }.getInstance(),
        q = n.createContext(void 0);
      async function W(e) {
        let { baseUrl: t, basePath: r, credentials: n } = G.getConfig();
        return await H(
          "session",
          { baseUrl: t, basePath: r, credentials: n },
          K,
          e
        );
      }
      async function J() {
        let { baseUrl: e, basePath: t, credentials: r } = G.getConfig(),
          n = await H("csrf", { baseUrl: e, basePath: t, credentials: r }, K);
        return n?.csrfToken ?? "";
      }
      function V(e) {
        var t, r;
        ...
        let { children: i, refetchInterval: a, refetchWhenOffline: o = !0 } = e,
          s = G.getConfig(),
          c = !!e.session;
        G.initializeConfig(c);
        let {
          session: l,
          setSession: f,
          loading: u,
          ...
          return (
            (0, n.useEffect)(
              () => (
                (r.fetchSession = async ({ event: e } = {}) => {
                  try {
                    if ("storage" === e || !r.session) {
                      (r.lastSync = j()), (r.session = await W()), a(r.session);
                      return;
                    }
                    if (!e || !r.session || j() < r.lastSync) return;
                    (r.lastSync = j()), (r.session = await W()), a(r.session);
                  } catch (e) {
                    K.error(new U(e.message, e));
                  } finally {
                    s(!1);
                  }
                }),
                ...
                () => {
                  (r.lastSync = 0),
                    (r.session = null),
                    (r.fetchSession = async () => void 0);
                }
              ),
              []
            ),
            { session: i, setSession: a, loading: o, setLoading: s }
          );
        })(c, e.session ?? null);
        (t = e.refetchOnWindowFocus ?? !0),
          (0, n.useEffect)(() => {
              ...
              document.addEventListener(
                ...
                () => {
                  t &&
                    ...
                    s.fetchSession({ event: "visibilitychange" });
                },
                { signal: e.signal }
              ),
              () => {
        ...
        (r = o || h),
          (0, n.useEffect)(() => {
            if (a && r) {
              let e = setInterval(() => {
                s.session && s.fetchSession({ event: "poll" });
              }, 1e3 * a);
              return () => {
                clearInterval(e);
              };
        ...
        let x = (0, n.useMemo)(
          () => ({
            data: l,
            status: u ? "loading" : l ? "authenticated" : "unauthenticated",
            update: async (e) => {
              if (u || !l) return;
              d(!0);
              let t = await H(
                ...
                s,
                K,
                e ? { body: { csrfToken: await J(), data: e } } : void 0
              );
              return d(!1), t && f(t), t;
            },
          }),
        ...
        return n.createElement(q.Provider, { value: x }, i);
      }
      function Q(e) {
        if (!q)
          throw Error("React Context is unavailable in Server Components");
        let t = G.getConfig(),
          r = (0, n.useContext)(q),
          { required: i, onUnauthenticated: a } = e ?? {},
          o = i && r?.status === "unauthenticated";
        return ((0, n.useEffect)(() => {
          if (o) {
            let e = `${t.baseUrl}${t.basePath}/signin?${new URLSearchParams({
              error: "SessionRequired",
              callbackUrl: window.location.href,
            })}`;
            a ? a() : (window.location.href = e);
          }
        }, [o, a]),
        o)
      ...
      async function Y() {
        return H("providers", G.getConfig(), K);
      }
      async function Z(e, t = {}, r = {}) {
        let {
            callbackUrl: n = window.location.href,
            redirect: i = !0,
            ...a
          } = t,
          o = G.getConfig(),
          s = `${o.baseUrl}${o.basePath}`,
          c = await Y();
        if (!c) {
          window.location.href = `${s}/error`;
          return;
        }
        if (!e || !(e in c)) {
          window.location.href = `${s}/signin?${new URLSearchParams({
            callbackUrl: n,
          })}`;
          return;
        }
        let l = "credentials" === c[e].type;
        c[e].type;
        let f = `${s}/${l ? "callback" : "signin"}/${e}`,
          u = await J(),
          d = await fetch(`${f}?${new URLSearchParams(r)}`, {
            method: "POST",
            headers: {
              "Content-Type": "application/x-www-form-urlencoded",
              "X-Auth-Return-Redirect": "1",
            },
            body: new URLSearchParams({ ...a, csrfToken: u, callbackUrl: n }),
        ...
        let x = new URL(h.url).searchParams.get("error");
        return (
          d.ok && (await o.fetchSession?.({ event: "storage" })),
          { error: x, status: d.status, ok: d.ok, url: x ? null : h.url }
        );
      }
      async function X(e) {
        let { callbackUrl: t = window.location.href, redirect: r = !0 } =
            e ?? {},
          n = G.getConfig(),
          i = await J(),
          a = await fetch(`${n.baseUrl}${n.basePath}/signout`, {
            method: "POST",
            headers: {
              "Content-Type": "application/x-www-form-urlencoded",
              "X-Auth-Return-Redirect": "1",
            },
            body: new URLSearchParams({ csrfToken: i, callbackUrl: t }),
        ...
        return await n.fetchSession?.({ event: "storage" }), o;
      }
    },
    31187: (e, t, r) => {
      "use strict";
    ...
    33210: (e, t, r) => {
      ...
      r.r(t),
        r.d(t, {
          BaseContract: () => n.BaseContract,
          BigNumber: () => i.gH,
          Contract: () => n.Contract,
          ContractFactory: () => n.ContractFactory,
          FixedNumber: () => a.I3,
          Signer: () => o.Signer,
          VoidSigner: () => o.VoidSigner,
          Wallet: () => s.Wallet,
          Wordlist: () => u.b,
          constants: () => c,
          errors: () => h.ErrorCode,
          getDefaultProvider: () => l.getDefaultProvider,
          logger: () => p,
          providers: () => l,
          utils: () => d,
          version: () => x.r,
    ...
    34062: (e, t, r) => {
      ...
      var n,
        ...
        u = r(86166),
        d = r(6865);
      let h = new d.Logger("transactions/5.8.0");
      function x(e) {
        return "0x" === e ? null : (0, i.getAddress)(e);
      }
      function p(e) {
        return "0x" === e ? s.XK : a.gH.from(e);
      }
      !(function (e) {
        (e[(e.legacy = 0)] = "legacy"),
      ...
      function b(e) {
        let t = (0, u.computePublicKey)(e);
        return (0, i.getAddress)(
          (0, o.hexDataSlice)((0, c.keccak256)((0, o.hexDataSlice)(t, 1)), 12)
        );
      }
      function y(e, t) {
        return b((0, u.recoverPublicKey)((0, o.arrayify)(e), t));
      }
      function v(e, t) {
        let r = (0, o.stripZeros)(a.gH.from(e).toHexString());
        return (
          r.length > 32 &&
      ...
      function k(e, t) {
        if (null != e.gasPrice) {
          let t = a.gH.from(e.gasPrice),
            r = a.gH.from(e.maxFeePerGas || 0);
          t.eq(r) ||
            h.throwArgumentError(
        ...
        if (t) {
          let e = (0, o.splitSignature)(t);
          r.push(v(e.recoveryParam, "recoveryParam")),
        ...
        if (null == e.type || 0 === e.type) {
          ...
          g.forEach(function (t) {
            ...
            t.numeric && (i.hexPad = "left"),
              ...
              t.maxLength &&
                (n = (0, o.stripZeros)(n)).length > t.maxLength &&
                h.throwArgumentError(
                  "invalid length for " + t.name,
                  "transaction:" + t.name,
                  n
      ...
      function P(e, t, r) {
        ...
        try {
          let t = (0, c.keccak256)(r(e));
          e.from = y(t, { r: e.r, s: e.s, recoveryParam: e.v });
        } catch (e) {}
      }
      function R(e) {
        ...
        if (t[0] > 127)
          return (function (e) {
            ...
            if (
              ...
              a.gH.from(r.r).isZero() && a.gH.from(r.s).isZero())
            )
              (r.chainId = r.v), (r.v = 0);
            else {
              ...
              let n = r.v - 27,
                i = t.slice(0, 6);
              0 !== r.chainId &&
                (i.push((0, o.hexlify)(r.chainId)),
                i.push("0x"),
                i.push("0x"),
                (n -= 2 * r.chainId + 8));
              let a = (0, c.keccak256)(f.encode(i));
              try {
                r.from = y(a, {
                  r: (0, o.hexlify)(r.r),
                  s: (0, o.hexlify)(r.s),
              ...
              r.hash = (0, c.keccak256)(e);
            }
            return (r.type = null), r;
          })(t);
        switch (t[0]) {
          case 1:
            let r = f.decode(t.slice(1));
            8 !== r.length &&
              11 !== r.length &&
              h.throwArgumentError(
            ...
            let n = {
              type: 1,
              chainId: p(r[0]).toNumber(),
              nonce: p(r[1]).toNumber(),
              gasPrice: p(r[2]),
              gasLimit: p(r[3]),
              to: x(r[4]),
              value: p(r[5]),
            ...
            return (
              8 === r.length ||
                ((n.hash = (0, c.keccak256)(t)), P(n, r.slice(8), S)),
              n
            );
          case 2:
            let i = f.decode(t.slice(1));
            9 !== i.length &&
              12 !== i.length &&
              h.throwArgumentError(
            ...
            let s = p(i[2]),
              ...
              u = {
                type: 2,
                chainId: p(i[0]).toNumber(),
                nonce: p(i[1]).toNumber(),
            ...
            return (
              9 === i.length ||
                ((u.hash = (0, c.keccak256)(t)), P(u, i.slice(9), k)),
              u
            );
        }
        return h.throwError(
    ...
    39705: (e, t, r) => {
      ...
      var n = r(99764),
        i = r(71182);
      let a = new (r(6865).Logger)("wordlists/5.8.0");
      class o {
        constructor(e) {
    ...
    40138: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { keccak256: () => o });
      var n = r(72464),
        i = r.n(n),
        a = r(20037);
      function o(e) {
        return "0x" + i().keccak_256((0, a.arrayify)(e));
      }
    },
    40341: (e, t, r) => {
      "use strict";
      ...
      var n = r(8898),
        ...
        d = r(34062),
        h = r(99373);
      let x = new (r(6865).Logger)("hdnode/5.8.0"),
        p = a.gH.from(
          "0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"
        ),
        g = (0, o.YW)("Bitcoin seed");
      function m(e) {
        return ((1 << e) - 1) << (8 - e);
      }
      function b(e) {
      ...
      function y(e) {
        return n.Base58.encode(
          (0, i.concat)([e, (0, i.hexDataSlice)((0, f.sc)((0, f.sc)(e)), 0, 4)])
        );
      }
      function v(e) {
        if (null == e) return h.Y.en;
        if ("string" == typeof e) {
          let t = h.Y[e];
          return (
            null == t && x.throwArgumentError("unknown locale", "wordlist", e),
            t
          );
        }
        return e;
      ...
      class E {
        constructor(e, t, r, n, a, o, s, u) {
          ...
          (0, c.defineReadOnly)(this, "parentFingerprint", n),
            (0, c.defineReadOnly)(
              this,
              "fingerprint",
              (0, i.hexDataSlice)((0, f.HE)((0, f.sc)(this.publicKey)), 0, 4)
            ),
            (0, c.defineReadOnly)(
              this,
              "address",
            ...
            (0, c.defineReadOnly)(this, "chainCode", a),
            ...
            null == u
              ...
              : "string" == typeof u
              ? ((0, c.defineReadOnly)(this, "mnemonic", null),
                (0, c.defineReadOnly)(this, "path", u))
              : ((0, c.defineReadOnly)(this, "mnemonic", u),
                (0, c.defineReadOnly)(this, "path", u.path));
        }
        get extendedKey() {
        ...
        _derive(e) {
          ...
          for (let t = 24; t >= 0; t -= 8)
            r[33 + (t >> 3)] = (e >> (24 - t)) & 255;
          let n = (0, i.arrayify)((0, f.L5)(u.q.sha512, this.chainCode, r)),
            o = n.slice(0, 32),
            s = n.slice(32),
            c = null,
            d = null;
          this.privateKey
            ? (c = b(a.gH.from(o).add(this.privateKey).mod(p)))
            : (d = new l.SigningKey((0, i.hexlify)(o))._addPoint(
                this.publicKey
              ));
          let h = t,
            x = this.mnemonic;
          return (
            ...
            new E(w, c, d, this.fingerprint, b(s), e, this.depth + 1, h)
          );
        }
        derivePath(e) {
          let t = e.split("/");
        ...
        static _fromSeed(e, t) {
          ...
          let n = (0, i.arrayify)((0, f.L5)(u.q.sha512, g, r));
          return new E(
            w,
            b(n.slice(0, 32)),
            null,
        ...
        static fromMnemonic(e, t, r) {
          return (
            (r = v(r)),
            (e = _(S(e, r), r)),
            E._fromSeed(k(e, t), { phrase: e, path: "m", locale: r.locale })
          );
        }
        static fromSeed(e) {
        ...
        static fromExtendedKey(e) {
          ...
          let r = t[4],
            ...
            s = (0, i.hexlify)(t.slice(13, 45)),
            c = t.slice(45, 78);
          switch ((0, i.hexlify)(t.slice(0, 4))) {
            case "0x0488b21e":
            case "0x043587cf":
              return new E(w, null, (0, i.hexlify)(c), a, s, o, r, null);
            case "0x0488ade4":
            case "0x04358394 ":
              if (0 !== c[0]) break;
              return new E(
      ...
      function k(e, t) {
        t || (t = "");
        let r = (0, o.YW)("mnemonic" + t, o.dz.NFKD);
        return (0, s.A)((0, o.YW)(e, o.dz.NFKD), r, 2048, 64, "sha512");
      }
      function S(e, t) {
        (t = v(t)), x.checkNormalize();
        let r = t.split(e);
        ...
        let o = (32 * r.length) / 3,
          s = m(r.length / 3);
        if (
          ((0, i.arrayify)((0, f.sc)(n.slice(0, o / 8)))[0] & s) !=
          (n[n.length - 1] & s)
        )
      ...
      function R(e) {
        return (
          ("number" != typeof e || e < 0 || e >= 0x80000000 || e % 1) &&
            x.throwArgumentError("invalid account index", "index", e),
          `m/44'/60'/${e}'/0/0`
        );
      }
    },
    ...
    42726: (e, t, r) => {
        ...
        static fromString(e, t) {
          ...
          return (
            (r = (function (e, t) {
              ...
              return (
                o.parent && s.throwArgumentError("unexpected eof", "param", e),
                delete a.state,
                "indexed" === o.name
                  ? (t || n(r.length - 7),
      ...
      class m {
        ...
        static fromString(e) {
          return "event" ===
            ...
            : "function" === e.split(" ")[0]
            ? E.fromString(e.substring(8).trim())
            : "constructor" === e.split("(")[0].trim()
            ? A.fromString(e.trim())
            : "error" === e.split(" ")[0]
            ? S.fromString(e.substring(5).trim())
      ...
      class A extends m {
        ...
        static fromObject(e) {
          if (A.isConstructorFragment(e)) return e;
          "constructor" !== e.type &&
      ...
      class S extends m {
        ...
        static fromString(e) {
          let t = { type: "error" },
            r = e.match(N);
          return (
            r || s.throwArgumentError("invalid error signature", "value", e),
            (t.name = r[1].trim()),
            t.name && R(t.name),
            (t.inputs = g(r[2], !1)),
            k(S.fromObject(t))
    ...
    43662: (e) => {
      ...
      function s(e, t) {
        ...
        for (var u = [], d = 0; d < l.length; ++d) {
          var h = l.charAt(d),
            x = r[h];
          if (void 0 === x) return "Unknown character " + h;
          (f = a(f) ^ x), d + 6 >= l.length || u.push(x);
        }
        return 1 !== f ? "Invalid checksum for " + e : { prefix: c, words: u };
      }
      function c(e, t, r, n) {
        for (
          var i = 0, a = 0, o = (1 << r) - 1, s = [], c = 0;
          c < e.length;
          ++c
        )
          for (i = (i << t) | e[c], a += t; a >= r; )
            s.push((i >> (a -= r)) & o);
        if (n) a > 0 && s.push((i << (r - a)) & o);
        else {
      ...
      e.exports = {
        ...
        encode: function (e, r, n) {
          ...
          var i = o((e = e.toLowerCase()));
          if ("string" == typeof i) throw Error(i);
          for (var s = e + "1", c = 0; c < r.length; ++c) {
            var l = r[c];
            if (l >> 5 != 0) throw Error("Non 5-bit word");
            (i = a(i) ^ l), (s += t.charAt(l));
          }
          for (c = 0; c < 6; ++c) i = a(i);
          for (i ^= 1, c = 0; c < 6; ++c) {
            var f = (i >> ((5 - c) * 5)) & 31;
    ...
    44203: (e, t, r) => {
      ...
      function d(e, t, r) {
        ...
        t.length !== n.length &&
          u.throwArgumentError("types/value length mismatch", "tuple", r);
        let i = new s.AU(e.wordSize),
          o = new s.AU(e.wordSize),
          c = [];
        t.forEach((e, t) => {
          let r = n[t];
          if (e.dynamic) {
      ...
      class k extends g {
        ...
        encode(e, t) {
          return super.encode(e, (0, E.YW)(t));
        }
        decode(e) {
          return (0, E._v)(super.decode(e));
        }
      }
      class S extends s.Ue {
        constructor(e, t) {
          let r = !1,
            n = [];
          e.forEach((e) => {
      ...
      class C {
        ...
        getDefaultValue(e) {
          return new S(
            e.map((e) => this._getCoder(_.aX.from(e))),
            "_"
          ).defaultValue();
        }
        encode(e, t) {
    ...
    44541: (e, t, r) => {
      ...
      function p(e, t) {
        ...
        let a = i[0],
          c = i[1];
        for (a || (a = "0"), c || (c = "0"); "0" === c[c.length - 1]; )
      ...
      class m {
        ...
        addUnsafe(e) {
          ...
          return m.fromValue(t.add(r), this.format.decimals, this.format);
        }
        subUnsafe(e) {
          this._checkFormat(e);
          let t = p(this._value, this.format.decimals),
            r = p(e._value, e.format.decimals);
          return m.fromValue(t.sub(r), this.format.decimals, this.format);
        }
        mulUnsafe(e) {
          this._checkFormat(e);
          let t = p(this._value, this.format.decimals),
        ...
        floor() {
          ...
          let t = m.from(e[0], this.format),
            r = !e[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (t = t.subUnsafe(b.toFormat(t.format))), t
          );
        }
        ceiling() {
          let e = this.toString().split(".");
          ...
          let t = m.from(e[0], this.format),
            r = !e[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (t = t.addUnsafe(b.toFormat(t.format))),
            t
          );
        }
        round(e) {
          ...
          if (
            ...
            return this;
          let r = m.from("1" + d.substring(0, e), this.format),
        ...
        static fromValue(e, t, r) {
          return (
            null != r || null == t || (0, o.YR)(t) || ((r = t), (t = null)),
            null == t && (t = 0),
            null == r && (r = "fixed"),
            m.fromString(x(e, t), g.from(r))
          );
        }
        static fromString(e, t) {
          null == t && (t = "fixed");
          ...
          !r.signed &&
            i.lt(l) &&
            u("unsigned value cannot be negative", "overflow", "value", e);
          let a = null;
          return (
            r.signed
              ? (a = i.toTwos(r.width).toHexString())
              : ((a = i.toHexString()),
                (a = (0, n.hexZeroPad)(a, r.width / 8))),
            new m(c, a, x(i, r.decimals), r)
          );
        }
        ...
        static from(e, t) {
          if ("string" == typeof e) return m.fromString(e, t);
          if ((0, n.isBytes)(e)) return m.fromBytes(e, t);
          try {
            return m.fromValue(e, 0, t);
          } catch (e) {
    ...
    47200: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { decode: () => n.D, encode: () => n.l });
      var n = r(30447);
    },
    49528: (e, t, r) => {
      "use strict";
    ...
    50331: (e, t, r) => {
      ...
      n.inherits(b, g),
        ...
        (b.prototype._update = function (e, t) {
          ...
          for (; n < r.length; n++)
            r[n] = c(p(r[n - 2]), r[n - 7], x(r[n - 15]), r[n - 16]);
          var i = this.h[0],
            a = this.h[1],
            g = this.h[2],
            m = this.h[3],
          ...
          for (o(this.k.length === r.length), n = 0; n < r.length; n++) {
            var A = l(w, h(b), f(b, y, v), this.k[n], r[n]),
              E = s(d(i), u(i, a, g));
            (w = v),
              (v = y),
              (y = b),
    ...
    55206: (e, t, r) => {
      ...
      let x = new d.Logger("contracts/5.8.0"),
        p = {
          chainId: !0,
          data: !0,
          from: !0,
      ...
      function m(e, t, r) {
        return h(this, void 0, void 0, function* () {
          return Array.isArray(r)
            ? yield Promise.all(
                r.map((r, n) => m(e, Array.isArray(t) ? t[n] : t[r.name], r))
              )
            : "address" === r.type
            ? yield g(e, t)
            : "tuple" === r.type
            ? yield m(e, t, r.components)
            : "array" === r.baseType
            ? Array.isArray(t)
              ? yield Promise.all(t.map((t) => m(e, t, r.arrayChildren)))
              : Promise.reject(
                  x.makeError(
      ...
      function b(e, t, r) {
        return h(this, void 0, void 0, function* () {
          ...
          r.length === t.inputs.length + 1 &&
            ...
            (n = (0, f.shallowCopy)(r.pop())),
            x.checkArgumentCount(
              r.length,
              t.inputs.length,
              "passed to contract"
            ),
          ...
          let i = yield (0, f.resolveProperties)({
              args: m(e.signer || e.provider, r, t.inputs),
              address: e.resolvedAddress,
              overrides: (0, f.resolveProperties)(n) || {},
            }),
            a = e.interface.encodeFunctionData(t, i.args),
            o = { data: a, to: i.address },
            p = i.overrides;
          if (
            (null != p.nonce && (o.nonce = c.gH.from(p.nonce).toNumber()),
            null != p.gasLimit && (o.gasLimit = c.gH.from(p.gasLimit)),
            null != p.gasPrice && (o.gasPrice = c.gH.from(p.gasPrice)),
            null != p.maxFeePerGas &&
              (o.maxFeePerGas = c.gH.from(p.maxFeePerGas)),
            null != p.maxPriorityFeePerGas &&
              (o.maxPriorityFeePerGas = c.gH.from(p.maxPriorityFeePerGas)),
            null != p.from && (o.from = p.from),
            null != p.type && (o.type = p.type),
            null != p.accessList &&
              (o.accessList = (0, u.accessListify)(p.accessList)),
            null == o.gasLimit && null != t.gas)
          ) {
            let e = 21e3,
              r = (0, l.arrayify)(a);
            for (let t = 0; t < r.length; t++) (e += 4), r[t] && (e += 64);
            o.gasLimit = c.gH.from(t.gas).add(e);
          }
          if (p.value) {
            let e = c.gH.from(p.value);
            e.isZero() ||
              t.payable ||
              x.throwError(
          ...
          p.customData && (o.customData = (0, f.shallowCopy)(p.customData)),
            p.ccipReadEnabled && (o.ccipReadEnabled = !!p.ccipReadEnabled),
            delete n.nonce,
            delete n.gasLimit,
            delete n.gasPrice,
            delete n.from,
            ...
            try {
              ...
              throw (
                (t.code === d.Logger.errors.CALL_EXCEPTION &&
                  ((t.address = e.address), (t.args = i), (t.transaction = o)),
                t)
              );
            }
          });
      ...
      class E {
        constructor(e, t) {
          (0, f.defineReadOnly)(this, "tag", e),
            (0, f.defineReadOnly)(this, "filter", t),
            (this._listeners = []);
        }
        addListener(e, t) {
      ...
      class S extends E {
        constructor(e, t, r, n) {
          ...
          n
            ? (a !== n[0] &&
                x.throwArgumentError("topic mismatch", "topics", n),
              (i.topics = n.slice()))
            : (i.topics = [a]),
            super(A(i), i),
            (0, f.defineReadOnly)(this, "address", e),
            (0, f.defineReadOnly)(this, "interface", t),
            (0, f.defineReadOnly)(this, "fragment", r);
        }
        prepareEvent(e) {
      ...
      class P {
        constructor(e, t, r) {
          (0, f.defineReadOnly)(
            this,
            "interface",
            (0, f.getStatic)(new.target, "getInterface")(t)
          ),
            null == r
              ? ((0, f.defineReadOnly)(this, "provider", null),
                (0, f.defineReadOnly)(this, "signer", null))
              : o.Signer.isSigner(r)
              ? ((0, f.defineReadOnly)(this, "provider", r.provider || null),
                (0, f.defineReadOnly)(this, "signer", r))
              : a.Kq.isProvider(r)
              ? ((0, f.defineReadOnly)(this, "provider", r),
                (0, f.defineReadOnly)(this, "signer", null))
              : x.throwArgumentError(
            ...
            (0, f.defineReadOnly)(this, "callStatic", {}),
            (0, f.defineReadOnly)(this, "estimateGas", {}),
            (0, f.defineReadOnly)(this, "functions", {}),
            (0, f.defineReadOnly)(this, "populateTransaction", {}),
            (0, f.defineReadOnly)(this, "filters", {});
          {
            let e = {};
            Object.keys(this.interface.events).forEach((t) => {
              let r = this.interface.events[t];
              (0, f.defineReadOnly)(this.filters, t, (...e) => ({
              ...
              Object.keys(e).forEach((t) => {
                let r = e[t];
                1 === r.length
                  ? (0, f.defineReadOnly)(this.filters, t, this.filters[r[0]])
                  : x.warn(`Duplicate definition of ${t} (${r.join(", ")})`);
              });
          }
          if (
            ((0, f.defineReadOnly)(this, "_runningEvents", {}),
            (0, f.defineReadOnly)(this, "_wrappedEmits", {}),
            null == e &&
              x.throwArgumentError(
            ...
            (0, f.defineReadOnly)(this, "resolvedAddress", g(this.provider, e));
          else
            try {
              (0, f.defineReadOnly)(
                this,
          ...
          Object.keys(this.interface.functions).forEach((e) => {
            ...
            null == this[e] && (0, f.defineReadOnly)(this, e, w(this, r, !0)),
              null == this.functions[e] &&
                (0, f.defineReadOnly)(this.functions, e, w(this, r, !1)),
              null == this.callStatic[e] &&
                (0, f.defineReadOnly)(this.callStatic, e, v(this, r, !0)),
            ...
            Object.keys(n).forEach((e) => {
              ...
              let r = t[0];
              try {
                null == this[e] && (0, f.defineReadOnly)(this, e, this[r]);
              } catch (e) {}
              null == this.functions[e] &&
                (0, f.defineReadOnly)(this.functions, e, this.functions[r]),
                null == this.callStatic[e] &&
                  (0, f.defineReadOnly)(this.callStatic, e, this.callStatic[r]),
                null == this.populateTransaction[e] &&
                  (0, f.defineReadOnly)(
                    this.populateTransaction,
                    e,
        ...
        _getRunningEvent(e) {
          if ("string" == typeof e) {
            ...
            return this._normalizeRunningEvent(
              new S(this.address, this.interface, t)
            );
          }
          if (e.topics && e.topics.length > 0) {
            try {
              ...
              return this._normalizeRunningEvent(
                new S(this.address, this.interface, r, e.topics)
              );
            } catch (e) {}
            let t = { address: this.address, topics: e.topics };
            return this._normalizeRunningEvent(new E(A(t), t));
          }
          return this._normalizeRunningEvent(
            new _(this.address, this.interface)
          );
      ...
      class N {
        constructor(e, t, r) {
          ...
          "0x" !==
            ...
            (!(0, l.isHexString)(n) || n.length % 2) &&
              x.throwArgumentError("invalid bytecode", "bytecode", t),
            r &&
              !o.Signer.isSigner(r) &&
              x.throwArgumentError("invalid signer", "signer", r),
            (0, f.defineReadOnly)(this, "bytecode", n),
            (0, f.defineReadOnly)(
              this,
              "interface",
              (0, f.getStatic)(new.target, "getInterface")(e)
            ),
            (0, f.defineReadOnly)(this, "signer", r || null);
        }
        getDeployTransaction(...e) {
          ...
          if (
            ...
            for (let r in (t = (0, f.shallowCopy)(e.pop())))
              if (!p[r]) throw Error("unknown transaction override " + r);
          }
          return (
        ...
        deploy(...e) {
          return h(this, void 0, void 0, function* () {
            ...
            let r = yield m(this.signer, e, this.interface.deploy.inputs);
            r.push(t);
            let n = this.getDeployTransaction(...r),
              i = yield this.signer.sendTransaction(n),
              a = (0, f.getStatic)(this.constructor, "getContractAddress")(i),
              o = (0, f.getStatic)(this.constructor, "getContract")(
                a,
                this.interface,
                this.signer
              );
            return y(o, i), (0, f.defineReadOnly)(o, "deployTransaction", i), o;
          });
        }
        attach(e) {
    ...
    56005: (e, t, r) => {
      ...
      var n = r(44541);
      let i = new (r(6865).Logger)("units/5.8.0"),
    ...
    60007: (e, t, r) => {
        ...
        for (let r = 0; r < e.length; r++) {
          ...
          t
            ? (t.name !== n.name ||
              ...
              x.throwArgumentError("provider mismatch", "networks", e)
            : (t = n);
        }
        return t;
      }
      ...
      function b(e) {
        ...
        if (i.gH.isBigNumber(e)) return e.toString();
      ...
      class S extends l.DJ {
        constructor(e, t) {
          0 === e.length &&
            x.throwArgumentError("missing providers", "providers", e);
          let r = e.map((e, t) => {
              if (n.Kq.isProvider(e)) {
                let t = (0, f.ws)(e) ? 2e3 : 750;
              ...
              let r = (0, o.shallowCopy)(e);
              null == r.priority && (r.priority = 1),
                null == r.stallTimeout &&
                  (r.stallTimeout = (0, f.ws)(e) ? 2e3 : 750),
          ...
          let a = g(r.map((e) => e.provider.network));
          null == a &&
            (a = new Promise((e, t) => {
              setTimeout(() => {
            ...
            super(a),
            (0, o.defineReadOnly)(this, "providerConfigs", Object.freeze(r)),
            (0, o.defineReadOnly)(this, "quorum", t),
        ...
        perform(e, t) {
          return h(this, void 0, void 0, function* () {
            ...
            let r = (function (e, t, r) {
                ...
                switch (t) {
                    ...
                    return function (t) {
                      ...
                      if (null != n)
                        return (
                          (n = Math.ceil(n)),
                          r.indexOf(n + 1) >= 0 && n++,
                          n >= e._highestBlockNumber &&
                            (e._highestBlockNumber = n),
                  ...
                  case "getTransactionReceipt":
                    a = function (e) {
                      return null == e
                        ? null
                        : (((e = (0, o.shallowCopy)(e)).confirmations = -1),
                          b(e));
                    };
                    break;
                  case "getBlock":
                    a = r.includeTransactions
                      ? function (e) {
                          return null == e
                            ? null
                            : (((e = (0, o.shallowCopy)(e)).transactions =
                                e.transactions.map(
                                  (e) => (
                                    ((e = (0, o.shallowCopy)(e)).confirmations =
                                      -1),
                                    e
                                  )
                                )),
                ...
                return (
                  ...
                  function (e) {
                    ...
                    e.forEach((e) => {
                      let r = n(e.result);
                      t[r] || (t[r] = { count: 0, result: e.result }),
                        t[r].count++;
                    });
                    let r = Object.keys(t);
                    for (let e = 0; e < r.length; e++) {
              ...
              n = (0, s.A)(this.providerConfigs.map(o.shallowCopy));
            ...
            for (;;) {
              ...
              for (; f < this.quorum && c < n.length; ) {
                let r = n[c++],
                  s = y++;
                (r.start = p()),
                  (r.staller = v(r.stallTimeout)),
                  r.staller.wait(() => {
                    r.staller = null;
                  }),
                    ...
                    return h(this, void 0, void 0, function* () {
                      ...
                      switch (r) {
                        ...
                        case "getLogs": {
                          let r = n.filter;
                          return (
                            ((r.fromBlock && (0, a.isHexString)(r.fromBlock)) ||
                              (r.toBlock && (0, a.isHexString)(r.toBlock))) &&
                              (i = yield k(e, t)),
                            i.getLogs(r)
                          );
                        }
                      ...
                      (r.done = !0),
                        ...
                        this.listenerCount("debug") &&
                          this.emit("debug", {
                            ...
                            rid: s,
                            backend: E(r, p()),
                            request: { method: e, params: (0, o.deepCopy)(t) },
                            provider: this,
                          });
                    },
                    (n) => {
              ...
              let g = n.filter((e) => e.done && null == e.error);
              ...
              if (
                (Object.keys(m).forEach((e) => {
                  ...
                  A.forEach((e) => {
                    ...
                    x.throwError(r.reason || r.message, e, i);
                }),
      ...
      n.inherits(d, f),
        ...
        (d.prototype._update = function (e, t) {
          ...
          for (n = 0; n < r.length; n++) {
            var x = ~~(n / 20),
              p = c(o(i, 5), l(x, a, f, d), h, r[n], u[x]);
            (h = d), (d = f), (f = o(a, 30)), (a = i), (i = p);
          }
          (this.h[0] = s(this.h[0], i)),
            (this.h[1] = s(this.h[1], a)),
    ...
    65511: (e, t, r) => {
      ...
      r(20037);
      var i = r(71182);
      let a = new (r(6865).Logger)("abstract-provider/5.8.0");
      class o extends i.Description {
            ...
            (a = function* () {
              ...
              return (
                e &&
                  e.baseFeePerGas &&
                  ((r = e.baseFeePerGas),
                  (o = n.gH.from("1500000000")),
                  (a = e.baseFeePerGas.mul(2).add(o))),
                {
                  lastBaseFeePerGas: r,
                  maxFeePerGas: a,
    ...
    65994: (e, t, r) => {
      "use strict";
      r.d(t, { r: () => n });
      let n = "providers/5.8.0";
    },
    66732: function (e, t, r) {
      !(function (e, t) {
        "use strict";
        function n(e, t) {
        ...
        if (
            ...
            if ("be" === r)
              for (o = e.length - 1, i = 0; o >= 0; o -= 3)
                (a = e[o] | (e[o - 1] << 8) | (e[o - 2] << 16)),
                  (this.words[i] |= (a << s) & 0x3ffffff),
                  (this.words[i + 1] = (a >>> (26 - s)) & 0x3ffffff),
                  (s += 24) >= 26 && ((s -= 26), i++);
            else if ("le" === r)
          ...
          (a.prototype._parseBase = function (e, t, r) {
            ...
            if (0 !== o) {
              var u = 1;
              for (l = c(e, f, e.length, t), f = 0; f < o; f++) u *= t;
              this.imuln(u),
                this.words[0] + l < 0x4000000
                  ? (this.words[0] += l)
                  : this._iaddn(l);
        ...
        function p(e, t, r) {
          ...
          for (var l = 1; l < n; l++) {
            for (
              var f = c >>> 26,
                u = 0x3ffffff & c,
                d = Math.min(l, t.length - 1),
                h = Math.max(0, l - e.length + 1);
              h <= d;
              h++
            ) {
              var x = (l - h) | 0;
              (f +=
                ((o = (i = 0 | e.words[x]) * (a = 0 | t.words[h]) + u) /
                  0x4000000) |
                0),
                (u = 0x3ffffff & o);
            }
        ...
        (a.prototype.toString = function (e, t) {
          if (((t = 0 | t || 1), 16 === (e = e || 10) || "hex" === e)) {
            for (var r = "", i = 0, a = 0, o = 0; o < this.length; o++) {
              var s = this.words[o],
                c = (((s << i) | a) & 0xffffff).toString(16);
              (a = (s >>> (24 - i)) & 0xffffff),
                (i += 2) >= 26 && ((i -= 26), o--),
                (r =
                  0 !== a || o !== this.length - 1
          ...
          if (e === (0 | e) && e >= 2 && e <= 36) {
            ...
            for (u.negative = 0; !u.isZero(); ) {
              var p = u.modrn(f).toString(e);
              r = (u = u.idivn(f)).isZero() ? p + r : d[l - p.length] + p + r;
            }
          ...
          (a.prototype.iadd = function (e) {
            ...
            this.length > e.length
              ? ((r = this), (n = e))
              : ((r = e), (n = this));
            for (var t, r, n, i = 0, a = 0; a < n.length; a++)
          ...
          (a.prototype.isub = function (e) {
            ...
            for (var a = 0, o = 0; o < r.length; o++)
              (a = (n = (0 | t.words[o]) - (0 | r.words[o]) + a) >> 26),
                (this.words[o] = 0x3ffffff & n);
        ...
        var g = function (e, t, r) {
          ...
          var eg =
            (((l + n) | 0) +
              ((8191 & (i = ((i = Math.imul(u, z)) + Math.imul(d, j)) | 0)) <<
                13)) |
            0;
          (l = ((((a = Math.imul(d, z)) + (i >>> 13)) | 0) + (eg >>> 26)) | 0),
            (eg &= 0x3ffffff),
            (n = Math.imul(x, j)),
            (i = ((i = Math.imul(x, z)) + Math.imul(p, j)) | 0),
            (a = Math.imul(p, z)),
            (n = (n + Math.imul(u, G)) | 0);
          var em =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, q)) | 0) + Math.imul(d, G)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, q)) | 0) + (i >>> 13)) | 0) +
              (em >>> 26)) |
            0),
            (em &= 0x3ffffff),
            (n = Math.imul(m, j)),
            (i = ((i = Math.imul(m, z)) + Math.imul(b, j)) | 0),
            (a = Math.imul(b, z)),
            (n = (n + Math.imul(x, G)) | 0),
            (i = ((i = (i + Math.imul(x, q)) | 0) + Math.imul(p, G)) | 0),
            (a = (a + Math.imul(p, q)) | 0),
            (n = (n + Math.imul(u, J)) | 0);
          var eb =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, V)) | 0) + Math.imul(d, J)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, V)) | 0) + (i >>> 13)) | 0) +
              (eb >>> 26)) |
            0),
            (eb &= 0x3ffffff),
            (n = Math.imul(v, j)),
            (i = ((i = Math.imul(v, z)) + Math.imul(w, j)) | 0),
            (a = Math.imul(w, z)),
            (n = (n + Math.imul(m, G)) | 0),
            (i = ((i = (i + Math.imul(m, q)) | 0) + Math.imul(b, G)) | 0),
            (a = (a + Math.imul(b, q)) | 0),
            (n = (n + Math.imul(x, J)) | 0),
            (i = ((i = (i + Math.imul(x, V)) | 0) + Math.imul(p, J)) | 0),
            (a = (a + Math.imul(p, V)) | 0),
            (n = (n + Math.imul(u, Y)) | 0);
          var ey =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, Z)) | 0) + Math.imul(d, Y)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, Z)) | 0) + (i >>> 13)) | 0) +
              (ey >>> 26)) |
            0),
            (ey &= 0x3ffffff),
            (n = Math.imul(E, j)),
            (i = ((i = Math.imul(E, z)) + Math.imul(k, j)) | 0),
            (a = Math.imul(k, z)),
            (n = (n + Math.imul(v, G)) | 0),
            (i = ((i = (i + Math.imul(v, q)) | 0) + Math.imul(w, G)) | 0),
            (a = (a + Math.imul(w, q)) | 0),
            (n = (n + Math.imul(m, J)) | 0),
            (i = ((i = (i + Math.imul(m, V)) | 0) + Math.imul(b, J)) | 0),
            (a = (a + Math.imul(b, V)) | 0),
            (n = (n + Math.imul(x, Y)) | 0),
            (i = ((i = (i + Math.imul(x, Z)) | 0) + Math.imul(p, Y)) | 0),
            (a = (a + Math.imul(p, Z)) | 0),
            (n = (n + Math.imul(u, $)) | 0);
          var ev =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, ee)) | 0) + Math.imul(d, $)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, ee)) | 0) + (i >>> 13)) | 0) +
              (ev >>> 26)) |
            0),
            (ev &= 0x3ffffff),
            (n = Math.imul(_, j)),
            (i = ((i = Math.imul(_, z)) + Math.imul(P, j)) | 0),
            (a = Math.imul(P, z)),
            (n = (n + Math.imul(E, G)) | 0),
            (i = ((i = (i + Math.imul(E, q)) | 0) + Math.imul(k, G)) | 0),
            (a = (a + Math.imul(k, q)) | 0),
            (n = (n + Math.imul(v, J)) | 0),
            (i = ((i = (i + Math.imul(v, V)) | 0) + Math.imul(w, J)) | 0),
            (a = (a + Math.imul(w, V)) | 0),
            (n = (n + Math.imul(m, Y)) | 0),
            (i = ((i = (i + Math.imul(m, Z)) | 0) + Math.imul(b, Y)) | 0),
            (a = (a + Math.imul(b, Z)) | 0),
            (n = (n + Math.imul(x, $)) | 0),
            (i = ((i = (i + Math.imul(x, ee)) | 0) + Math.imul(p, $)) | 0),
          ...
          var ew =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, en)) | 0) + Math.imul(d, er)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, en)) | 0) + (i >>> 13)) | 0) +
              (ew >>> 26)) |
            0),
            (ew &= 0x3ffffff),
            (n = Math.imul(N, j)),
            (i = ((i = Math.imul(N, z)) + Math.imul(C, j)) | 0),
            (a = Math.imul(C, z)),
            (n = (n + Math.imul(_, G)) | 0),
            (i = ((i = (i + Math.imul(_, q)) | 0) + Math.imul(P, G)) | 0),
            (a = (a + Math.imul(P, q)) | 0),
            (n = (n + Math.imul(E, J)) | 0),
            (i = ((i = (i + Math.imul(E, V)) | 0) + Math.imul(k, J)) | 0),
            (a = (a + Math.imul(k, V)) | 0),
            (n = (n + Math.imul(v, Y)) | 0),
            (i = ((i = (i + Math.imul(v, Z)) | 0) + Math.imul(w, Y)) | 0),
            (a = (a + Math.imul(w, Z)) | 0),
            (n = (n + Math.imul(m, $)) | 0),
            (i = ((i = (i + Math.imul(m, ee)) | 0) + Math.imul(b, $)) | 0),
            (a = (a + Math.imul(b, ee)) | 0),
            (n = (n + Math.imul(x, er)) | 0),
            (i = ((i = (i + Math.imul(x, en)) | 0) + Math.imul(p, er)) | 0),
          ...
          var eA =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, eo)) | 0) + Math.imul(d, ea)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, eo)) | 0) + (i >>> 13)) | 0) +
              (eA >>> 26)) |
            0),
            (eA &= 0x3ffffff),
            (n = Math.imul(I, j)),
            (i = ((i = Math.imul(I, z)) + Math.imul(T, j)) | 0),
            (a = Math.imul(T, z)),
            (n = (n + Math.imul(N, G)) | 0),
            (i = ((i = (i + Math.imul(N, q)) | 0) + Math.imul(C, G)) | 0),
            (a = (a + Math.imul(C, q)) | 0),
            (n = (n + Math.imul(_, J)) | 0),
            (i = ((i = (i + Math.imul(_, V)) | 0) + Math.imul(P, J)) | 0),
            (a = (a + Math.imul(P, V)) | 0),
            (n = (n + Math.imul(E, Y)) | 0),
            (i = ((i = (i + Math.imul(E, Z)) | 0) + Math.imul(k, Y)) | 0),
            (a = (a + Math.imul(k, Z)) | 0),
            (n = (n + Math.imul(v, $)) | 0),
            (i = ((i = (i + Math.imul(v, ee)) | 0) + Math.imul(w, $)) | 0),
            (a = (a + Math.imul(w, ee)) | 0),
            (n = (n + Math.imul(m, er)) | 0),
            (i = ((i = (i + Math.imul(m, en)) | 0) + Math.imul(b, er)) | 0),
            (a = (a + Math.imul(b, en)) | 0),
            (n = (n + Math.imul(x, ea)) | 0),
            (i = ((i = (i + Math.imul(x, eo)) | 0) + Math.imul(p, ea)) | 0),
          ...
          var eE =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, el)) | 0) + Math.imul(d, ec)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, el)) | 0) + (i >>> 13)) | 0) +
              (eE >>> 26)) |
            0),
            (eE &= 0x3ffffff),
            (n = Math.imul(B, j)),
            (i = ((i = Math.imul(B, z)) + Math.imul(L, j)) | 0),
            (a = Math.imul(L, z)),
            (n = (n + Math.imul(I, G)) | 0),
            (i = ((i = (i + Math.imul(I, q)) | 0) + Math.imul(T, G)) | 0),
            (a = (a + Math.imul(T, q)) | 0),
            (n = (n + Math.imul(N, J)) | 0),
            (i = ((i = (i + Math.imul(N, V)) | 0) + Math.imul(C, J)) | 0),
            (a = (a + Math.imul(C, V)) | 0),
            (n = (n + Math.imul(_, Y)) | 0),
            (i = ((i = (i + Math.imul(_, Z)) | 0) + Math.imul(P, Y)) | 0),
            (a = (a + Math.imul(P, Z)) | 0),
            (n = (n + Math.imul(E, $)) | 0),
            (i = ((i = (i + Math.imul(E, ee)) | 0) + Math.imul(k, $)) | 0),
            (a = (a + Math.imul(k, ee)) | 0),
            (n = (n + Math.imul(v, er)) | 0),
            (i = ((i = (i + Math.imul(v, en)) | 0) + Math.imul(w, er)) | 0),
            (a = (a + Math.imul(w, en)) | 0),
            (n = (n + Math.imul(m, ea)) | 0),
            (i = ((i = (i + Math.imul(m, eo)) | 0) + Math.imul(b, ea)) | 0),
            (a = (a + Math.imul(b, eo)) | 0),
            (n = (n + Math.imul(x, ec)) | 0),
            (i = ((i = (i + Math.imul(x, el)) | 0) + Math.imul(p, ec)) | 0),
            (a = (a + Math.imul(p, el)) | 0),
            (n = (n + Math.imul(u, eu)) | 0);
          var ek =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, ed)) | 0) + Math.imul(d, eu)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, ed)) | 0) + (i >>> 13)) | 0) +
              (ek >>> 26)) |
            0),
            (ek &= 0x3ffffff),
            (n = Math.imul(D, j)),
            (i = ((i = Math.imul(D, z)) + Math.imul(U, j)) | 0),
            (a = Math.imul(U, z)),
            (n = (n + Math.imul(B, G)) | 0),
            (i = ((i = (i + Math.imul(B, q)) | 0) + Math.imul(L, G)) | 0),
            (a = (a + Math.imul(L, q)) | 0),
            (n = (n + Math.imul(I, J)) | 0),
            (i = ((i = (i + Math.imul(I, V)) | 0) + Math.imul(T, J)) | 0),
            (a = (a + Math.imul(T, V)) | 0),
            (n = (n + Math.imul(N, Y)) | 0),
            (i = ((i = (i + Math.imul(N, Z)) | 0) + Math.imul(C, Y)) | 0),
            (a = (a + Math.imul(C, Z)) | 0),
            (n = (n + Math.imul(_, $)) | 0),
            (i = ((i = (i + Math.imul(_, ee)) | 0) + Math.imul(P, $)) | 0),
            (a = (a + Math.imul(P, ee)) | 0),
            (n = (n + Math.imul(E, er)) | 0),
            (i = ((i = (i + Math.imul(E, en)) | 0) + Math.imul(k, er)) | 0),
            (a = (a + Math.imul(k, en)) | 0),
            (n = (n + Math.imul(v, ea)) | 0),
            (i = ((i = (i + Math.imul(v, eo)) | 0) + Math.imul(w, ea)) | 0),
            (a = (a + Math.imul(w, eo)) | 0),
            (n = (n + Math.imul(m, ec)) | 0),
            (i = ((i = (i + Math.imul(m, el)) | 0) + Math.imul(b, ec)) | 0),
            (a = (a + Math.imul(b, el)) | 0),
            (n = (n + Math.imul(x, eu)) | 0),
            (i = ((i = (i + Math.imul(x, ed)) | 0) + Math.imul(p, eu)) | 0),
            (a = (a + Math.imul(p, ed)) | 0),
            (n = (n + Math.imul(u, ex)) | 0);
          var eS =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(u, ep)) | 0) + Math.imul(d, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(d, ep)) | 0) + (i >>> 13)) | 0) +
              (eS >>> 26)) |
            0),
            (eS &= 0x3ffffff),
            (n = Math.imul(D, G)),
            (i = ((i = Math.imul(D, q)) + Math.imul(U, G)) | 0),
            (a = Math.imul(U, q)),
            (n = (n + Math.imul(B, J)) | 0),
            (i = ((i = (i + Math.imul(B, V)) | 0) + Math.imul(L, J)) | 0),
            (a = (a + Math.imul(L, V)) | 0),
            (n = (n + Math.imul(I, Y)) | 0),
            (i = ((i = (i + Math.imul(I, Z)) | 0) + Math.imul(T, Y)) | 0),
            (a = (a + Math.imul(T, Z)) | 0),
            (n = (n + Math.imul(N, $)) | 0),
            (i = ((i = (i + Math.imul(N, ee)) | 0) + Math.imul(C, $)) | 0),
            (a = (a + Math.imul(C, ee)) | 0),
            (n = (n + Math.imul(_, er)) | 0),
            (i = ((i = (i + Math.imul(_, en)) | 0) + Math.imul(P, er)) | 0),
            (a = (a + Math.imul(P, en)) | 0),
            (n = (n + Math.imul(E, ea)) | 0),
            (i = ((i = (i + Math.imul(E, eo)) | 0) + Math.imul(k, ea)) | 0),
            (a = (a + Math.imul(k, eo)) | 0),
            (n = (n + Math.imul(v, ec)) | 0),
            (i = ((i = (i + Math.imul(v, el)) | 0) + Math.imul(w, ec)) | 0),
            (a = (a + Math.imul(w, el)) | 0),
            (n = (n + Math.imul(m, eu)) | 0),
            (i = ((i = (i + Math.imul(m, ed)) | 0) + Math.imul(b, eu)) | 0),
            (a = (a + Math.imul(b, ed)) | 0),
            (n = (n + Math.imul(x, ex)) | 0);
          var e_ =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(x, ep)) | 0) + Math.imul(p, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(p, ep)) | 0) + (i >>> 13)) | 0) +
              (e_ >>> 26)) |
            0),
            (e_ &= 0x3ffffff),
            (n = Math.imul(D, J)),
            (i = ((i = Math.imul(D, V)) + Math.imul(U, J)) | 0),
            (a = Math.imul(U, V)),
            (n = (n + Math.imul(B, Y)) | 0),
            (i = ((i = (i + Math.imul(B, Z)) | 0) + Math.imul(L, Y)) | 0),
            (a = (a + Math.imul(L, Z)) | 0),
            (n = (n + Math.imul(I, $)) | 0),
            (i = ((i = (i + Math.imul(I, ee)) | 0) + Math.imul(T, $)) | 0),
            (a = (a + Math.imul(T, ee)) | 0),
            (n = (n + Math.imul(N, er)) | 0),
            (i = ((i = (i + Math.imul(N, en)) | 0) + Math.imul(C, er)) | 0),
            (a = (a + Math.imul(C, en)) | 0),
            (n = (n + Math.imul(_, ea)) | 0),
            (i = ((i = (i + Math.imul(_, eo)) | 0) + Math.imul(P, ea)) | 0),
            (a = (a + Math.imul(P, eo)) | 0),
            (n = (n + Math.imul(E, ec)) | 0),
            (i = ((i = (i + Math.imul(E, el)) | 0) + Math.imul(k, ec)) | 0),
            (a = (a + Math.imul(k, el)) | 0),
            (n = (n + Math.imul(v, eu)) | 0),
            (i = ((i = (i + Math.imul(v, ed)) | 0) + Math.imul(w, eu)) | 0),
            (a = (a + Math.imul(w, ed)) | 0),
            (n = (n + Math.imul(m, ex)) | 0);
          var eP =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(m, ep)) | 0) + Math.imul(b, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(b, ep)) | 0) + (i >>> 13)) | 0) +
              (eP >>> 26)) |
            0),
            (eP &= 0x3ffffff),
            (n = Math.imul(D, Y)),
            (i = ((i = Math.imul(D, Z)) + Math.imul(U, Y)) | 0),
            (a = Math.imul(U, Z)),
            (n = (n + Math.imul(B, $)) | 0),
            (i = ((i = (i + Math.imul(B, ee)) | 0) + Math.imul(L, $)) | 0),
            (a = (a + Math.imul(L, ee)) | 0),
            (n = (n + Math.imul(I, er)) | 0),
            (i = ((i = (i + Math.imul(I, en)) | 0) + Math.imul(T, er)) | 0),
            (a = (a + Math.imul(T, en)) | 0),
            (n = (n + Math.imul(N, ea)) | 0),
            (i = ((i = (i + Math.imul(N, eo)) | 0) + Math.imul(C, ea)) | 0),
            (a = (a + Math.imul(C, eo)) | 0),
            (n = (n + Math.imul(_, ec)) | 0),
            (i = ((i = (i + Math.imul(_, el)) | 0) + Math.imul(P, ec)) | 0),
            (a = (a + Math.imul(P, el)) | 0),
            (n = (n + Math.imul(E, eu)) | 0),
            (i = ((i = (i + Math.imul(E, ed)) | 0) + Math.imul(k, eu)) | 0),
            (a = (a + Math.imul(k, ed)) | 0),
            (n = (n + Math.imul(v, ex)) | 0);
          var eR =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(v, ep)) | 0) + Math.imul(w, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(w, ep)) | 0) + (i >>> 13)) | 0) +
              (eR >>> 26)) |
            0),
            (eR &= 0x3ffffff),
            (n = Math.imul(D, $)),
            ...
            (i = ((i = (i + Math.imul(B, en)) | 0) + Math.imul(L, er)) | 0),
            (a = (a + Math.imul(L, en)) | 0),
            (n = (n + Math.imul(I, ea)) | 0),
            (i = ((i = (i + Math.imul(I, eo)) | 0) + Math.imul(T, ea)) | 0),
            (a = (a + Math.imul(T, eo)) | 0),
            (n = (n + Math.imul(N, ec)) | 0),
            (i = ((i = (i + Math.imul(N, el)) | 0) + Math.imul(C, ec)) | 0),
            (a = (a + Math.imul(C, el)) | 0),
            (n = (n + Math.imul(_, eu)) | 0),
            (i = ((i = (i + Math.imul(_, ed)) | 0) + Math.imul(P, eu)) | 0),
            (a = (a + Math.imul(P, ed)) | 0),
            (n = (n + Math.imul(E, ex)) | 0);
          var eN =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(E, ep)) | 0) + Math.imul(k, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(k, ep)) | 0) + (i >>> 13)) | 0) +
              (eN >>> 26)) |
            0),
            (eN &= 0x3ffffff),
            (n = Math.imul(D, er)),
            (i = ((i = Math.imul(D, en)) + Math.imul(U, er)) | 0),
            (a = Math.imul(U, en)),
            (n = (n + Math.imul(B, ea)) | 0),
            (i = ((i = (i + Math.imul(B, eo)) | 0) + Math.imul(L, ea)) | 0),
            (a = (a + Math.imul(L, eo)) | 0),
            (n = (n + Math.imul(I, ec)) | 0),
            (i = ((i = (i + Math.imul(I, el)) | 0) + Math.imul(T, ec)) | 0),
            (a = (a + Math.imul(T, el)) | 0),
            (n = (n + Math.imul(N, eu)) | 0),
            (i = ((i = (i + Math.imul(N, ed)) | 0) + Math.imul(C, eu)) | 0),
            (a = (a + Math.imul(C, ed)) | 0),
            (n = (n + Math.imul(_, ex)) | 0);
          var eC =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(_, ep)) | 0) + Math.imul(P, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(P, ep)) | 0) + (i >>> 13)) | 0) +
            ...
            (eC &= 0x3ffffff),
            (n = Math.imul(D, ea)),
            (i = ((i = Math.imul(D, eo)) + Math.imul(U, ea)) | 0),
            (a = Math.imul(U, eo)),
            (n = (n + Math.imul(B, ec)) | 0),
            (i = ((i = (i + Math.imul(B, el)) | 0) + Math.imul(L, ec)) | 0),
            (a = (a + Math.imul(L, el)) | 0),
            (n = (n + Math.imul(I, eu)) | 0),
            (i = ((i = (i + Math.imul(I, ed)) | 0) + Math.imul(T, eu)) | 0),
            (a = (a + Math.imul(T, ed)) | 0),
            (n = (n + Math.imul(N, ex)) | 0);
          var eM =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(N, ep)) | 0) + Math.imul(C, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(C, ep)) | 0) + (i >>> 13)) | 0) +
              (eM >>> 26)) |
            0),
            (eM &= 0x3ffffff),
            (n = Math.imul(D, ec)),
            (i = ((i = Math.imul(D, el)) + Math.imul(U, ec)) | 0),
            (a = Math.imul(U, el)),
            (n = (n + Math.imul(B, eu)) | 0),
            (i = ((i = (i + Math.imul(B, ed)) | 0) + Math.imul(L, eu)) | 0),
            (a = (a + Math.imul(L, ed)) | 0),
            (n = (n + Math.imul(I, ex)) | 0);
          var eI =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(I, ep)) | 0) + Math.imul(T, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(T, ep)) | 0) + (i >>> 13)) | 0) +
              (eI >>> 26)) |
            0),
            (eI &= 0x3ffffff),
            (n = Math.imul(D, eu)),
            (i = ((i = Math.imul(D, ed)) + Math.imul(U, eu)) | 0),
            (a = Math.imul(U, ed)),
            (n = (n + Math.imul(B, ex)) | 0);
          var eT =
            (((l + n) | 0) +
              ((8191 &
                (i =
                  ((i = (i + Math.imul(B, ep)) | 0) + Math.imul(L, ex)) | 0)) <<
                13)) |
            0;
          (l =
            ((((a = (a + Math.imul(L, ep)) | 0) + (i >>> 13)) | 0) +
              (eT >>> 26)) |
            0),
            (eT &= 0x3ffffff),
            (n = Math.imul(D, ex));
          var eO =
            (((l + n) | 0) +
              ((8191 & (i = ((i = Math.imul(D, ep)) + Math.imul(U, ex)) | 0)) <<
                13)) |
            0;
          return (
            (l =
              ((((a = Math.imul(U, ep)) + (i >>> 13)) | 0) + (eO >>> 26)) | 0),
            (eO &= 0x3ffffff),
            (c[0] = eg),
            (c[1] = em),
            (c[2] = eb),
        ...
        Math.imul || (g = p),
          ...
          (b.prototype.makeRBT = function (e) {
            for (
              var t = Array(e), r = a.prototype._countBits(e) - 1, n = 0;
              n < e;
              n++
            )
          ...
          (b.prototype.mulp = function (e, t, r) {
            ...
            (d.length = n),
              ...
              this.transform(l, a, f, u, n, i);
            for (var h = 0; h < n; h++) {
              var x = s[h] * f[h] - c[h] * u[h];
              (c[h] = s[h] * u[h] + c[h] * f[h]), (s[h] = x);
            }
            return (
              this.conjugate(s, c, n),
              this.transform(s, c, d, a, n, i),
          ...
          (a.prototype.imuln = function (e) {
            ...
            for (var r = 0, i = 0; i < this.length; i++) {
              var a = (0 | this.words[i]) * e,
                o = (0x3ffffff & a) + (0x3ffffff & r);
              (r >>= 26),
                (r += ((a / 0x4000000) | 0) + (o >>> 26)),
          ...
          (a.prototype.iushrn = function (e, t, r) {
            ...
            if (((i -= o), (i = Math.max(0, i)), r)) {
              for (var c = 0; c < o; c++) r.words[c] = this.words[c];
              r.length = o;
            }
            if (0 === o);
          ...
          (a.prototype._wordDiv = function (e, t) {
            ...
            0 != (n = 26 - this._countBits(s)) &&
              ((o = o.ushln(n)), i.iushln(n), (s = 0 | o.words[o.length - 1]));
            var c = i.length - o.length;
            if ("mod" !== t) {
              ((r = new a(null)).length = c + 1), (r.words = Array(r.length));
              for (var l = 0; l < r.length; l++) r.words[l] = 0;
            }
            var f = i.clone()._ishlnsubmul(o, 1, c);
            0 === f.negative && ((i = f), r && (r.words[c] = 1));
            for (var u = c - 1; u >= 0; u--) {
              var d =
                (0 | i.words[o.length + u]) * 0x4000000 +
                (0 | i.words[o.length + u - 1]);
              for (
                d = Math.min((d / s) | 0, 0x3ffffff), i._ishlnsubmul(o, d, u);
                0 !== i.negative;
          ...
          (a.prototype.modrn = function (e) {
            var t = e < 0;
            t && (e = -e), n(e <= 0x3ffffff);
            for (var r = 0x4000000 % e, i = 0, a = this.length - 1; a >= 0; a--)
          ...
          (a.prototype.idivn = function (e) {
            ...
            for (var r = 0, i = this.length - 1; i >= 0; i--) {
              var a = (0 | this.words[i]) + 0x4000000 * r;
          ...
          (a.prototype.egcd = function (e) {
            ...
            for (
              var i = new a(1), o = new a(0), s = new a(0), c = new a(1), l = 0;
              t.isEven() && r.isEven();
            ...
            for (var f = r.clone(), u = t.clone(); !t.isZero(); ) {
              ...
              if (d > 0)
                for (t.iushrn(d); d-- > 0; )
                  (i.isOdd() || o.isOdd()) && (i.iadd(f), o.isub(u)),
                    i.iushrn(1),
                    o.iushrn(1);
              for (
                var x = 0, p = 1;
          ...
          (a.prototype._invmp = function (e) {
            ...
            for (
              var o = new a(1), s = new a(0), c = i.clone();
              ...
              r.cmp(i) >= 0 ? (r.isub(i), o.isub(s)) : (i.isub(r), s.isub(o));
            }
            return 0 > (t = 0 === r.cmpn(1) ? o : s).cmpn(0) && t.iadd(e), t;
          }),
        ...
        (v.prototype._tmp = function () {
          ...
          (S.prototype.sqrt = function (e) {
            ...
            for (
              ...
              for (var p = h, g = 0; 0 !== p.cmp(s); g++) p = p.redSqr();
              n(g < x);
              var m = this.pow(u, new a(1).iushln(x - g - 1));
              (d = d.redMul(m)), (u = m.redSqr()), (h = h.redMul(u)), (x = g);
            }
            return d;
          }),
          ...
          (S.prototype.pow = function (e, t) {
            ...
            for (0 === c && (c = 26), n = t.length - 1; n >= 0; n--) {
              for (var l = t.words[n], f = c - 1; f >= 0; f--) {
                var u = (l >> f) & 1;
                if ((i !== r[0] && (i = this.sqr(i)), 0 === u && 0 === o)) {
                  s = 0;
                  continue;
                }
                (o <<= 1),
    ...
    69625: (e, t, r) => {
      ...
      function x(e) {
        ...
        (t = t
          ...
          (t = (0, n.dg)((0, n.H5)(t), n.dz.NFKC)).forEach((e) => {
            if (o(e, h)) throw Error("STRINGPREP_CONTAINS_PROHIBITED");
          }),
          t.forEach((e) => {
            if (o(e, s)) throw Error("STRINGPREP_CONTAINS_UNASSIGNED");
          });
        let r = (0, n.H5)(t);
        if (
          "-" === r.substring(0, 1) ||
    ...
    71182: (e, t, r) => {
      ...
      let n = new (r(6865).Logger)("properties/5.8.0");
      function i(e, t, r) {
    ...
    72464: (e, t, r) => {
      ...
      !(function () {
        ...
        for (
          var v = function (e, t, r) {
            ...
            A = function (e, t, r) {
              return function (t, n, i, a) {
                return P["cshake" + e].update(t, n, i, a)[r]();
              };
            },
            E = function (e, t, r) {
              return function (t, n, i, a) {
                return P["kmac" + e].update(t, n, i, a)[r]();
              };
            },
            k = function (e, t, r, n) {
              ...
              },
              {
                ...
                createMethod: function (e, t) {
                  var r = y[e],
                    n = A(e, t, "hex");
                  return (
                    (n.create = function (n, i, a) {
                      return i || a
                        ? new B(e, t, n).bytepad([i, a], r)
                        : P["shake" + e].create(n);
                    }),
          ...
          for (var C = _[N], M = C.bits, I = 0; I < M.length; ++I) {
            var T = C.name + "_" + M[I];
            if (
              (R.push(T),
              (P[T] = C.createMethod(M[I], C.padding)),
              "sha3" !== C.name)
            ) {
              var O = C.name + M[I];
              R.push(O), (P[O] = P[T]);
        ...
        (B.prototype.update = function (e) {
          ...
          if ("string" !== r) {
            if ("object" === r) {
              ...
              else if (u && e.constructor === ArrayBuffer)
                e = new Uint8Array(e);
          ...
          for (
            ...
            if (this.reset)
              for (n = 1, this.reset = !1, o[0] = this.block; n < l + 1; ++n)
                o[n] = 0;
            if (t)
              ...
              for (n = this.start; f < c && n < s; ++f)
                (i = e.charCodeAt(f)) < 128
                  ...
                  : (i < 2048
                      ? (o[n >> 2] |= (192 | (i >> 6)) << x[3 & n++])
                      : (i < 55296 || i >= 57344
                          ? (o[n >> 2] |= (224 | (i >> 12)) << x[3 & n++])
                          : ((i =
                              65536 +
                              (((1023 & i) << 10) |
                                (1023 & e.charCodeAt(++f)))),
                            (o[n >> 2] |= (240 | (i >> 18)) << x[3 & n++]),
                            (o[n >> 2] |=
                              (128 | ((i >> 12) & 63)) << x[3 & n++])),
                        (o[n >> 2] |= (128 | ((i >> 6) & 63)) << x[3 & n++])),
                    (o[n >> 2] |= (128 | (63 & i)) << x[3 & n++]));
            if (((this.lastByteIndex = n), n >= s)) {
              for (this.start = n - s, this.block = o[l], n = 0; n < l; ++n)
                d[n] ^= o[n];
              F(d), (this.reset = !0);
            } else this.start = n;
          }
          ...
          (B.prototype.toString = B.prototype.hex =
            function () {
              ...
              return (
                i &&
                  ((s += d[((e = r[a]) >> 4) & 15] + d[15 & e]),
                  i > 1 && (s += d[(e >> 12) & 15] + d[(e >> 8) & 15]),
                  i > 2 && (s += d[(e >> 20) & 15] + d[(e >> 16) & 15])),
                s
              );
            }),
          (B.prototype.arrayBuffer = function () {
            ...
            return i && ((c[a] = r[a]), (e = e.slice(0, s))), e;
          }),
        ...
        if (l) e.exports = P;
          ...
          for (N = 0; N < R.length; ++N) s[R[N]] = P[R[N]];
          f &&
            (void 0 ===
              (n = function () {
                return P;
    ...
    72490: (e, t, r) => {
      ...
      var n = r(704),
        ...
        g = r(6865),
        m = r(3401);
      let b = new g.Logger(m.r);
      function y(e) {
        return null != e && e.mnemonic && e.mnemonic.phrase;
      }
      class v extends h.Description {
        isKeystoreAccount(e) {
          return !!(e && e._isKeystoreAccount);
        }
      }
      function w(e, t) {
        let r = (0, p.m0)((0, p.oe)(e, "crypto/ciphertext"));
        if (
          (0, c.hexlify)(
            (0, f.keccak256)((0, c.concat)([t.slice(16, 32), r]))
          ).substring(2) !== (0, p.oe)(e, "crypto/mac").toLowerCase()
        )
          throw Error("invalid password");
        let n = (function (e, t, r) {
          if ("aes-128-ctr" === (0, p.oe)(e, "crypto/cipher")) {
            let n = (0, p.m0)((0, p.oe)(e, "crypto/cipherparams/iv")),
              a = new (i().Counter)(n),
              o = new (i().ModeOfOperation.ctr)(t, a);
            return (0, c.arrayify)(o.decrypt(r));
          }
          return null;
        })(e, t.slice(0, 16), r);
        n ||
        ...
        if ("0.1" === (0, p.oe)(e, "x-ethers/version")) {
          let t = (0, p.m0)((0, p.oe)(e, "x-ethers/mnemonicCiphertext")),
            r = (0, p.m0)((0, p.oe)(e, "x-ethers/mnemonicCounter")),
            n = new (i().Counter)(r),
            o = new (i().ModeOfOperation.ctr)(a, n),
            s = (0, p.oe)(e, "x-ethers/path") || l.defaultPath,
            f = (0, p.oe)(e, "x-ethers/locale") || "en",
            d = (0, c.arrayify)(o.decrypt(t));
          try {
            let e = (0, l.entropyToMnemonic)(d, f),
              t = l.HDNode.fromMnemonic(e, null, f).derivePath(s);
            if (t.privateKey != u.privateKey) throw Error("mnemonic mismatch");
            u.mnemonic = t.mnemonic;
          } catch (e) {
            if (
              e.code !== g.Logger.errors.INVALID_ARGUMENT ||
              "wordlist" !== e.argument
            )
              throw e;
          }
      ...
      function A(e, t, r, n, i) {
        return (0, c.arrayify)((0, u.A)(e, t, r, n, i));
      }
      function E(e, t, r, n, i) {
        return Promise.resolve(A(e, t, r, n, i));
      }
      function k(e, t, r, n, i) {
        let a = (0, p.Qq)(t),
          o = (0, p.oe)(e, "crypto/kdf");
        if (o && "string" == typeof o) {
          ...
          if ("scrypt" === o.toLowerCase()) {
            let r = (0, p.m0)((0, p.oe)(e, "crypto/kdfparams/salt")),
              s = parseInt((0, p.oe)(e, "crypto/kdfparams/n")),
              c = parseInt((0, p.oe)(e, "crypto/kdfparams/r")),
              l = parseInt((0, p.oe)(e, "crypto/kdfparams/p"));
            (s && c && l) || t("kdf", o), (s & (s - 1)) != 0 && t("N", s);
            let f = parseInt((0, p.oe)(e, "crypto/kdfparams/dklen"));
            return 32 !== f && t("dklen", f), n(a, r, s, c, l, 64, i);
          }
          if ("pbkdf2" === o.toLowerCase()) {
            let n = (0, p.m0)((0, p.oe)(e, "crypto/kdfparams/salt")),
              i = null,
              o = (0, p.oe)(e, "crypto/kdfparams/prf");
            "hmac-sha256" === o
              ? (i = "sha256")
              : "hmac-sha512" === o
              ? (i = "sha512")
              : t("prf", o);
            let s = parseInt((0, p.oe)(e, "crypto/kdfparams/c")),
              c = parseInt((0, p.oe)(e, "crypto/kdfparams/dklen"));
            return 32 !== c && t("dklen", c), r(a, n, s, c, i);
          }
        }
        return b.throwArgumentError(
      ...
      function P(e, t, r, n) {
        try {
          if (
            (0, s.getAddress)(e.address) !== (0, x.computeAddress)(e.privateKey)
          )
        ...
        let a = (0, c.arrayify)(e.privateKey),
          u = (0, p.Qq)(t),
          h = null,
          g = null,
          m = null;
        if (y(e)) {
          ...
          (h = (0, c.arrayify)(
            ...
            (g = t.path || l.defaultPath),
            (m = t.locale || "en");
        }
        let b = r.client;
        b || (b = "ethers.js");
        let v = null;
        v = r.salt ? (0, c.arrayify)(r.salt) : (0, d.p)(32);
        let w = null;
        if (r.iv) {
          if (16 !== (w = (0, c.arrayify)(r.iv)).length)
            throw Error("invalid iv");
        } else w = (0, d.p)(16);
        let A = null;
        if (r.uuid) {
          if (16 !== (A = (0, c.arrayify)(r.uuid)).length)
        ...
        return (
          r.scrypt &&
            ...
            r.scrypt.r && (k = r.scrypt.r),
            r.scrypt.p && (S = r.scrypt.p)),
          o()
            .scrypt(u, v, E, k, S, 64, n)
            .then((t) => {
              let r = (t = (0, c.arrayify)(t)).slice(0, 16),
                n = t.slice(16, 32),
                o = t.slice(32, 64),
                s = new (i().Counter)(w),
                l = new (i().ModeOfOperation.ctr)(r, s),
                u = (0, c.arrayify)(l.encrypt(a)),
                x = (0, f.keccak256)((0, c.concat)([n, u])),
                y = {
                  ...
                  crypto: {
                    cipher: "aes-128-ctr",
                    cipherparams: { iv: (0, c.hexlify)(w).substring(2) },
                    ciphertext: (0, c.hexlify)(u).substring(2),
                    kdf: "scrypt",
                    kdfparams: {
              ...
              if (h) {
                let e = (0, d.p)(16),
                  ...
                  n = (0, c.arrayify)(r.encrypt(h)),
                  a = new Date(),
                  s =
                    a.getUTCFullYear() +
                    "-" +
                    (0, p.Sp)(a.getUTCMonth() + 1, 2) +
                    "-" +
                    (0, p.Sp)(a.getUTCDate(), 2) +
                    "T" +
                    (0, p.Sp)(a.getUTCHours(), 2) +
                    "-" +
                    (0, p.Sp)(a.getUTCMinutes(), 2) +
                    "-" +
                    (0, p.Sp)(a.getUTCSeconds(), 2) +
                    ".0Z";
                y["x-ethers"] = {
                  client: b,
      ...
      class d {
        constructor(e, t, r, i) {
          (0, a.defineReadOnly)(this, "_data", (0, n.arrayify)(e)),
            ...
            (0, a.defineReadOnly)(this, "allowLoose", i),
            (this._offset = 0);
        }
        get data() {
    ...
    73546: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { Signer: () => l, VoidSigner: () => f });
      var n = r(71182),
        i = r(6865),
        a = function (e, t, r, n) {
          return new (r || (r = Promise))(function (i, a) {
      ...
      let o = new i.Logger("abstract-signer/5.8.0"),
        s = [
          "accessList",
          "ccipReadEnabled",
          "chainId",
        ...
        detectNetwork() {
          ...
          return (
            ...
            (a = function* () {
              ...
              return (
                null == e &&
                  ((e = yield o.detectNetwork.call(this)) ||
                    s.throwError(
                      "no network detected",
      ...
      class l extends c {
        constructor(e, t) {
          s.checkAbstract(new.target, l),
            (e = (0, n.getStatic)(new.target, "getNetwork")(e)),
            super(
              (0, n.getStatic)(new.target, "getUrl")(
                e,
                (t = (0, n.getStatic)(new.target, "getApiKey")(t))
              ),
              e
            ),
            "string" == typeof t
              ? (0, n.defineReadOnly)(this, "apiKey", t)
              : null != t &&
    ...
    75644: (e, t, r) => {
      ...
      var n = r(13679),
        ...
        u = r(6865),
        d = r(41678);
      let h = new u.Logger(d.r);
      class x extends c.Description {}
      ...
      class v {
        constructor(e) {
          ...
          (t = "string" == typeof e ? JSON.parse(e) : e),
            (0, c.defineReadOnly)(
              this,
              "fragments",
              t.map((e) => f.FK.from(e)).filter((e) => null != e)
            ),
            (0, c.defineReadOnly)(
              this,
              "_abiCoder",
            ...
            this.fragments.forEach((e) => {
              ...
              switch (e.type) {
                case "constructor":
                  if (this.deploy)
                    return void h.warn("duplicate definition - constructor");
                  (0, c.defineReadOnly)(this, "deploy", e);
                  return;
                case "function":
                  t = this.functions;
                  break;
              ...
              let r = e.format();
              if (t[r]) return void h.warn("duplicate definition - " + r);
              t[r] = e;
            }),
            this.deploy ||
              (0, c.defineReadOnly)(
                this,
                "deploy",
                f.Pw.from({ payable: !1, type: "constructor" })
              ),
        ...
        static getSighash(e) {
          return (0, a.hexDataSlice)((0, o.id)(e.format()), 0, 4);
        }
        ...
        getFunction(e) {
          ...
          if (-1 === e.indexOf("(")) {
            ...
            return (
              0 === r.length
                ? h.throwArgumentError("no matching function", "name", t)
                : r.length > 1 &&
                  h.throwArgumentError(
          ...
          let t = this.functions[f.hc.fromString(e).format()];
          return (
            t || h.throwArgumentError("no matching function", "signature", e), t
          );
        }
        getEvent(e) {
          if ((0, a.isHexString)(e)) {
          ...
          if (-1 === e.indexOf("(")) {
            ...
            return (
              0 === r.length
                ? h.throwArgumentError("no matching event", "name", t)
                : r.length > 1 &&
                  h.throwArgumentError("multiple matching events", "name", t),
              this.events[r[0]]
            );
          }
          let t = this.events[f.Zp.fromString(e).format()];
          return (
            t || h.throwArgumentError("no matching event", "signature", e), t
          );
        }
        getError(e) {
          if ((0, a.isHexString)(e)) {
            let t = (0, c.getStatic)(this.constructor, "getSighash");
          ...
          if (-1 === e.indexOf("(")) {
            ...
            return (
              0 === r.length
                ? h.throwArgumentError("no matching error", "name", t)
                : r.length > 1 &&
                  h.throwArgumentError("multiple matching errors", "name", t),
              this.errors[r[0]]
            );
          }
          let t = this.errors[f.hc.fromString(e).format()];
          return (
            t || h.throwArgumentError("no matching error", "signature", e), t
          );
        }
        getSighash(e) {
          if ("string" == typeof e)
              ...
              if (t)
                (o = this._abiCoder.decode(t.inputs, r.slice(4))),
                  ...
                  "Error" === s
                    ...
                    : "Panic" === s &&
                      (i = `; VM Exception while processing transaction: reverted with panic code ${o[0]}`);
              else
                try {
          ...
          return (
            ...
            e.inputs.forEach((e, a) => {
              ...
              if (e.indexed)
                ...
                else r.push(this._abiCoder.encode([e.type], [c]));
        ...
        decodeEventLog(e, t, r) {
          ...
          e.inputs.forEach((e, t) => {
            e.indexed
              ? "string" === e.type ||
                ...
                "tuple" === e.baseType ||
                "array" === e.baseType
                ? (n.push(f.aX.fromObject({ type: "bytes32", name: e.name })),
                  o.push(!0))
                : (n.push(e), o.push(!1))
              : (i.push(e), o.push(!1));
          });
          ...
          e.inputs.forEach((e, t) => {
            if (e.indexed)
              if (null == s) l[t] = new m({ _isIndexed: !0, hash: null });
              else if (o[t]) l[t] = new m({ _isIndexed: !0, hash: s[x++] });
              else
                try {
                  l[t] = s[x++];
                } catch (e) {
    ...
    84205: (e, t, r) => {
      "use strict";
      r.r(t),
        r.d(t, { _fetchData: () => u, fetchJson: () => d, poll: () => h });
      var n = r(30447),
        i = r(20037),
        a = r(71182),
        o = r(19744),
        s = r(6865);
      let c = new s.Logger("web/5.8.0");
      function l(e) {
        return new Promise((t) => {
          setTimeout(t, e);
        });
      ...
      function u(e, t, r) {
        ...
        if ("string" == typeof e) m = e;
          ...
          if (
            ((null == e || null == e.url) &&
              c.throwArgumentError("missing URL", "connection.url", e),
            (m = e.url),
            "number" == typeof e.timeout && e.timeout > 0 && (v = e.timeout),
            e.headers)
          )
            for (let t in e.headers)
              (g[t.toLowerCase()] = { key: t, value: String(e.headers[t]) }),
                ["if-none-match", "if-modified-since"].indexOf(
                  t.toLowerCase()
                ) >= 0 && (y = !0);
          if (
            ((b.allowGzip = !!e.allowGzip),
                ...
                v &&
                  (u = setTimeout(() => {
                    null != u &&
                      ((u = null),
                      t(
                        c.makeError("timeout", s.Logger.errors.TIMEOUT, {
                          requestBody: f(b.body, k["content-type"]),
                ...
                for (let e = 0; e < d; e++) {
                          ...
                          (o = function* () {
                            ...
                            return (
                                  ...
                                  }),
                              {
                                ...
                                body: (0, i.arrayify)(new Uint8Array(a)),
                              }
                            );
                          }),
                          new (a || (a = Promise))(function (e, t) {
                  ...
                  if (
                    ...
                    try {
                      ...
                      if (r.throttleRetry && e < d) {
                        let t = !0;
                        if ((h && (t = yield h(e, m)), t)) {
                          let t =
                            x *
        ...
        return Promise.race([S.promise, _]);
      }
      function d(e, t, r) {
        let n = null;
        if (null != t) {
          n = (0, o.YW)(t);
          let r = "string" == typeof e ? { url: e } : (0, a.shallowCopy)(e);
          r.headers
            ? 0 ===
                Object.keys(r.headers).filter(
                  (e) => "content-type" === e.toLowerCase()
                ).length &&
              ((r.headers = (0, a.shallowCopy)(r.headers)),
        ...
        return u(e, n, (e, t) => {
          ...
          if (null != e)
            try {
              n = JSON.parse((0, o._v)(e));
            } catch (t) {
              c.throwError("invalid JSON", s.Logger.errors.SERVER_ERROR, {
                body: e,
                error: t,
              });
            }
    ...
    86166: (e, t, r) => {
      ...
      (p.prototype.point = function () {
          ...
          for (
            ...
            for (r = 0; r < s.length; r++)
              (n = s[r]) === u
                ...
                : n === -u && (f = f.mixedAdd(i.points[r].neg()));
            l = l.add(f);
          }
          return l.toP();
        }),
        ...
        (p.prototype._wnafMulAdd = function (e, t, r, n, i) {
          var a,
            ...
            u = 0;
          for (a = 0; a < n; a++) {
            var x = (s = t[a])._getNAFPoints(e);
            (c[a] = x.wnd), (l[a] = x.points);
          }
          for (a = n - 1; a >= 1; a -= 2) {
            var p = a - 1,
              g = a;
            if (1 !== c[p] || 1 !== c[g]) {
              (f[p] = d(r[p], c[p], this._bitLength)),
                (f[g] = d(r[g], c[g], this._bitLength)),
                (u = Math.max(f[p].length, u)),
                (u = Math.max(f[g].length, u));
              continue;
            }
            var m = [t[p], null, null, t[g]];
            0 === t[p].y.cmp(t[g].y)
              ? ((m[1] = t[p].add(t[g])),
                (m[2] = t[p].toJ().mixedAdd(t[g].neg())))
              : 0 === t[p].y.cmp(t[g].y.redNeg())
              ? ((m[1] = t[p].toJ().mixedAdd(t[g])),
                (m[2] = t[p].add(t[g].neg())))
              : ((m[1] = t[p].toJ().mixedAdd(t[g])),
                (m[2] = t[p].toJ().mixedAdd(t[g].neg())));
            ...
            for (
              ...
              var v = 0 | y[0][o],
                w = 0 | y[1][o];
              (f[p][o] = b[(v + 1) * 3 + (w + 1)]), (f[g][o] = 0), (l[p] = m);
            }
          }
          ...
          for (a = u; a >= 0; a--) {
            for (var k = 0; a >= 0; ) {
              var S = !0;
              for (o = 0; o < n; o++)
                (E[o] = 0 | f[o][a]), 0 !== E[o] && (S = !1);
              if (!S) break;
              k++, a--;
            }
            if ((a >= 0 && k++, (A = A.dblp(k)), a < 0)) break;
            for (o = 0; o < n; o++) {
              var _ = E[o];
              0 !== _ &&
                (_ > 0
        ...
        (g.prototype.encode = function (e, t) {
          return u.encode(this._encode(t), e);
        }),
      ...
      function v(e, t, r, n) {
        p.BasePoint.call(this, e, "affine"),
          null === t && null === r
      ...
      function w(e, t, r, n) {
        p.BasePoint.call(this, e, "jacobian"),
      ...
      m(y, p),
        ...
        (y.prototype._getEndoBasis = function (e) {
          for (
            ...
            var y = h.div(d);
            (l = h.sub(y.mul(d))), (f = g.sub(y.mul(x)));
            var v = m.sub(y.mul(p));
            if (!n && 0 > l.cmp(u))
              (t = c.neg()), (r = x), (n = l.neg()), (a = f);
            else if (n && 2 == ++b) break;
            (c = l), (h = d), (d = l), (g = x), (x = f), (m = p), (p = v);
          }
          (o = l.neg()), (s = f);
          var w = n.sqr().add(a.sqr());
          return (
            o.sqr().add(s.sqr()).cmp(w) >= 0 && ((o = t), (s = r)),
        ...
        (y.prototype._endoWnafMulAdd = function (e, t, r) {
          ...
          for (
            var l = this._wnafMulAdd(1, n, i, 2 * a, r), f = 0;
            f < 2 * a;
            f++
          )
            (n[f] = null), (i[f] = null);
        ...
        (y.prototype.point = function (e, t, r) {
          return new v(this, e, t, r);
        }),
        (y.prototype.pointFromJSON = function (e, t) {
          return v.fromJSON(this, e, t);
        }),
        ...
        (v.prototype.mulAdd = function (e, t, r) {
          var n = [this, t],
            i = [e, r];
        ...
        (v.prototype.jmulAdd = function (e, t, r) {
          var n = [this, t],
            i = [e, r];
          return this.curve.endo
        ...
        (w.prototype.add = function (e) {
          ...
          var l = s.redSqr(),
            f = l.redMul(s),
            u = n.redMul(l),
            d = c.redSqr().redIAdd(f).redISub(u).redISub(u),
            h = c.redMul(u.redISub(d)).redISub(a.redMul(f)),
            x = this.z.redMul(e.z).redMul(s);
          return this.curve.jpoint(d, h, x);
        }),
        (w.prototype.mixedAdd = function (e) {
          ...
          var c = o.redSqr(),
            l = c.redMul(o),
            f = r.redMul(c),
            u = s.redSqr().redIAdd(l).redISub(f).redISub(f),
            d = s.redMul(f.redISub(u)).redISub(i.redMul(l)),
            h = this.z.redMul(o);
          return this.curve.jpoint(u, d, h);
        }),
        (w.prototype.dblp = function (e) {
          ...
          for (t = 0; t < e; t++) {
            var f = a.redSqr(),
              u = l.redSqr(),
              d = u.redSqr(),
              h = f.redAdd(f).redIAdd(f).redIAdd(n.redMul(c)),
              x = a.redMul(u),
              p = h.redSqr().redISub(x.redAdd(x)),
              g = x.redISub(p),
              m = h.redMul(g);
            m = m.redIAdd(m).redISub(d);
            var b = l.redMul(s);
            t + 1 < e && (c = c.redMul(d)), (a = p), (s = b), (l = m);
          }
        ...
        (w.prototype._zeroDbl = function () {
          if (this.zOne) {
            ...
            var f = this.x.redSqr(),
              u = this.y.redSqr(),
              d = u.redSqr(),
              h = this.x.redAdd(u).redSqr().redISub(f).redISub(d);
            h = h.redIAdd(h);
            var x = f.redAdd(f).redIAdd(f),
              p = x.redSqr(),
              g = d.redIAdd(d);
            (g = (g = g.redIAdd(g)).redIAdd(g)),
              (e = p.redISub(h).redISub(h)),
              (t = x.redMul(h.redISub(e)).redISub(g)),
        ...
        (w.prototype._dbl = function () {
          var e = this.curve.a,
            ...
            f = s.redSqr().redISub(l.redAdd(l)),
            u = l.redISub(f),
            d = o.redSqr();
          d = (d = (d = d.redIAdd(d)).redIAdd(d)).redIAdd(d);
          var h = s.redMul(u).redISub(d),
            x = r.redAdd(r).redMul(n);
          return this.curve.jpoint(f, h, x);
        }),
        (w.prototype.trpl = function () {
          ...
          var l = i.redIAdd(o).redSqr().redISub(a).redISub(s).redISub(c),
            f = t.redMul(l);
          f = (f = f.redIAdd(f)).redIAdd(f);
          var u = this.x.redMul(s).redISub(f);
          u = (u = u.redIAdd(u)).redIAdd(u);
          var d = this.y.redMul(l.redMul(c.redISub(l)).redISub(o.redMul(s)));
          d = (d = (d = d.redIAdd(d)).redIAdd(d)).redIAdd(d);
      ...
      (k.prototype._init = function (e, t, r) {
        ...
        (k.prototype.reseed = function (e, t, r, n) {
        ...
        (k.prototype.generate = function (e, t, r, n) {
          if (this._reseed > this.reseedInterval)
            throw Error("Reseed is required");
          "string" != typeof t && ((n = r), (r = t), (t = null)),
            r && ((r = f.toArray(r, n || "hex")), this._update(r));
          for (var i = []; i.length < e; )
            (this.V = this._hmac().update(this.V).digest()),
              (i = i.concat(this.V));
          var a = i.slice(0, e);
          return this._update(r), this._reseed++, f.encode(a, t);
        });
      var S = u.assert;
      function _(e, t) {
        (this.ec = e),
      ...
      (_.fromPublic = function (e, t, r) {
        return t instanceof _ ? t : new _(e, { pub: t, pubEnc: r });
      }),
        (_.fromPrivate = function (e, t, r) {
          return t instanceof _ ? t : new _(e, { priv: t, privEnc: r });
        }),
      ...
      (R.prototype._importDER = function (e, t) {
        ...
        var o = e.slice(r.place, a + r.place);
        if (((r.place += a), 2 !== e[r.place++])) return !1;
        var s = C(e, r);
        if (!1 === s || e.length !== s + r.place || (128 & e[r.place]) != 0)
          return !1;
        ...
        (R.prototype.toDER = function (e) {
          ...
          for (
            ...
            r = r.slice(1);
          var n = [2];
          I(n, t.length), (n = n.concat(t)).push(2), I(n, r.length);
          var i = n.concat(r),
            a = [48];
          return I(a, i.length), (a = a.concat(i)), u.encode(a, e);
        });
      var T = function () {
      ...
      function B(e) {
        ...
        "string" == typeof e &&
          (O(Object.prototype.hasOwnProperty.call(E, e), "Unknown curve " + e),
          (e = E[e])),
          e instanceof E.PresetCurve && (e = { curve: e }),
      ...
      (B.prototype.keyPair = function (e) {
        ...
        (B.prototype._truncateToN = function (e, t, r) {
          ...
          return (o > 0 && (e = e.ushrn(o)), !t && e.cmp(this.n) >= 0)
            ? e.sub(this.n)
            : e;
        }),
        (B.prototype.sign = function (e, t, r, n) {
          if (
            ...
            O(
              ...
              O(e.length >>> 0 === e.length);
            for (var a = 0; a < e.length; a++) O((255 & e[a]) === e[a]);
          }
          ...
          var o = this.n.byteLength(),
            ...
            c = e.toArray("be", o);
          O(new (i())(c).eq(e), "Can not sign message");
          for (
            var l = new k({
                hash: this.hash,
                entropy: s,
            ...
            var d = n.k ? n.k(u) : new (i())(l.generate(this.n.byteLength()));
            if (0 >= (d = this._truncateToN(d, !0)).cmpn(1) || d.cmp(f) >= 0)
              continue;
            var h = this.g.mul(d);
            if (!h.isInfinity()) {
              var x = h.getX(),
                p = x.umod(this.n);
              if (0 !== p.cmpn(0)) {
                var g = d.invm(this.n).mul(p.mul(t.getPrivate()).iadd(e));
                if (0 !== (g = g.umod(this.n)).cmpn(0)) {
                  var m = !!h.getY().isOdd() | (2 * (0 !== x.cmp(p)));
                  return (
                    n.canonical &&
                      g.cmp(this.nh) > 0 &&
                      ((g = this.n.sub(g)), (m ^= 1)),
                    new R({ r: p, s: g, recoveryParam: m })
                  );
                }
              }
            }
        ...
        (B.prototype.verify = function (e, t, r, n, i) {
          i || (i = {}),
          ...
          var c = s.invm(this.n),
            ...
            f = c.mul(o).umod(this.n);
          return this.curve._maxwellTrick
            ? !(a = this.g.jmulAdd(l, r.getPublic(), f)).isInfinity() &&
                a.eqXToP(o)
            : !(a = this.g.mulAdd(l, r.getPublic(), f)).isInfinity() &&
      ...
      var L = s(function (e, t) {
        ...
        F = r(20037),
        D = r(71182);
      let U = new (r(6865).Logger)("signing-key/5.8.0"),
        H = null;
      function j() {
        return H || (H = new L("secp256k1")), H;
      }
      class z {
        constructor(e) {
          (0, D.defineReadOnly)(this, "curve", "secp256k1"),
            (0, D.defineReadOnly)(this, "privateKey", (0, F.hexlify)(e)),
            32 !== (0, F.hexDataLength)(this.privateKey) &&
              U.throwArgumentError(
                "invalid private key",
                "privateKey",
                "[[ REDACTED ]]"
              );
          let t = j().keyFromPrivate((0, F.arrayify)(this.privateKey));
          (0, D.defineReadOnly)(
            this,
            "publicKey",
            ...
            (0, D.defineReadOnly)(this, "_isSigningKey", !0);
        }
        _addPoint(e) {
          let t = j().keyFromPublic((0, F.arrayify)(this.publicKey)),
            r = j().keyFromPublic((0, F.arrayify)(e));
        ...
        computeSharedSecret(e) {
          let t = j().keyFromPrivate((0, F.arrayify)(this.privateKey)),
            r = j().keyFromPublic((0, F.arrayify)(G(e)));
          return (0, F.hexZeroPad)(
      ...
      function K(e, t) {
        let r = (0, F.splitSignature)(t),
          n = { r: (0, F.arrayify)(r.r), s: (0, F.arrayify)(r.s) };
        return (
          "0x" +
          j()
            .recoverPubKey((0, F.arrayify)(e), n, r.recoveryParam)
            .encode("hex", !1)
        );
      }
      function G(e, t) {
        ...
        if (32 === r.length) {
          let e = new z(r);
          return t
            ? "0x" + j().keyFromPrivate(r).getPublic(!0, "hex")
            : e.publicKey;
        }
        return 33 === r.length
          ? t
            ? (0, F.hexlify)(r)
            : "0x" + j().keyFromPublic(r).getPublic(!1, "hex")
          : 65 === r.length
          ? t
            ? "0x" + j().keyFromPublic(r).getPublic(!0, "hex")
            : (0, F.hexlify)(r)
          : U.throwArgumentError(
    ...
    86916: (e, t, r) => {
      ...
      r.r(t),
        r.d(t, {
          AbiCoder: () => n.y,
          ConstructorFragment: () => i.Pw,
          ErrorFragment: () => i.bp,
          EventFragment: () => i.Zp,
          FormatTypes: () => i.$o,
          Fragment: () => i.FK,
          FunctionFragment: () => i.hc,
          HDNode: () => p.HDNode,
          Indexed: () => o.wu,
          Interface: () => o.KA,
          LogDescription: () => o.FW,
          ...
          SupportedAlgorithm: () => T.q,
          TransactionDescription: () => o.dJ,
          TransactionTypes: () => N.TransactionTypes,
          UnicodeNormalizationForm: () => P.dz,
          Utf8ErrorFuncs: () => P.d5,
          Utf8ErrorReason: () => P._E,
          _TypedDataEncoder: () => x.z,
          _fetchData: () => I._fetchData,
          _toEscapedUtf8String: () => P.Wj,
          accessListify: () => N.accessListify,
          arrayify: () => f.arrayify,
          base58: () => l.Base58,
          base64: () => c,
          checkProperties: () => E.checkProperties,
          checkResultErrors: () => a.$v,
          commify: () => C.commify,
          computeAddress: () => N.computeAddress,
          computeHmac: () => y.L5,
          computePublicKey: () => S.computePublicKey,
          concat: () => f.concat,
          deepCopy: () => E.deepCopy,
          defaultAbiCoder: () => n.D,
          defaultPath: () => p.defaultPath,
          defineReadOnly: () => E.defineReadOnly,
          dnsEncode: () => u.Wh,
          entropyToMnemonic: () => p.entropyToMnemonic,
          fetchJson: () => I.fetchJson,
          formatBytes32String: () => R.R,
          formatEther: () => C.formatEther,
          formatUnits: () => C.formatUnits,
          getAccountPath: () => p.getAccountPath,
          getAddress: () => s.getAddress,
          getContractAddress: () => s.getContractAddress,
          getCreate2Address: () => s.getCreate2Address,
          getIcapAddress: () => s.getIcapAddress,
          getJsonWalletAddress: () => g.cZ,
          getStatic: () => E.getStatic,
          hashMessage: () => d.A,
          hexConcat: () => f.hexConcat,
          hexDataLength: () => f.hexDataLength,
          hexDataSlice: () => f.hexDataSlice,
          hexStripZeros: () => f.hexStripZeros,
          hexValue: () => f.hexValue,
          hexZeroPad: () => f.hexZeroPad,
          hexlify: () => f.hexlify,
          id: () => h.id,
          isAddress: () => s.isAddress,
          isBytes: () => f.isBytes,
          isBytesLike: () => f.isBytesLike,
          isHexString: () => f.isHexString,
          isValidMnemonic: () => p.isValidMnemonic,
          isValidName: () => u.uV,
          joinSignature: () => f.joinSignature,
          keccak256: () => m.keccak256,
          mnemonicToEntropy: () => p.mnemonicToEntropy,
          mnemonicToSeed: () => p.mnemonicToSeed,
          namehash: () => u.kM,
          nameprep: () => _.j9,
          parseBytes32String: () => R.V,
          parseEther: () => C.parseEther,
          parseTransaction: () => N.parse,
          parseUnits: () => C.parseUnits,
          poll: () => I.poll,
          randomBytes: () => w.p,
          recoverAddress: () => N.recoverAddress,
          recoverPublicKey: () => S.recoverPublicKey,
          resolveProperties: () => E.resolveProperties,
          ripemd160: () => y.HE,
          serializeTransaction: () => N.serialize,
          sha256: () => y.sc,
          sha512: () => y.Zf,
          shallowCopy: () => E.shallowCopy,
          shuffled: () => A.A,
          solidityKeccak256: () => v.keccak256,
          solidityPack: () => v.pack,
          soliditySha256: () => v.sha256,
          splitSignature: () => f.splitSignature,
          stripZeros: () => f.stripZeros,
          toUtf8Bytes: () => P.YW,
          toUtf8CodePoints: () => P.dg,
          toUtf8String: () => P._v,
          verifyMessage: () => M.verifyMessage,
          verifyTypedData: () => M.verifyTypedData,
          zeroPad: () => f.zeroPad,
        });
      var n = r(44203),
        i = r(42726),
    ...
    87709: (e, t, r) => {
      ...
      let p = new u.Logger(d.r),
        g = ["call", "estimateGas"];
      function m(e, t) {
        if (null == e) return null;
        if ("string" == typeof e.message && e.message.match("reverted")) {
          let r = (0, a.isHexString)(e.data) ? e.data : null;
      ...
      class E extends n.Signer {
        constructor(e, t, r) {
          ...
          (0, s.defineReadOnly)(this, "provider", t),
            ...
            "string" == typeof r
              ...
              : "number" == typeof r
              ? ((0, s.defineReadOnly)(this, "_index", r),
        ...
        connectUnchecked() {
          return new k(A, this.provider, this._address || this._index);
        }
        getAddress() {
                ...
                (e) => (
                  "string" == typeof e.message &&
                    ...
                    p.throwError(
                      ...
                      u.Logger.errors.ACTION_REJECTED,
        ...
        _signTypedData(e, t, r) {
          return x(this, void 0, void 0, function* () {
            let n = yield o.z.resolveNames(e, t, r, (e) =>
            ...
            try {
              return yield this.provider.send("eth_signTypedData_v4", [
                i.toLowerCase(),
                JSON.stringify(o.z.getPayload(n.domain, t, n.value)),
              ]);
            } catch (e) {
              throw (
                ("string" == typeof e.message &&
      ...
      class _ extends h.DJ {
        ...
        _uncachedDetectNetwork() {
          return x(this, void 0, void 0, function* () {
            ...
            if (null != e) {
              ...
              try {
                return t(i.gH.from(e).toNumber());
              } catch (t) {
                return p.throwError(
                  "could not detect network",
                  u.Logger.errors.NETWORK_ERROR,
        ...
        prepareRequest(e, t) {
          switch (e) {
            ...
            case "getTransactionCount":
              return ["eth_getTransactionCount", [w(t.address), t.blockTag]];
            case "getCode":
              return ["eth_getCode", [w(t.address), t.blockTag]];
            case "getStorageAt":
              return [
                "eth_getStorageAt",
                [w(t.address), (0, a.hexZeroPad)(t.position, 32), t.blockTag],
              ];
        ...
        perform(e, t) {
          return x(this, void 0, void 0, function* () {
            ...
            null == r &&
              p.throwError(
                e + " not implemented",
                u.Logger.errors.NOT_IMPLEMENTED,
                { operation: e }
              );
            try {
                    ...
                    e.send("eth_getFilterChanges", [r])
                      ...
                      .then(function () {
                        return e._pendingFilter != t
                          ? void e.send("eth_uninstallFilter", [r])
                          : (setTimeout(function () {
                              n();
                            }, 0),
                            null);
        ...
        static hexlifyTransaction(e, t) {
          let r = (0, s.shallowCopy)(S);
          if (t) for (let e in t) t[e] && (r[e] = !0);
          (0, s.checkProperties)(e, r);
          let n = {};
          return (
            [
              "chainId",
              ...
              if (null == e[t]) return;
              let r = (0, a.hexValue)(i.gH.from(e[t]));
              "gasLimit" === t && (t = "gas"), (n[t] = r);
            }),
            ["from", "to", "data"].forEach(function (t) {
              null != e[t] && (n[t] = (0, a.hexlify)(e[t]));
            }),
            e.accessList && (n.accessList = (0, l.accessListify)(e.accessList)),
            n
          );
        }
      }
      ...
      (t.inherits = r(864)),
        ...
        (t.toHex32 = function (e, t) {
          for (var r = "", n = 0; n < e.length; n++) {
            var a = e[n];
            "little" === t && (a = i(a)), (r += o(a.toString(16)));
          }
          return r;
        }),
        (t.zero2 = a),
        ...
        (t.join32 = function (e, t, r, i) {
          var a,
            o = r - t;
          n(o % 4 == 0);
          for (var s = Array(o / 4), c = 0, l = t; c < s.length; c++, l += 4)
            (a =
              "big" === i
        ...
        (t.sum64_5_hi = function (e, t, r, n, i, a, o, s, c, l) {
          var f,
            u = t;
          return (
            (e +
        ...
        (t.sum64_5_lo = function (e, t, r, n, i, a, o, s, c, l) {
          return (t + n + a + s + l) >>> 0;
        }),
    ...
    89124: (e, t, r) => {
      "use strict";
      r.d(t, { N: () => f });
      let n = new (r(6865).Logger)("networks/5.8.0");
      function i(e) {
        let t = function (t, r) {
          null == r && (r = {});
          let n = [];
        ...
        if (!t)
          return (
            "number" != typeof e.chainId &&
              n.throwArgumentError("invalid network chainId", "network", e),
            e
          );
        0 !== e.chainId &&
          e.chainId !== t.chainId &&
          n.throwArgumentError("network chainId mismatch", "network", e);
        let r = e._defaultProvider || null;
        if (null == r && t._defaultProvider) {
          var i;
          r =
            (i = t._defaultProvider) && "function" == typeof i.renetwork
    ...
    92220: (e, t, r) => {
      ...
      r.r(t),
        r.d(t, {
          AlchemyProvider: () => w,
          AlchemyWebSocketProvider: () => v,
          AnkrProvider: () => k,
          BaseProvider: () => a.DJ,
          CloudflareProvider: () => _,
          EtherscanProvider: () => F,
          FallbackProvider: () => D.S,
          Formatter: () => s.ZA,
          InfuraProvider: () => K,
          InfuraWebSocketProvider: () => z,
          IpcProvider: () => U,
          JsonRpcBatchProvider: () => G,
          JsonRpcProvider: () => l.F,
          JsonRpcSigner: () => l.c,
          NodesmithProvider: () => W,
          PocketProvider: () => Q,
          ...
          QuickNodeProvider: () => Z,
          Resolver: () => a.xR,
          StaticJsonRpcProvider: () => m.B,
          UrlJsonRpcProvider: () => m.M,
          Web3Provider: () => X.j,
          WebSocketProvider: () => g,
          getDefaultProvider: () => ee,
          getNetwork: () => i.N,
          isCommunityResourcable: () => s.fw,
          isCommunityResource: () => s.ws,
          showThrottleMessage: () => s.Zd,
        });
      var n = r(65511),
        i = r(89124),
        a = r(27570),
      ...
      let d = null;
      try {
        if (((d = WebSocket), null == d)) throw Error("inject please");
      } catch (t) {
        let e = new f.Logger(u.r);
        d = function () {
          e.throwError(
                ...
                if ((delete this._requests[e], void 0 !== r.result))
                  ...
                  r.error
                    ? ((e = Error(r.error.message || "unknown error")),
                      (0, o.defineReadOnly)(e, "code", r.error.code || null),
          ...
          switch (e.type) {
            case "block":
              this._subscribe("block", ["newHeads"], (e) => {
                let t = c.gH.from(e.number).toNumber();
      ...
      var m = r(75597);
      let b = new f.Logger(u.r),
        y = "_gg7wSSi0KMBsdKnGVfHDueq6xMB9EkC";
      class v extends g {
        constructor(e, t) {
          let r = new w(e, t);
          super(
      ...
      class w extends m.M {
        ...
        static getApiKey(e) {
          return null == e
            ...
            : (e &&
                "string" != typeof e &&
                b.throwArgumentError("invalid apiKey", "apiKey", e),
              e);
        }
        static getUrl(e, t) {
          let r = null;
      ...
      let A = new f.Logger(u.r),
        E = "9f7d929b018cdffb338517efa06f58359e86ff1ffd350bc889738523659e7972";
      class k extends m.M {
        isCommunityResource() {
        ...
        static getUrl(e, t) {
          ...
          let r = {
            ...
            url:
              ...
              t,
            throttleCallback: (e, r) => (
              t.apiKey === E && (0, s.Zd)(), Promise.resolve(!0)
            ),
          };
          return (
      ...
      class _ extends m.M {
        ...
        perform(e, t) {
          ...
          return (
            ...
            (i = void 0),
            (a = function* () {
              return "getBlockNumber" === e
                ? (yield o.perform.call(this, "getBlock", {
                    blockTag: "latest",
                  })).number
                : o.perform.call(this, e, t);
            }),
      ...
      function L(e, t, r) {
        if ("call" === e && t.code === f.Logger.errors.SERVER_ERROR) {
          let e = t.error;
          if (
            e &&
            ...
            let r = e.data;
            if (
              (r && (r = "0x" + r.replace(/^.*0x/i, "")), (0, P.isHexString)(r))
            )
              return r;
            M.throwError(
        ...
        let n = t.message;
        throw (
          (t.code === f.Logger.errors.SERVER_ERROR &&
          ...
          n.match(
            ...
            M.throwError(
              "nonce has already been used",
              f.Logger.errors.NONCE_EXPIRED,
              { error: t, method: e, transaction: r }
            ),
          n.match(/another transaction with same nonce/) &&
            M.throwError(
              "replacement fee too low",
              f.Logger.errors.REPLACEMENT_UNDERPRICED,
              { error: t, method: e, transaction: r }
            ),
          n.match(/execution failed due to an exception|execution reverted/) &&
            M.throwError(
              "cannot estimate gas; transaction may fail or may require manual gas limit",
              f.Logger.errors.UNPREDICTABLE_GAS_LIMIT,
              { error: t, method: e, transaction: r }
            ),
          t)
        );
      }
      class F extends a.DJ {
        constructor(e, t) {
          super(e),
            (0, o.defineReadOnly)(this, "baseUrl", this.getBaseUrl()),
            (0, o.defineReadOnly)(this, "apiKey", t || null);
        }
        getBaseUrl() {
          ...
          return C(this, void 0, void 0, function* () {
            ...
            i &&
              ...
              (l = Object.keys(i)
                .map((e) => `${e}=${i[e]}`)
                .join("&")));
            let f = yield (0, N.fetchJson)(c, l, a || O);
            return (
              this.emit("debug", {
                action: "response",
                request: n,
                response: (0, o.deepCopy)(f),
                provider: this,
              }),
              f
            );
            ...
            switch (e) {
              ...
              case "sendTransaction":
                return this.fetch(
                  ...
                  !0
                ).catch((e) => L("sendTransaction", e, t.signedTransaction));
              case "getBlock":
                if (t.blockTag)
                  return this.fetch("proxy", {
              ...
              case "estimateGas": {
                ...
                try {
                  ...
                  return L("estimateGas", e, t.transaction);
                }
              }
              case "getLogs": {
      ...
      let U = null,
        H = new f.Logger(u.r),
        j = "84842078b09946638c03157f83405213";
      class z extends g {
        constructor(e, t) {
          let r = new K(e, t),
            n = r.connection;
      ...
      class K extends m.M {
        ...
        static getApiKey(e) {
          let t = { apiKey: j, projectId: j, projectSecret: null };
          return (
            null == e ||
              ("string" == typeof e
                ? (t.projectId = e)
        ...
        static getUrl(e, t) {
          ...
          let n = {
            ...
            throttleCallback: (e, r) => (
              t.projectId === j && (0, s.Zd)(), Promise.resolve(!0)
            ),
          };
          return (
            null != t.projectSecret &&
      ...
      let q = new f.Logger(u.r);
      class W extends m.M {
        static getApiKey(e) {
          return (
            e &&
              "string" != typeof e &&
              q.throwArgumentError("invalid apiKey", "apiKey", e),
            e || "ETHERS_JS_SHARED"
          );
        }
        static getUrl(e, t) {
      ...
      let J = new f.Logger(u.r),
        V = "62e1ad51b37b8e00394bda3b";
      class Q extends m.M {
        static getApiKey(e) {
          let t = {
            applicationId: null,
        ...
        static getUrl(e, t) {
          ...
          let n = { headers: {}, url: `https://${r}/v1/lb/${t.applicationId}` };
          return (
        ...
        isCommunityResource() {
          return this.applicationId === V;
        }
      }
      let Y = new f.Logger(u.r);
      class Z extends m.M {
        static getApiKey(e) {
          return (
            e &&
              "string" != typeof e &&
              Y.throwArgumentError("invalid apiKey", "apiKey", e),
          ...
          if (t)
            switch (t[1].toLowerCase()) {
              ...
              case "wss":
                return new g(e);
              default:
                $.throwArgumentError("unsupported URL scheme", "network", e);
            }
        }
        let r = (0, i.N)(e);
        return (
    ...
    92442: (e, t, r) => {
      ...
      let h = i.gH.from(-1),
        ...
        m = (0, a.hexZeroPad)(p.toHexString(), 32),
        b = (0, a.hexZeroPad)(x.toHexString(), 32),
        y = {
          name: "string",
          version: "string",
          chainId: "uint256",
      ...
      function E(e) {
          ...
          if (t) {
            ...
            return function (t) {
              ...
              return (
                ...
                (0, a.hexZeroPad)(r.toTwos(256).toHexString(), 32)
              );
            };
          }
        }
        ...
        switch (e) {
          case "address":
            return function (e) {
              return (0, a.hexZeroPad)((0, n.getAddress)(e), 32);
            };
          case "bool":
            return function (e) {
              return e ? m : b;
      ...
      class S {
        constructor(e) {
          ...
          n)) {
            ...
            t.sort(),
              (this._types[a] = k(a, e[a]) + t.map((t) => k(t, e[t])).join(""));
          }
        }
        getEncoder(e) {
        ...
        _getEncoder(e) {
          ...
          if (t) {
            ...
            return (t) => {
              ...
              let i = t.map(r);
              return (
                this._types[e] && (i = i.map(o.keccak256)),
                (0, o.keccak256)((0, a.hexConcat)(i))
              );
            };
          }
          let r = this.types[e];
          if (r) {
            ...
            return (e) => {
              ...
              return n.unshift(t), (0, a.hexConcat)(n);
            };
          }
        ...
        hashStruct(e, t) {
          return (0, o.keccak256)(this.encodeData(e, t));
        }
        encode(e) {
        ...
        static hash(e, t, r) {
          return (0, o.keccak256)(S.encode(e, t, r));
        }
        static resolveNames(e, t, r, n) {
          ...
          return (
            ...
            (l = function* () {
              ...
              let i = {};
              e.verifyingContract &&
                !(0, a.isHexString)(e.verifyingContract, 20) &&
                (i[e.verifyingContract] = "0x");
              let o = S.from(t);
              for (let e in (o.visit(
                r,
                (e, t) => (
                  "address" !== e || (0, a.isHexString)(t, 20) || (i[t] = "0x"),
                  t
                )
              ),
              i))
        ...
        static getPayload(e, t, r) {
          ...
          v.forEach((t) => {
            let r = e[t];
            null != r && ((n[t] = A[t](r)), o.push({ name: t, type: y[t] }));
          });
          let c = S.from(t),
            l = (0, s.shallowCopy)(t);
          return (
            ...
            c.encode(r),
            {
              ...
              message: c.visit(r, (e, t) => {
                if (e.match(/^bytes(\d*)/))
                  return (0, a.hexlify)((0, a.arrayify)(t));
                if (e.match(/^u?int/)) return i.gH.from(t).toString();
                switch (e) {
                  case "address":
    ...
    92921: (e, t, r) => {
      "use strict";
      r.d(t, { L5: () => d, HE: () => l, sc: () => f, Zf: () => u });
      var n = r(31320),
        i = r.n(n),
        a = r(20037),
        o = r(23786),
        s = r(6865);
      let c = new s.Logger("sha2/5.8.0");
      function l(e) {
        return (
          "0x" +
          i()
            .ripemd160()
            .update((0, a.arrayify)(e))
            .digest("hex")
        );
      }
      function f(e) {
      ...
      function d(e, t, r) {
        return (
          ...
          "0x" +
            i()
              .hmac(i()[e], (0, a.arrayify)(t))
              .update((0, a.arrayify)(r))
              .digest("hex")
        );
      }
    },
    ...
    95257: (e, t, r) => {
      ...
      class h {
        ...
        mod(e) {
          let t = g(e);
          return t.isNeg() && m("division-by-zero", "mod"), p(g(this).umod(t));
        }
        pow(e) {
          let t = g(e);
          return t.isNeg() && m("negative-power", "pow"), p(g(this).pow(t));
        }
        and(e) {
          let t = g(e);
          return (
        ...
        mask(e) {
          return (
            (this.isNegative() || e < 0) && m("negative-width", "mask"),
            p(g(this).maskn(e))
          );
        }
        shl(e) {
          return (
            (this.isNegative() || e < 0) && m("negative-width", "shl"),
            p(g(this).shln(e))
          );
        }
        shr(e) {
          return (
            (this.isNegative() || e < 0) && m("negative-width", "shr"),
            p(g(this).shrn(e))
          );
        }
        eq(e) {
        ...
        static from(e) {
          ...
          if ((0, a.isBytes)(e)) return h.from((0, a.hexlify)(e));
          if (e)
            if (e.toHexString) {
              let t = e.toHexString();
              if ("string" == typeof t) return h.from(t);
            } else {
              let t = e._hex;
              if (
                ...
                "string" == typeof t &&
                  ((0, a.isHexString)(t) ||
                    ("-" === t[0] && (0, a.isHexString)(t.substring(1)))))
              )
                return h.from(t);
            }
      ...
      function x(e) {
        if ("string" != typeof e) return x(e.toString(16));
        if ("-" === e[0])
      ...
      function m(e, t, r) {
        ...
        return (
          null != r && (n.value = r),
          l.throwError(e, o.Logger.errors.NUMERIC_FAULT, n)
        );
      }
      function b(e) {
      ...
      class v extends a.Signer {
        constructor(e, t) {
          if (
            ...
            (function (e) {
              return (
                null != e &&
                (0, o.isHexString)(e.privateKey, 32) &&
                null != e.address
              );
            })(e))
          ) {
            ...
            if (
              ...
              let r = this.mnemonic,
                n = l.HDNode.fromMnemonic(r.phrase, null, r.locale).derivePath(
                  r.path
                );
              (0, g.computeAddress)(n.privateKey) !== this.address &&
                y.throwArgumentError(
          ...
          t &&
            !i.Kq.isProvider(t) &&
            y.throwArgumentError("invalid provider", "provider", t),
        ...
        signMessage(e) {
          return b(this, void 0, void 0, function* () {
            return (0,
            o.joinSignature)(this._signingKey().signDigest((0, s.A)(e)));
          });
        }
        _signTypedData(e, t, r) {
          return b(this, void 0, void 0, function* () {
            let n = yield c.z.resolveNames(
              e,
              t,
              r,
              (e) => (
            ...
            return (0,
            o.joinSignature)(this._signingKey().signDigest(c.z.hash(n.domain, t, n.value)));
          });
        }
        encrypt(e, t, r) {
          if (
        ...
        static createRandom(e) {
          ...
          e || (e = {}),
            e.extraEntropy &&
              (t = (0, o.arrayify)(
                (0, o.hexDataSlice)(
                  (0, f.keccak256)((0, o.concat)([t, e.extraEntropy])),
                  0,
                  16
                )
              ));
        ...
        static fromEncryptedJson(e, t, r) {
          return (0, p.decryptJsonWallet)(e, t, r).then((e) => new v(e));
        }
        static fromEncryptedJsonSync(e, t) {
          return new v((0, p.decryptJsonWalletSync)(e, t));
        }
        static fromMnemonic(e, t, r) {
          return (
            t || (t = l.defaultPath),
            new v(l.HDNode.fromMnemonic(e, null, r).derivePath(t))
          );
        }
      }
      function w(e, t) {
        return (0, g.recoverAddress)((0, s.A)(e), t);
      }
      function A(e, t, r, n) {
        return (0, g.recoverAddress)(c.z.hash(e, t, r), n);
      }
    },
    99373: (e, t, r) => {
      "use strict";
      ...
      function a(e) {
        if (
          ...
          throw ((i = null), Error("BIP39 Wordlist for en (English) FAILED"));
      }
      class o extends n.b {
        constructor() {
          super("en");
    ...
    99409: (e, t, r) => {
      ...
      class d {
        ...
        getDefaultFormats() {
          ...
          return (
            (e.transaction = {
              ...
              blockHash: d.allowNull(a, null),
              blockNumber: d.allowNull(c, null),
              transactionIndex: d.allowNull(c, null),
              confirmations: d.allowNull(c, null),
              from: t,
              gasPrice: d.allowNull(r),
              maxPriorityFeePerGas: d.allowNull(r),
              maxFeePerGas: d.allowNull(r),
              gasLimit: r,
              to: d.allowNull(t, null),
              value: r,
              nonce: c,
              data: i,
            ...
            (e.receipt = {
              ...
              contractAddress: d.allowNull(t, null),
              transactionIndex: c,
              root: d.allowNull(o),
              gasUsed: r,
              logsBloom: d.allowNull(i),
              blockHash: a,
              transactionHash: a,
            ...
            (e.block = {
              ...
              miner: d.allowNull(t),
              extraData: i,
              transactions: d.allowNull(d.arrayOf(a)),
              baseFeePerGas: d.allowNull(r),
            }),
            (e.blockWithTransactions = (0, s.shallowCopy)(e.block)),
            (e.blockWithTransactions.transactions = d.allowNull(
              d.arrayOf(this.transactionResponse.bind(this))
            )),
            (e.filter = {
              fromBlock: d.allowNull(n, void 0),
              toBlock: d.allowNull(n, void 0),
              blockHash: d.allowNull(a, void 0),
              address: d.allowNull(t, void 0),
              topics: d.allowNull(this.topics.bind(this), void 0),
            }),
            (e.filterLog = {
              blockNumber: d.allowNull(c),
              blockHash: d.allowNull(a),
              transactionIndex: c,
              removed: d.allowNull(this.boolean.bind(this)),
              address: t,
              data: d.allowFalsish(i, "0x"),
              topics: d.arrayOf(a),
              transactionHash: a,
              logIndex: c,
            }),
        ...
        number(e) {
          return "0x" === e ? 0 : i.gH.from(e).toNumber();
        }
        type(e) {
          return "0x" === e || null == e ? 0 : i.gH.from(e).toNumber();
        }
        bigNumber(e) {
          return i.gH.from(e);
        }
        ...
        hex(e, t) {
          return "string" == typeof e &&
            ...
            (0, a.isHexString)(e))
            ? e.toLowerCase()
            : u.throwArgumentError("invalid hash", "value", e);
        }
        data(e, t) {
          let r = this.hex(e, t);
        ...
        callAddress(e) {
          ...
          let t = (0, n.getAddress)((0, a.hexDataSlice)(e, 12));
          return t === o.L ? null : t;
        }
        contractAddress(e) {
        ...
        blockTag(e) {
          ...
          if ("number" == typeof e || (0, a.isHexString)(e))
            return (0, a.hexValue)(e);
          throw Error("invalid blockTag");
        }
        hash(e, t) {
          let r = this.hex(e, t);
          return 32 !== (0, a.hexDataLength)(r)
            ? u.throwArgumentError("invalid hash", "value", e)
            : r;
        }
        difficulty(e) {
        ...
        _block(e, t) {
          ...
          let r = null != e._difficulty ? e._difficulty : e.difficulty,
            n = d.check(t, e);
          return (n._difficulty = null == r ? null : i.gH.from(r)), n;
        }
        block(e) {
        ...
        transactionRequest(e) {
          return d.check(this.formats.transactionRequest, e);
        }
        transactionResponse(e) {
          null != e.gas && null == e.gasLimit && (e.gasLimit = e.gas),
            e.to &&
              i.gH.from(e.to).isZero() &&
            ...
            (1 === e.type || 2 === e.type) &&
              null == e.accessList &&
              (e.accessList = []);
          let t = d.check(this.formats.transaction, e);
          if (null != e.chainId) {
            let r = e.chainId;
            (0, a.isHexString)(r) && (r = i.gH.from(r).toNumber()),
              (t.chainId = r);
          } else {
            let r = e.networkId;
        ...
        receiptLog(e) {
          return d.check(this.formats.receiptLog, e);
        }
        receipt(e) {
          let t = d.check(this.formats.receipt, e);
          if (null != t.root)
            if (t.root.length <= 4) {
              let e = i.gH.from(t.root).toNumber();
              0 === e || 1 === e
                ? (null != t.status &&
                    t.status !== e &&
                    u.throwArgumentError(
        ...
        filter(e) {
          return d.check(this.formats.filter, e);
        }
        filterLog(e) {
          return d.check(this.formats.filterLog, e);
        }
        static check(e, t) {
          let r = {};
          for (let n in e)
