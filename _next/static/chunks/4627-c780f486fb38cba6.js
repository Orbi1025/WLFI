try {
  !(function () {
    ...
    i &&
      ...
      (e._sentryDebugIds[i] = "8e50ffa8-9e7a-4843-8f9f-9fa0b62da824"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-8e50ffa8-9e7a-4843-8f9f-9fa0b62da824"));
  })();
} catch (e) {}
("use strict");
    ...
    64627: (e, i, r) => {
      ...
      r.r(u),
        r.d(u, {
          ...
          $ZodCatch: () => c.t$,
          $ZodCheck: () => m.QP,
          $ZodCheckBigIntFormat: () => m.uE,
          $ZodCheckEndsWith: () => m.E6,
          $ZodCheckGreaterThan: () => m.J_,
          $ZodCheckIncludes: () => m.Tt,
          $ZodCheckLengthEquals: () => m.RM,
          $ZodCheckLessThan: () => m.sm,
          $ZodCheckLowerCase: () => m.NI,
          $ZodCheckMaxLength: () => m.Yk,
          $ZodCheckMaxSize: () => m.j2,
          $ZodCheckMimeType: () => m.sj,
          $ZodCheckMinLength: () => m.Kk,
          $ZodCheckMinSize: () => m.PH,
          $ZodCheckMultipleOf: () => m.Jk,
          $ZodCheckNumberFormat: () => m.KH,
          $ZodCheckOverwrite: () => m.v$,
          $ZodCheckProperty: () => m.XF,
          $ZodCheckRegex: () => m.DG,
          $ZodCheckSizeEquals: () => m.e2,
          $ZodCheckStartsWith: () => m.J,
          $ZodCheckStringFormat: () => m.ql,
          $ZodCheckUpperCase: () => m.kH,
          $ZodCustom: () => c.b0,
          $ZodCustomStringFormat: () => c.ZQ,
          $ZodDate: () => c.o5,
          $ZodDefault: () => c.rv,
          $ZodDiscriminatedUnion: () => c.P0,
          $ZodE164: () => c.Oy,
          $ZodEmail: () => c.qG,
          $ZodEmoji: () => c.cG,
          $ZodEnum: () => c.VO,
          ...
          $ZodSet: () => c.Oi,
          $ZodString: () => c.$v,
          $ZodStringFormat: () => c.EY,
          $ZodSuccess: () => c.Dw,
          $ZodSymbol: () => c.U5,
          $ZodTemplateLiteral: () => c.d,
          $ZodTransform: () => c.Wc,
          $ZodTuple: () => c.G3,
          $ZodType: () => c.W4,
          $ZodULID: () => c.g5,
          ...
          _cidrv4: () => el.Uy,
          _cidrv6: () => el.gP,
          _coercedBigint: () => el.St,
          _coercedBoolean: () => el.dN,
          _coercedDate: () => el.B4,
          _coercedNumber: () => el.qG,
          _coercedString: () => el.K_,
          _cuid: () => el.fs,
          _cuid2: () => el.Bj,
          _custom: () => el.FO,
          _date: () => el.YY,
          _default: () => el.Rv,
          _discriminatedUnion: () => el.FG,
          _e164: () => el.KB,
          _email: () => el.Mu,
          _emoji: () => el.aC,
          _endsWith: () => el.ER,
          ...
          function: () => ed,
          globalConfig: () => l.cr,
          globalRegistry: () => eu.fd,
          isValidBase64: () => c.UY,
          isValidBase64URL: () => c.tV,
          isValidJWT: () => c.c2,
          locales: () => n,
          parse: () => s.qg,
          parseAsync: () => s.EJ,
      ...
      r.r(o),
        r.d(o, {
          ...
          ZodCatch: () => ev.hw,
          ZodCustom: () => ev.JE,
          ZodCustomStringFormat: () => ev.LE,
          ZodDate: () => ev.aP,
          ZodDefault: () => ev.Xi,
          ZodDiscriminatedUnion: () => ev.jv,
          ZodE164: () => ev.m7,
          ZodEmail: () => ev.cM,
          ZodEmoji: () => ev.yC,
          ZodEnum: () => ev.Vb,
          ...
          ZodIPv4: () => ev.Bo,
          ZodIPv6: () => ev.Gp,
          ZodISODate: () => ey.ZodISODate,
          ZodISODateTime: () => ey.ZodISODateTime,
          ZodISODuration: () => ey.ZodISODuration,
          ZodISOTime: () => ey.ZodISOTime,
          ZodIntersection: () => ev.Jv,
          ZodIssueCode: () => e$,
          ZodJWT: () => ev.fi,
          ZodKSUID: () => ev.Kf,
          ZodLazy: () => ev.Ih,
          ...
          ZodNanoID: () => ev.n$,
          ZodNever: () => ev.iS,
          ZodNonOptional: () => ev.vZ,
          ZodNull: () => ev.PQ,
          ZodNullable: () => ev.l1,
          ZodNumber: () => ev.rS,
          ZodNumberFormat: () => ev.Kq,
          ZodObject: () => ev.bv,
          ZodOptional: () => ev.Ii,
          ZodPipe: () => ev.ut,
          ZodPrefault: () => ev.xg,
          ...
          ZodSet: () => ev.Kz,
          ZodString: () => ev.ND,
          ZodStringFormat: () => ev.EB,
          ZodSuccess: () => ev.Bu,
          ZodSymbol: () => ev.K5,
          ZodTemplateLiteral: () => ev.dd,
          ZodTransform: () => ev.CL,
          ZodTuple: () => ev.y0,
          ZodType: () => ev.aR,
          ZodULID: () => ev.qX,
              ...
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `مدخلات غير مقبولة: يفترض إدخال ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `اختيار غير مقبول: يتوقع انتقاء أحد هذه الخيارات: ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return ` أكبر من اللازم: يفترض أن تكون ${
                      r.origin ?? "القيمة"
                    } ${i} ${r.maximum.toString()} ${t.unit ?? "عنصر"}`;
                  return `أكبر من اللازم: يفترض أن تكون ${
                    r.origin ?? "القيمة"
                  } ${i} ${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `أصغر من اللازم: يفترض لـ ${
                      r.origin
                    } أن يكون ${i} ${r.minimum.toString()} ${t.unit}`;
                  return `أصغر من اللازم: يفترض لـ ${
                    r.origin
                  } أن يكون ${i} ${r.minimum.toString()}`;
                }
                case "invalid_format":
                  ...
                  return `${i[r.format] ?? r.format} غير مقبول`;
                case "not_multiple_of":
                  return `رقم غير مقبول: يجب أن يكون من مضاعفات ${r.divisor}`;
                case "unrecognized_keys":
                  return `معرف${r.keys.length > 1 ? "ات" : ""} غريب${
                    r.keys.length > 1 ? "ة" : ""
                  }: ${f.joinValues(r.keys, "، ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Yanlış dəyər: g\xf6zlənilən ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Yanlış se\xe7im: aşağıdakılardan biri olmalıdır: ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `\xc7ox b\xf6y\xfck: g\xf6zlənilən ${
                      r.origin ?? "dəyər"
                    } ${i}${r.maximum.toString()} ${t.unit ?? "element"}`;
                  return `\xc7ox b\xf6y\xfck: g\xf6zlənilən ${
                    r.origin ?? "dəyər"
                  } ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  ...
                  if (t)
                    return `\xc7ox ki\xe7ik: g\xf6zlənilən ${
                      r.origin
                    } ${i}${r.minimum.toString()} ${t.unit}`;
                  return `\xc7ox ki\xe7ik: g\xf6zlənilən ${
                    r.origin
                  } ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Yanlış ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
      ...
      function b(e, i, r, t) {
        let n = Math.abs(e),
          a = n % 10,
          u = n % 100;
        return u >= 11 && u <= 19 ? t : 1 === a ? i : a >= 2 && a <= 4 ? r : t;
      }
      function y() {
        return {
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Няправільны ўвод: чакалася ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Няправільны варыянт: чакаўся адзін з ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t) {
                    ...
                    return `Занадта вялікі: чакалася, што ${
                      r.origin ?? "значэнне"
                    } павінна ${t.verb} ${i}${r.maximum.toString()} ${e}`;
                  }
                  return `Занадта вялікі: чакалася, што ${
                    r.origin ?? "значэнне"
                  } павінна быць ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t) {
                    ...
                    return `Занадта малы: чакалася, што ${r.origin} павінна ${
                      t.verb
                    } ${i}${r.minimum.toString()} ${e}`;
                  }
                  return `Занадта малы: чакалася, што ${
                    r.origin
                  } павінна быць ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Няправільны ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `Няправільны лік: павінен быць кратным ${r.divisor}`;
                case "unrecognized_keys":
                  return `Нераспазнаны ${
                    r.keys.length > 1 ? "ключы" : "ключ"
                  }: ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Valor inv\xe0lid: s'esperava ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Opci\xf3 inv\xe0lida: s'esperava una de ${f.joinValues(
                    r.values,
                    " o "
                  )}`;
                case "too_big": {
                  let i = r.inclusive ? "com a m\xe0xim" : "menys de",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Massa gran: s'esperava que ${
                      r.origin ?? "el valor"
                    } contingu\xe9s ${i} ${r.maximum.toString()} ${
                      t.unit ?? "elements"
                    }`;
                  return `Massa gran: s'esperava que ${
                    r.origin ?? "el valor"
                  } fos ${i} ${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? "com a m\xednim" : "m\xe9s de",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Massa petit: s'esperava que ${
                      r.origin
                    } contingu\xe9s ${i} ${r.minimum.toString()} ${t.unit}`;
                  return `Massa petit: s'esperava que ${
                    r.origin
                  } fos ${i} ${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Format inv\xe0lid per a ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Neplatn\xfd vstup: oček\xe1v\xe1no ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Neplatn\xe1 možnost: oček\xe1v\xe1na jedna z hodnot ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Hodnota je př\xedliš velk\xe1: ${
                      r.origin ?? "hodnota"
                    } mus\xed m\xedt ${i}${r.maximum.toString()} ${
                      t.unit ?? "prvků"
                    }`;
                  return `Hodnota je př\xedliš velk\xe1: ${
                    r.origin ?? "hodnota"
                  } mus\xed b\xfdt ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Hodnota je př\xedliš mal\xe1: ${
                      r.origin ?? "hodnota"
                    } mus\xed m\xedt ${i}${r.minimum.toString()} ${
                      t.unit ?? "prvků"
                    }`;
                  return `Hodnota je př\xedliš mal\xe1: ${
                    r.origin ?? "hodnota"
                  } mus\xed b\xfdt ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Neplatn\xfd form\xe1t ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `Neplatn\xe9 č\xedslo: mus\xed b\xfdt n\xe1sobkem ${r.divisor}`;
                case "unrecognized_keys":
                  return `Nezn\xe1m\xe9 kl\xedče: ${f.joinValues(
                    r.keys,
                    ", "
                  )}`;
                case "invalid_key":
              ...
              switch (t.code) {
                ...
                case "invalid_value":
                  if (1 === t.values.length)
                    return `Ugyldig v\xe6rdi: forventede ${f.stringifyPrimitive(
                      t.values[0]
                    )}`;
                  return `Ugyldigt valg: forventede en af f\xf8lgende ${f.joinValues(
                    t.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (n)
                    return `For stor: forventede ${a ?? "value"} ${
                      n.verb
                    } ${r} ${t.maximum.toString()} ${n.unit ?? "elementer"}`;
                  return `For stor: forventede ${
                    a ?? "value"
                  } havde ${r} ${t.maximum.toString()}`;
                }
                case "too_small": {
                  let r = t.inclusive ? ">=" : ">",
                    n = e[t.origin] ?? null,
                  ...
                  if (n)
                    return `For lille: forventede ${a} ${
                      n.verb
                    } ${r} ${t.minimum.toString()} ${n.unit}`;
                  return `For lille: forventede ${a} havde ${r} ${t.minimum.toString()}`;
                }
                case "invalid_format":
                  ...
                  return `Ugyldig ${r[t.format] ?? t.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Ung\xfcltige Eingabe: erwartet ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Ung\xfcltige Option: erwartet eine von ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Zu gro\xdf: erwartet, dass ${
                      r.origin ?? "Wert"
                    } ${i}${r.maximum.toString()} ${t.unit ?? "Elemente"} hat`;
                  return `Zu gro\xdf: erwartet, dass ${
                    r.origin ?? "Wert"
                  } ${i}${r.maximum.toString()} ist`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Zu klein: erwartet, dass ${
                      r.origin
                    } ${i}${r.minimum.toString()} ${t.unit} hat`;
                  return `Zu klein: erwartet, dass ${
                    r.origin
                  } ${i}${r.minimum.toString()} ist`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Ung\xfcltig: ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Invalid input: expected ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Invalid option: expected one of ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Too big: expected ${
                      r.origin ?? "value"
                    } to have ${i}${r.maximum.toString()} ${
                      t.unit ?? "elements"
                    }`;
                  return `Too big: expected ${
                    r.origin ?? "value"
                  } to be ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Too small: expected ${
                      r.origin
                    } to have ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Too small: expected ${
                    r.origin
                  } to be ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Invalid ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Nevalida enigo: atendiĝis ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Nevalida opcio: atendiĝis unu el ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                ...
                case "too_small": {
                  ...
                  if (t)
                    return `Tro malgranda: atendiĝis ke ${
                      r.origin
                    } havu ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Tro malgranda: atendiĝis ke ${
                    r.origin
                  } estu ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Nevalida ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Entrada inv\xe1lida: se esperaba ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Opci\xf3n inv\xe1lida: se esperaba una de ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Demasiado grande: se esperaba que ${
                      r.origin ?? "valor"
                    } tuviera ${i}${r.maximum.toString()} ${
                      t.unit ?? "elementos"
                    }`;
                  return `Demasiado grande: se esperaba que ${
                    r.origin ?? "valor"
                  } fuera ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Demasiado peque\xf1o: se esperaba que ${
                      r.origin
                    } tuviera ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Demasiado peque\xf1o: se esperaba que ${
                    r.origin
                  } fuera ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Inv\xe1lido ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `ورودی نامعتبر: می‌بایست ${f.stringifyPrimitive(
                      r.values[0]
                    )} می‌بود`;
                  return `گزینه نامعتبر: می‌بایست یکی از ${f.joinValues(
                    r.values,
                    "|"
                  )} می‌بود`;
                case "too_big": {
                  ...
                  if (t)
                    return `خیلی بزرگ: ${
                      r.origin ?? "مقدار"
                    } باید ${i}${r.maximum.toString()} ${
                      t.unit ?? "عنصر"
                    } باشد`;
                  return `خیلی بزرگ: ${
                    r.origin ?? "مقدار"
                  } باید ${i}${r.maximum.toString()} باشد`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `خیلی کوچک: ${
                      r.origin
                    } باید ${i}${r.minimum.toString()} ${t.unit} باشد`;
                  return `خیلی کوچک: ${
                    r.origin
                  } باید ${i}${r.minimum.toString()} باشد`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `${i[r.format] ?? r.format} نامعتبر`;
                case "not_multiple_of":
                  return `عدد نامعتبر: باید مضرب ${r.divisor} باشد`;
                case "unrecognized_keys":
                  return `کلید${
                    r.keys.length > 1 ? "های" : ""
                  } ناشناس: ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Virheellinen sy\xf6te: t\xe4ytyy olla ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Virheellinen valinta: t\xe4ytyy olla yksi seuraavista: ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Liian suuri: ${
                      t.subject
                    } t\xe4ytyy olla ${i}${r.maximum.toString()} ${
                      t.unit
                    }`.trim();
                  return `Liian suuri: arvon t\xe4ytyy olla ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Liian pieni: ${
                      t.subject
                    } t\xe4ytyy olla ${i}${r.minimum.toString()} ${
                      t.unit
                    }`.trim();
                  return `Liian pieni: arvon t\xe4ytyy olla ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Virheellinen ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Entr\xe9e invalide : ${f.stringifyPrimitive(
                      r.values[0]
                    )} attendu`;
                  return `Option invalide : une valeur parmi ${f.joinValues(
                    r.values,
                    "|"
                  )} attendue`;
                case "too_big": {
                  let i = r.inclusive ? "<=" : "<",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Trop grand : ${r.origin ?? "valeur"} doit ${
                      t.verb
                    } ${i}${r.maximum.toString()} ${
                  ...
                  return `Trop grand : ${
                    r.origin ?? "valeur"
                  } doit \xeatre ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Trop petit : ${r.origin} doit ${
                      t.verb
                    } ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Trop petit : ${
                    r.origin
                  } doit \xeatre ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `${i[r.format] ?? r.format} invalide`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Entr\xe9e invalide : attendu ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Option invalide : attendu l'une des valeurs suivantes ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Trop grand : attendu que ${
                      r.origin ?? "la valeur"
                    } ait ${i}${r.maximum.toString()} ${t.unit}`;
                  return `Trop grand : attendu que ${
                    r.origin ?? "la valeur"
                  } soit ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? "≥" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Trop petit : attendu que ${
                      r.origin
                    } ait ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Trop petit : attendu que ${
                    r.origin
                  } soit ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                    return `Cha\xeene invalide : doit commencer par "${r.prefix}"`;
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `קלט לא תקין: צריך ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `קלט לא תקין: צריך אחת מהאפשרויות  ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `גדול מדי: ${
                      r.origin ?? "value"
                    } צריך להיות ${i}${r.maximum.toString()} ${
                      t.unit ?? "elements"
                    }`;
                  return `גדול מדי: ${
                    r.origin ?? "value"
                ...
                case "too_small": {
                  ...
                  if (t)
                    return `קטן מדי: ${
                      r.origin
                    } צריך להיות ${i}${r.minimum.toString()} ${t.unit}`;
                  return `קטן מדי: ${
                    r.origin
                  } צריך להיות ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  if ("includes" === r.format)
                    return `מחרוזת לא תקינה: חייבת לכלול "${r.includes}"`;
                  if ("regex" === r.format)
                    return `מחרוזת לא תקינה: חייבת להתאים לתבנית ${r.pattern}`;
                  return `${i[r.format] ?? r.format} לא תקין`;
                case "not_multiple_of":
                  return `מספר לא תקין: חייב להיות מכפלה של ${r.divisor}`;
                case "unrecognized_keys":
                  return `מפתח${r.keys.length > 1 ? "ות" : ""} לא מזוה${
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `\xc9rv\xe9nytelen bemenet: a v\xe1rt \xe9rt\xe9k ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `\xc9rv\xe9nytelen opci\xf3: valamelyik \xe9rt\xe9k v\xe1rt ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `T\xfal nagy: ${
                      r.origin ?? "\xe9rt\xe9k"
                    } m\xe9rete t\xfal nagy ${i}${r.maximum.toString()} ${
                      t.unit ?? "elem"
                    }`;
                  return `T\xfal nagy: a bemeneti \xe9rt\xe9k ${
                    r.origin ?? "\xe9rt\xe9k"
                  } t\xfal nagy: ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `T\xfal kicsi: a bemeneti \xe9rt\xe9k ${
                      r.origin
                    } m\xe9rete t\xfal kicsi ${i}${r.minimum.toString()} ${
                      t.unit
                    }`;
                  return `T\xfal kicsi: a bemeneti \xe9rt\xe9k ${
                    r.origin
                  } t\xfal kicsi ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `\xc9rv\xe9nytelen ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Input tidak valid: diharapkan ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Pilihan tidak valid: diharapkan salah satu dari ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Terlalu besar: diharapkan ${
                      r.origin ?? "value"
                    } memiliki ${i}${r.maximum.toString()} ${
                      t.unit ?? "elemen"
                    }`;
                  return `Terlalu besar: diharapkan ${
                    r.origin ?? "value"
                  } menjadi ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Terlalu kecil: diharapkan ${
                      r.origin
                    } memiliki ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Terlalu kecil: diharapkan ${
                    r.origin
                  } menjadi ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `${i[r.format] ?? r.format} tidak valid`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Rangt gildi: gert r\xe1\xf0 fyrir ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `\xd3gilt val: m\xe1 vera eitt af eftirfarandi ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Of st\xf3rt: gert er r\xe1\xf0 fyrir a\xf0 ${
                      r.origin ?? "gildi"
                    } hafi ${i}${r.maximum.toString()} ${t.unit ?? "hluti"}`;
                  return `Of st\xf3rt: gert er r\xe1\xf0 fyrir a\xf0 ${
                    r.origin ?? "gildi"
                  } s\xe9 ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Of l\xedti\xf0: gert er r\xe1\xf0 fyrir a\xf0 ${
                      r.origin
                    } hafi ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Of l\xedti\xf0: gert er r\xe1\xf0 fyrir a\xf0 ${
                    r.origin
                  } s\xe9 ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Rangt ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
        ...
        return {
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                case "invalid_type":
                  return `Input non valido: atteso ${r.expected}, ricevuto ${((
                    e
                  ) => {
                    let i = typeof e;
                    switch (i) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Input non valido: atteso ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Opzione non valida: atteso uno tra ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Troppo grande: ${
                      r.origin ?? "valore"
                    } deve avere ${i}${r.maximum.toString()} ${
                      t.unit ?? "elementi"
                    }`;
                  return `Troppo grande: ${
                    r.origin ?? "valore"
                  } deve essere ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Troppo piccolo: ${
                      r.origin
                    } deve avere ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Troppo piccolo: ${
                    r.origin
                  } deve essere ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `無効な入力: ${f.stringifyPrimitive(
                      r.values[0]
                    )}が期待されました`;
                  return `無効な選択: ${f.joinValues(
                    r.values,
                    "、"
                  )}のいずれかである必要があります`;
                case "too_big": {
                  let i = r.inclusive ? "以下である" : "より小さい",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `大きすぎる値: ${
                      r.origin ?? "値"
                  ...
                  return `大きすぎる値: ${
                    r.origin ?? "値"
                  }は${r.maximum.toString()}${i}必要があります`;
                }
                case "too_small": {
                  let i = r.inclusive ? "以上である" : "より大きい",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `小さすぎる値: ${r.origin}は${r.minimum.toString()}${
                      t.unit
                    }${i}必要があります`;
                  return `小さすぎる値: ${
                    r.origin
                  }は${r.minimum.toString()}${i}必要があります`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `無効な${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `ទិន្នន័យបញ្ចូលមិនត្រឹមត្រូវ៖ ត្រូវការ ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `ជម្រើសមិនត្រឹមត្រូវ៖ ត្រូវជាមួយក្នុងចំណោម ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `ធំពេក៖ ត្រូវការ ${
                      r.origin ?? "តម្លៃ"
                    } ${i} ${r.maximum.toString()} ${t.unit ?? "ធាតុ"}`;
                  return `ធំពេក៖ ត្រូវការ ${
                    r.origin ?? "តម្លៃ"
                  } ${i} ${r.maximum.toString()}`;
                }
                ...
                case "invalid_format":
                  ...
                  return `មិនត្រឹមត្រូវ៖ ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `លេខមិនត្រឹមត្រូវ៖ ត្រូវតែជាពហុគុណនៃ ${r.divisor}`;
                case "unrecognized_keys":
                  return `រកឃើញសោមិនស្គាល់៖ ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `잘못된 입력: 값은 ${f.stringifyPrimitive(
                      r.values[0]
                    )} 이어야 합니다`;
                  return `잘못된 옵션: ${f.joinValues(
                    r.values,
                    "또는 "
                  )} 중 하나여야 합니다`;
                case "too_big": {
                  let i = r.inclusive ? "이하" : "미만",
                    t = "미만" === i ? "이어야 합니다" : "여야 합니다",
                    n = e[r.origin] ?? null,
                    a = n?.unit ?? "요소";
                  if (n)
                    return `${
                      r.origin ?? "값"
                    }이 너무 큽니다: ${r.maximum.toString()}${a} ${i}${t}`;
                  return `${
                    r.origin ?? "값"
                  }이 너무 큽니다: ${r.maximum.toString()} ${i}${t}`;
                }
                case "too_small": {
                  let i = r.inclusive ? "이상" : "초과",
                    t = "이상" === i ? "이어야 합니다" : "여야 합니다",
                    n = e[r.origin] ?? null,
                    a = n?.unit ?? "요소";
                  if (n)
                    return `${
                      r.origin ?? "값"
                    }이 너무 작습니다: ${r.minimum.toString()}${a} ${i}${t}`;
                  return `${
                    r.origin ?? "값"
                  }이 너무 작습니다: ${r.minimum.toString()} ${i}${t}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `잘못된 ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `잘못된 숫자: ${r.divisor}의 배수여야 합니다`;
                case "unrecognized_keys":
                  return `인식할 수 없는 키: ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  ...
                  return `Грешана опција: се очекува една ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Премногу голем: се очекува ${
                      r.origin ?? "вредноста"
                    } да има ${i}${r.maximum.toString()} ${
                      t.unit ?? "елементи"
                    }`;
                  return `Премногу голем: се очекува ${
                    r.origin ?? "вредноста"
                  } да биде ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Премногу мал: се очекува ${
                      r.origin
                    } да има ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Премногу мал: се очекува ${
                    r.origin
                  } да биде ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Input tidak sah: dijangka ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Pilihan tidak sah: dijangka salah satu daripada ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  let i = r.inclusive ? "<=" : "<",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Terlalu besar: dijangka ${r.origin ?? "nilai"} ${
                      t.verb
                    } ${i}${r.maximum.toString()} ${t.unit ?? "elemen"}`;
                  return `Terlalu besar: dijangka ${
                    r.origin ?? "nilai"
                  } adalah ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Terlalu kecil: dijangka ${r.origin} ${
                      t.verb
                    } ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Terlalu kecil: dijangka ${
                    r.origin
                  } adalah ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `${i[r.format] ?? r.format} tidak sah`;
                case "not_multiple_of":
                  return `Nombor tidak sah: perlu gandaan ${r.divisor}`;
                case "unrecognized_keys":
                  return `Kunci tidak dikenali: ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Ongeldige invoer: verwacht ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Ongeldige optie: verwacht \xe9\xe9n van ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                ...
                case "too_small": {
                  ...
                  if (t)
                    return `Te kort: verwacht dat ${
                      r.origin
                    } ${i}${r.minimum.toString()} ${t.unit} bevat`;
                  return `Te kort: verwacht dat ${
                    r.origin
                  } ${i}${r.minimum.toString()} is`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Ongeldig: ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
        ...
        return {
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                case "invalid_type":
                  return `Ugyldig input: forventet ${r.expected}, fikk ${((
                    e
                  ) => {
                    let i = typeof e;
                    switch (i) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Ugyldig verdi: forventet ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Ugyldig valg: forventet en av ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `For stor(t): forventet ${
                      r.origin ?? "value"
                    } til \xe5 ha ${i}${r.maximum.toString()} ${
                      t.unit ?? "elementer"
                    }`;
                  return `For stor(t): forventet ${
                    r.origin ?? "value"
                ...
                case "too_small": {
                  ...
                  if (t)
                    return `For lite(n): forventet ${
                      r.origin
                    } til \xe5 ha ${i}${r.minimum.toString()} ${t.unit}`;
                  return `For lite(n): forventet ${
                    r.origin
                  } til \xe5 ha ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `F\xe2sit giren: umulan ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `F\xe2sit tercih: m\xfbteberler ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  return `Fazla b\xfcy\xfck: ${
                    r.origin ?? "value"
                  }, ${i}${r.maximum.toString()} olmalıydı.`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Fazla k\xfc\xe7\xfck: ${
                      r.origin
                    }, ${i}${r.minimum.toString()} ${t.unit} sahip olmalıydı.`;
                  return `Fazla k\xfc\xe7\xfck: ${
                    r.origin
                  }, ${i}${r.minimum.toString()} olmalıydı.`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `F\xe2sit ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `ناسم ورودي: باید ${f.stringifyPrimitive(
                      r.values[0]
                    )} وای`;
                  return `ناسم انتخاب: باید یو له ${f.joinValues(
                    r.values,
                    "|"
                  )} څخه وای`;
                case "too_big": {
                ...
                case "too_small": {
                  ...
                  if (t)
                    return `ډیر کوچنی: ${
                      r.origin
                    } باید ${i}${r.minimum.toString()} ${t.unit} ولري`;
                  return `ډیر کوچنی: ${
                    r.origin
                  } باید ${i}${r.minimum.toString()} وي`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `${i[r.format] ?? r.format} ناسم دی`;
                case "not_multiple_of":
                  return `ناسم عدد: باید د ${r.divisor} مضرب وي`;
                case "unrecognized_keys":
                  return `ناسم ${
                    r.keys.length > 1 ? "کلیډونه" : "کلیډ"
                  }: ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Nieprawidłowe dane wejściowe: oczekiwano ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Nieprawidłowa opcja: oczekiwano jednej z wartości ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Za duża wartość: oczekiwano, że ${
                      r.origin ?? "wartość"
                    } będzie mieć ${i}${r.maximum.toString()} ${
                      t.unit ?? "element\xf3w"
                    }`;
                  return `Zbyt duż(y/a/e): oczekiwano, że ${
                    r.origin ?? "wartość"
                  } będzie wynosić ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Za mała wartość: oczekiwano, że ${
                      r.origin ?? "wartość"
                    } będzie mieć ${i}${r.minimum.toString()} ${
                      t.unit ?? "element\xf3w"
                    }`;
                  return `Zbyt mał(y/a/e): oczekiwano, że ${
                    r.origin ?? "wartość"
                  } będzie wynosić ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Nieprawidłow(y/a/e) ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Entrada inv\xe1lida: esperado ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Op\xe7\xe3o inv\xe1lida: esperada uma das ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Muito grande: esperado que ${
                      r.origin ?? "valor"
                    } tivesse ${i}${r.maximum.toString()} ${
                      t.unit ?? "elementos"
                    }`;
                  return `Muito grande: esperado que ${
                    r.origin ?? "valor"
                  } fosse ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Muito pequeno: esperado que ${
                      r.origin
                    } tivesse ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Muito pequeno: esperado que ${
                    r.origin
                  } fosse ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `${i[r.format] ?? r.format} inv\xe1lido`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Неверный ввод: ожидалось ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Неверный вариант: ожидалось одно из ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t) {
                    ...
                    return `Слишком большое значение: ожидалось, что ${
                      r.origin ?? "значение"
                    } будет иметь ${i}${r.maximum.toString()} ${e}`;
                  }
                  return `Слишком большое значение: ожидалось, что ${
                    r.origin ?? "значение"
                  } будет ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t) {
                    ...
                    return `Слишком маленькое значение: ожидалось, что ${
                      r.origin
                    } будет иметь ${i}${r.minimum.toString()} ${e}`;
                  }
                  return `Слишком маленькое значение: ожидалось, что ${
                    r.origin
                  } будет ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Неверный ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `Неверное число: должно быть кратным ${r.divisor}`;
                case "unrecognized_keys":
                  return `Нераспознанн${r.keys.length > 1 ? "ые" : "ый"} ключ${
                    r.keys.length > 1 ? "и" : ""
                  }: ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Neveljaven vnos: pričakovano ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Neveljavna možnost: pričakovano eno izmed ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                ...
                case "too_small": {
                  ...
                  if (t)
                    return `Premajhno: pričakovano, da bo ${
                      r.origin
                    } imelo ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Premajhno: pričakovano, da bo ${
                    r.origin
                  } ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  ...
                  return `Neveljaven ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Ogiltig inmatning: f\xf6rv\xe4ntat ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Ogiltigt val: f\xf6rv\xe4ntade en av ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                ...
                case "too_small": {
                  ...
                  if (t)
                    return `F\xf6r lite(t): f\xf6rv\xe4ntade ${
                      r.origin ?? "v\xe4rdet"
                    } att ha ${i}${r.minimum.toString()} ${t.unit}`;
                  return `F\xf6r lite(t): f\xf6rv\xe4ntade ${
                    r.origin ?? "v\xe4rdet"
                  } att ha ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Ogiltig(t) ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `தவறான உள்ளீடு: எதிர்பார்க்கப்பட்டது ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `தவறான விருப்பம்: எதிர்பார்க்கப்பட்டது ${f.joinValues(
                    r.values,
                    "|"
                  )} இல் ஒன்று`;
                case "too_big": {
                  ...
                  return `மிக பெரியது: எதிர்பார்க்கப்பட்டது ${
                    r.origin ?? "மதிப்பு"
                  } ${i}${r.maximum.toString()} ஆக இருக்க வேண்டும்`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `மிகச் சிறியது: எதிர்பார்க்கப்பட்டது ${
                      r.origin
                    } ${i}${r.minimum.toString()} ${t.unit} ஆக இருக்க வேண்டும்`;
                  return `மிகச் சிறியது: எதிர்பார்க்கப்பட்டது ${
                    r.origin
                  } ${i}${r.minimum.toString()} ஆக இருக்க வேண்டும்`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `தவறான ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `ค่าไม่ถูกต้อง: ควรเป็น ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `ตัวเลือกไม่ถูกต้อง: ควรเป็นหนึ่งใน ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  let i = r.inclusive ? "ไม่เกิน" : "น้อยกว่า",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `เกินกำหนด: ${
                      r.origin ?? "ค่า"
                    } ควรมี${i} ${r.maximum.toString()} ${t.unit ?? "รายการ"}`;
                  return `เกินกำหนด: ${
                    r.origin ?? "ค่า"
                  } ควรมี${i} ${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? "อย่างน้อย" : "มากกว่า",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `น้อยกว่ากำหนด: ${
                      r.origin
                    } ควรมี${i} ${r.minimum.toString()} ${t.unit}`;
                  return `น้อยกว่ากำหนด: ${
                    r.origin
                  } ควรมี${i} ${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `รูปแบบไม่ถูกต้อง: ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `ตัวเลขไม่ถูกต้อง: ต้องเป็นจำนวนที่หารด้วย ${r.divisor} ได้ลงตัว`;
                case "unrecognized_keys":
                  return `พบคีย์ที่ไม่รู้จัก: ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
        ...
        return {
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                case "invalid_type":
                  return `Ge\xe7ersiz değer: beklenen ${r.expected}, alınan ${((
                    e
                  ) => {
                    let i = typeof e;
                    switch (i) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Ge\xe7ersiz değer: beklenen ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Ge\xe7ersiz se\xe7enek: aşağıdakilerden biri olmalı: ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `\xc7ok b\xfcy\xfck: beklenen ${
                      r.origin ?? "değer"
                    } ${i}${r.maximum.toString()} ${t.unit ?? "\xf6ğe"}`;
                  return `\xc7ok b\xfcy\xfck: beklenen ${
                    r.origin ?? "değer"
                  } ${i}${r.maximum.toString()}`;
                }
                ...
                case "invalid_format":
                  ...
                  return `Ge\xe7ersiz ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Неправильні вхідні дані: очікується ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `Неправильна опція: очікується одне з ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `Занадто велике: очікується, що ${
                      r.origin ?? "значення"
                    } ${t.verb} ${i}${r.maximum.toString()} ${
                      t.unit ?? "елементів"
                    }`;
                  return `Занадто велике: очікується, що ${
                    r.origin ?? "значення"
                  } буде ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Занадто мале: очікується, що ${r.origin} ${
                      t.verb
                    } ${i}${r.minimum.toString()} ${t.unit}`;
                  return `Занадто мале: очікується, що ${
                    r.origin
                  } буде ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Неправильний ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `غلط ان پٹ: ${f.stringifyPrimitive(
                      r.values[0]
                    )} متوقع تھا`;
                  return `غلط آپشن: ${f.joinValues(
                    r.values,
                    "|"
                ...
                case "too_big": {
                  ...
                  if (t)
                    return `بہت بڑا: ${
                      r.origin ?? "ویلیو"
                    } کے ${i}${r.maximum.toString()} ${
                      t.unit ?? "عناصر"
                    } ہونے متوقع تھے`;
                  return `بہت بڑا: ${
                    r.origin ?? "ویلیو"
                  } کا ${i}${r.maximum.toString()} ہونا متوقع تھا`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `بہت چھوٹا: ${
                      r.origin
                    } کے ${i}${r.minimum.toString()} ${t.unit} ہونے متوقع تھے`;
                  return `بہت چھوٹا: ${
                    r.origin
                  } کا ${i}${r.minimum.toString()} ہونا متوقع تھا`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `غلط ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `Đầu v\xe0o kh\xf4ng hợp lệ: mong đợi ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `T\xf9y chọn kh\xf4ng hợp lệ: mong đợi một trong c\xe1c gi\xe1 trị ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  let i = r.inclusive ? "<=" : "<",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Qu\xe1 lớn: mong đợi ${r.origin ?? "gi\xe1 trị"} ${
                      t.verb
                    } ${i}${r.maximum.toString()} ${t.unit ?? "phần tử"}`;
                ...
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `Qu\xe1 nhỏ: mong đợi ${r.origin} ${
                      t.verb
                    } ${i}${r.minimum.toString()} ${t.unit}`;
                ...
                case "invalid_format":
                  ...
                  return `${i[r.format] ?? r.format} kh\xf4ng hợp lệ`;
                case "not_multiple_of":
                  return `Số kh\xf4ng hợp lệ: phải l\xe0 bội số của ${r.divisor}`;
                case "unrecognized_keys":
                  return `Kh\xf3a kh\xf4ng được nhận dạng: ${f.joinValues(
                    r.keys,
                    ", "
                  )}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `无效输入：期望 ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `无效选项：期望以下之一 ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `数值过大：期望 ${
                      r.origin ?? "值"
                    } ${i}${r.maximum.toString()} ${t.unit ?? "个元素"}`;
                  return `数值过大：期望 ${
                    r.origin ?? "值"
                  } ${i}${r.maximum.toString()}`;
                }
                ...
                case "invalid_format":
                  ...
                  return `无效${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `无效数字：必须是 ${r.divisor} 的倍数`;
                case "unrecognized_keys":
                  return `出现未知的键(key): ${f.joinValues(r.keys, ", ")}`;
                case "invalid_key":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `無效的輸入值：預期為 ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `無效的選項：預期為以下其中之一 ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `數值過大：預期 ${
                      r.origin ?? "值"
                    } 應為 ${i}${r.maximum.toString()} ${t.unit ?? "個元素"}`;
                  return `數值過大：預期 ${
                    r.origin ?? "值"
                  } 應為 ${i}${r.maximum.toString()}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `數值過小：預期 ${
                      r.origin
                    } 應為 ${i}${r.minimum.toString()} ${t.unit}`;
                  return `數值過小：預期 ${
                    r.origin
                  } 應為 ${i}${r.minimum.toString()}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `無效的 ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
          ...
          localeError: (() => {
            ...
            return (r) => {
              switch (r.code) {
                ...
                case "invalid_value":
                  if (1 === r.values.length)
                    return `\xccb\xe1wọl\xe9 aṣ\xecṣe: a n\xed l\xe1ti fi ${f.stringifyPrimitive(
                      r.values[0]
                    )}`;
                  return `\xc0ṣ\xe0y\xe0n aṣ\xecṣe: yan ọ̀kan l\xe1ra ${f.joinValues(
                    r.values,
                    "|"
                  )}`;
                case "too_big": {
                  ...
                  if (t)
                    return `T\xf3 pọ̀ j\xf9: a n\xed l\xe1ti jẹ́ p\xe9 ${
                      r.origin ?? "iye"
                    } ${t.verb} ${i}${r.maximum} ${t.unit}`;
                  return `T\xf3 pọ̀ j\xf9: a n\xed l\xe1ti jẹ́ ${i}${r.maximum}`;
                }
                case "too_small": {
                  let i = r.inclusive ? ">=" : ">",
                    t = e[r.origin] ?? null;
                  if (t)
                    return `K\xe9r\xe9 ju: a n\xed l\xe1ti jẹ́ p\xe9 ${r.origin} ${t.verb} ${i}${r.minimum} ${t.unit}`;
                  return `K\xe9r\xe9 ju: a n\xed l\xe1ti jẹ́ ${i}${r.minimum}`;
                }
                case "invalid_format":
                  if ("starts_with" === r.format)
                  ...
                  return `Aṣ\xecṣe: ${i[r.format] ?? r.format}`;
                case "not_multiple_of":
                  return `Nọ́mb\xe0 aṣ\xecṣe: gbọ́dọ̀ jẹ́ \xe8y\xe0 p\xedp\xedn ti ${r.divisor}`;
                case "unrecognized_keys":
                  return `Bọt\xecn\xec \xe0\xecmọ̀: ${f.joinValues(
                    r.keys,
                    ", "
                  )}`;
                case "invalid_key":
      ...
      class es {
        ...
        implement(e) {
          ...
          let i = (...r) => {
            let t = this._def.input
              ? (0, s.qg)(this._def.input, r, void 0, { callee: i })
              : r;
            if (!Array.isArray(t))
              throw Error(
            ...
            return this._def.output
              ? (0, s.qg)(this._def.output, n, void 0, { callee: i })
              : n;
          };
          return i;
        }
        implementAsync(e) {
          ...
          let i = async (...r) => {
            let t = this._def.input
              ? await (0, s.EJ)(this._def.input, r, void 0, { callee: i })
              : r;
            if (!Array.isArray(t))
              throw Error(
                "Invalid arguments schema: not an array or tuple schema."
            ...
            let n = await e(...t);
            return this._def.output
              ? (0, s.EJ)(this._def.output, n, void 0, { callee: i })
              : n;
          };
          return i;
        }
        input(...e) {
          ...
          return new i(
            Array.isArray(e[0])
              ? {
                  type: "function",
                  input: new c.G3({ type: "tuple", items: e[0], rest: e[1] }),
      ...
      function ed(e) {
        return new es({
          ...
          input: Array.isArray(e?.input)
            ? (0, el.gt)(c.G3, e?.input)
            : e?.input ?? (0, el.dZ)(c.$p, (0, el.em)(c.GP)),
          output: e?.output ?? (0, el.em)(c.GP),
        });
      }
      class ec {
        constructor(e) {
          (this.counter = 0),
            (this.metadataRegistry = e?.metadata ?? eu.fd),
        ...
        process(e, i = { path: [], schemaPath: [] }) {
          ...
          if (u) a.schema = u;
            ...
            let r = { ...i, schemaPath: [...i.schemaPath, e], path: i.path },
              n = e._zod.parent;
            if (n)
              (a.ref = n), this.process(n, r), (this.seen.get(n).isParent = !0);
            else {
              let i = a.schema;
              switch (t.type) {
                case "string": {
                ...
                case "number": {
                  ...
                  "string" == typeof n && n.includes("int")
                    ...
                    "number" == typeof o &&
                      ("draft-4" === this.target
                        ? ((i.minimum = o), (i.exclusiveMinimum = !0))
                        : (i.exclusiveMinimum = o)),
                    "number" == typeof r &&
                      ((i.minimum = r),
                      "number" == typeof o &&
                        "draft-4" !== this.target &&
                    ...
                    "number" == typeof t &&
                      ...
                      "number" == typeof u &&
                        ...
                        (u <= t
                          ? delete i.maximum
                          : delete i.exclusiveMaximum)),
                    "number" == typeof a && (i.multipleOf = a);
                  break;
                }
                case "boolean":
                case "success":
                ...
                case "array": {
                  ...
                  "number" == typeof n && (i.minItems = n),
                    "number" == typeof a && (i.maxItems = a),
                    (i.type = "array"),
                    (i.items = this.process(t.element, {
                      ...r,
                      path: [...r.path, "items"],
                    }));
                  break;
                ...
                case "object": {
                  ...
                  let e = t.shape;
                  for (let t in e)
                    i.properties[t] = this.process(e[t], {
                      ...r,
                      path: [...r.path, "properties", t],
                    });
                  let n = new Set(
                    [...new Set(Object.keys(e))].filter((e) => {
                      let i = t.shape[e]._zod;
                      return "input" === this.io
                        ? void 0 === i.optin
                        : void 0 === i.optout;
                    })
                  );
                  n.size > 0 && (i.required = Array.from(n)),
                    t.catchall?._zod.def.type === "never"
                      ? (i.additionalProperties = !1)
                      : t.catchall
                      ? t.catchall &&
                        (i.additionalProperties = this.process(t.catchall, {
                          ...r,
                          path: [...r.path, "additionalProperties"],
                        }))
                      : "output" === this.io && (i.additionalProperties = !1);
                  break;
                }
                case "union":
                  i.anyOf = t.options.map((e, i) =>
                    this.process(e, { ...r, path: [...r.path, "anyOf", i] })
                  );
                  break;
                case "intersection": {
                  let e = this.process(t.left, {
                      ...r,
                      path: [...r.path, "allOf", 0],
                    }),
                    n = this.process(t.right, {
                      ...r,
                      path: [...r.path, "allOf", 1],
                    }),
                ...
                case "tuple": {
                  i.type = "array";
                  let n = t.items.map((e, i) =>
                    this.process(e, {
                      ...r,
                      path: [...r.path, "prefixItems", i],
                    })
                  );
                  if (
                  ...
                  t.rest &&
                    (i.items = this.process(t.rest, {
                      ...r,
                      path: [...r.path, "items"],
                    }));
                  let { minimum: a, maximum: u } = e._zod.bag;
                  "number" == typeof a && (i.minItems = a),
                    "number" == typeof u && (i.maxItems = u);
                  break;
                }
                case "record":
                  (i.type = "object"),
                    "draft-4" !== this.target &&
                      (i.propertyNames = this.process(t.keyType, {
                        ...r,
                        path: [...r.path, "propertyNames"],
                      })),
                    (i.additionalProperties = this.process(t.valueType, {
                      ...r,
                      path: [...r.path, "additionalProperties"],
                    }));
                  break;
                ...
                case "set":
                  ...
                  break;
                case "enum": {
                  let e = (0, f.getEnumValues)(t.entries);
                  e.every((e) => "number" == typeof e) && (i.type = "number"),
                    e.every((e) => "string" == typeof e) && (i.type = "string"),
                    (i.enum = e);
                  break;
                }
                case "literal": {
                  ...
                  for (let i of t.values)
                    if (void 0 === i) {
                      ...
                      else e.push(Number(i));
                    else e.push(i);
                  if (0 === e.length);
                  else if (1 === e.length) {
                    let r = e[0];
                    (i.type = null === r ? "null" : typeof r),
                      "draft-4" === this.target
                        ? (i.enum = [r])
                        : (i.const = r);
                  } else
                ...
                case "file": {
                  let r = {
                    ...
                    { minimum: t, maximum: n, mime: a } = e._zod.bag;
                  void 0 !== t && (r.minLength = t),
                    void 0 !== n && (r.maxLength = n),
                    a
                      ? 1 === a.length
                        ? ((r.contentMediaType = a[0]), Object.assign(i, r))
                        : (i.anyOf = a.map((e) => ({
                            ...r,
                            contentMediaType: e,
                          })))
                ...
                case "transform":
                  ...
                  break;
                case "nullable":
                  i.anyOf = [this.process(t.innerType, r), { type: "null" }];
                  break;
                case "nonoptional":
                case "promise":
                case "optional":
                  this.process(t.innerType, r), (a.ref = t.innerType);
                  break;
                case "default":
                  this.process(t.innerType, r),
                    (a.ref = t.innerType),
          ...
          return (
            o && Object.assign(a.schema, o),
            "input" === this.io &&
              (function e(i, r) {
                let t = r ?? { seen: new Set() };
                if (t.seen.has(i)) return !1;
                t.seen.add(i);
                let n = i._zod.def;
                switch (n.type) {
                  case "string":
                  ...
                  case "object":
                    for (let i in n.shape) if (e(n.shape[i], t)) return !0;
                    return !1;
                  case "union":
                    for (let i of n.options) if (e(i, t)) return !0;
                    return !1;
                  case "intersection":
                    return e(n.left, t) || e(n.right, t);
                  case "tuple":
                    for (let i of n.items) if (e(i, t)) return !0;
                    if (n.rest && e(n.rest, t)) return !0;
                    return !1;
                  case "record":
                  case "map":
                    return e(n.keyType, t) || e(n.valueType, t);
                  case "set":
                    return e(n.valueType, t);
                  case "promise":
                  case "optional":
                  case "nonoptional":
                  case "nullable":
                  ...
                  case "default":
                  case "prefault":
                    return e(n.innerType, t);
                  case "lazy":
                    return e(n.getter(), t);
                  case "transform":
                    return !0;
                  case "pipe":
                    return e(n.in, t) || e(n.out, t);
                }
        ...
        emit(e, i) {
          ...
          let n = (e) => {
              let i = "draft-2020-12" === this.target ? "$defs" : "definitions";
              if (r.external) {
                let t = r.external.registry.get(e[0])?.id,
                  n = r.external.uri ?? ((e) => e);
                if (t) return { ref: n(t) };
                let a =
                  e[1].defId ?? e[1].schema.id ?? `schema${this.counter++}`;
                return (
                  (e[1].defId = a),
                  { defId: a, ref: `${n("__shared")}#/${i}/${a}` }
                );
              }
              if (e[1] === t) return { ref: "#" };
              let n = `#/${i}/`,
...
Set the \`cycles\` parameter to \`"ref"\` to resolve cyclical schemas with defs.`);
          ...
          for (let i of this.seen.entries()) {
            let t = i[1];
            if (e === i[0]) {
              a(i);
              continue;
            ...
            if (r.external) {
              let t = r.external.registry.get(i[0])?.id;
              if (e !== i[0] && t) {
                a(i);
                continue;
              }
            ...
            if (
              this.metadataRegistry.get(i[0])?.id ||
              t.cycle ||
              (t.count > 1 && "ref" === r.reused)
            ) {
              a(i);
              continue;
            }
          ...
          let u = (e, i) => {
            ...
            if (((r.ref = null), a)) {
              ...
              e.$ref && ("draft-7" === i.target || "draft-4" === i.target)
                ? ((t.allOf = t.allOf ?? []), t.allOf.push(e))
                : (Object.assign(t, e), Object.assign(t, n));
            }
            r.isParent ||
              this.override({
                zodSchema: e,
          ...
          if (
            ...
            let i = r.external.registry.get(e)?.id;
            if (!i) throw Error("Schema is missing an `id` property");
            o.$id = r.external.uri(i);
          }
          Object.assign(o, t.def);
          let l = r.external?.defs ?? {};
          for (let e of this.seen.entries()) {
            let i = e[1];
            i.def && i.defId && (l[i.defId] = i.def);
          }
          r.external ||
      ...
      function em(e, i) {
        if (e instanceof eu.rs) {
          ...
          let n = {},
            a = { registry: e, uri: i?.uri, defs: t };
          for (let t of e._idmap.entries()) {
            let [e, u] = t;
            n[e] = r.emit(u, { ...i, external: a });
          }
          return (
            Object.keys(t).length > 0 &&
              (n.__shared = {
                ["draft-2020-12" === r.target ? "$defs" : "definitions"]: t,
              }),
            { schemas: n }
          );
        }
