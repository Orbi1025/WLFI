try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "b2b77a53-dd82-4189-bb54-2e0b503ca75e"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-b2b77a53-dd82-4189-bb54-2e0b503ca75e"));
  })();
} catch (e) {}
  ...
  [1220],
  {
    628: (e, t, s) => {
      e.exports = function () {
        ...
        let h = null,
          ...
          E = 1 / 0,
          w = function (t, s, r) {
            let i = `${l}evaluateRule(): `;
            if (t >= b.length) throw Error(`${i}rule index: ${t} out of range`);
            if (s >= n) throw Error(`${i}phrase index: ${s} out of range`);
            let { length: a } = h;
            h.push({ type: o.RNM, index: t }), e(a, s, r), h.pop();
          },
          C = function (t, s, r) {
            let i = `${l}evaluateUdt(): `;
            if (t >= y.length) throw Error(`${i}udt index: ${t} out of range`);
            if (s >= n) throw Error(`${i}phrase index: ${s} out of range`);
            let { length: a } = h;
            h.push({ type: o.UDT, empty: y[t].empty, index: t }),
              e(a, s, r),
              h.pop();
          },
          k = function () {
          ...
          S = function () {
            ...
            (this.push = function () {
              ...
              (this.pop = function (t) {
                let s = t;
                if ((s || (s = e.length - 1), s < 1 || s > e.length))
                  throw Error(`${l}backRef.pop(): bad length: ${s}`);
                return (e.length = s), e[e.length - 1];
              }),
              (this.length = function () {
                return e.length;
              }),
              (this.savePhrase = function (t, s, r) {
                e[e.length - 1][t] = { phraseIndex: s, phraseLength: r };
              }),
          ...
          v = function () {
            ...
            null !== c.trace && c.trace.init(b, y, d);
          },
          N = function () {
          ...
          H = function (e, s, i) {
            ...
            if ("string" == typeof c) c = a.stringToChars(c);
            ...
            if ("number" != typeof h) h = 0;
            else if ((h = Math.floor(h)) < 0 || h > c.length)
              throw Error(`${o}input beginning index out of range: ${h}`);
            if ("number" != typeof p) p = c.length - h;
            else if ((p = Math.floor(p)) < 0 || p > c.length - h)
          ...
          R = function () {
            let e,
              t,
              s = `${l}initializeCallbacks(): `;
            for (e = 0, g = [], m = []; e < b.length; e += 1) g[e] = null;
            for (e = 0; e < y.length; e += 1) m[e] = null;
            let r = [];
            for (e = 0; e < b.length; e += 1) r.push(b[e].lower);
            for (e = 0; e < y.length; e += 1) r.push(y[e].lower);
            for (let n in c.callbacks) {
              if ((e = r.indexOf(n.toLowerCase())) < 0)
                throw Error(
                  `${s}syntax callback '${n}' not a rule or udt name`
                );
              if (
                ((t = c.callbacks[n]) || (t = null),
                "function" == typeof t || null === t)
              )
                e < b.length ? (g[e] = t) : (m[e - b.length] = t);
              else
                throw Error(
                  `${s}syntax callback[${n}] must be function reference or 'false' (false/null/undefined/etc.)`
                );
            }
            for (e = 0; e < y.length; e += 1)
              if (null === m[e])
                throw Error(
                  `${s}all UDT callbacks must be defined. UDT callback[${y[e].lower}] not a function reference`
                );
          };
        (this.setMaxTreeDepth = function (e) {
          if ("number" != typeof e || (x = Math.floor(e)) <= 0)
        ...
        (this.parseSubstring = function (e, t, s, r, n, i) {
          return k(), H(s, r, n), D(e, t, i);
        }),
          (this.parse = function (e, t, s, r) {
            return k(), H(s, 0, s.length), D(e, t, r);
          });
        let _ = function (t, s, r) {
            let n = h[t];
            for (
              let t = 0;
              t < n.children.length &&
              (e(n.children[t], s, r), r.state === o.NOMATCH);
              t += 1
            );
          },
          P = function (t, s, r) {
            let n,
              ...
              p = r.uFrame.length(),
              u = r.pFrame.length();
            c.ast && (i = c.ast.getLength()), (n = !0), (a = s), (l = 0);
            for (let t = 0; t < d.children.length; t += 1) {
              if ((e(d.children[t], a, r), r.state === o.NOMATCH)) {
                n = !1;
                break;
              }
              (a += r.phraseLength), (l += r.phraseLength);
            }
            n
              ? ((r.state = 0 === l ? o.EMPTY : o.MATCH), (r.phraseLength = l))
              : ((r.state = o.NOMATCH),
                (r.phraseLength = 0),
                r.uFrame.pop(p),
                r.pFrame.pop(u),
          ...
          F = function (e, t, s, r) {
            if (t.phraseLength > s) {
              let r = `${l}opRNM(${e.name}): callback function error: `;
              throw Error(
                (r += `sysData.phraseLength: ${t.phraseLength} must be <= remaining chars: ${s}`)
              );
            }
            switch (t.state) {
              case o.ACTIVE:
                if (!0 !== r)
                  throw Error(
                    `${l}opRNM(${e.name}): callback function return error. ACTIVE state not allowed.`
                  );
                break;
              case o.EMPTY:
                t.phraseLength = 0;
              ...
              default:
                throw Error(
                  `${l}opRNM(${e.name}): callback function return error. Unrecognized return state: ${t.state}`
                );
            }
          },
          K = function (t, s, r) {
            ...
            if (
              (x &&
                ((a = c.ast && c.ast.ruleDefined(m.index)) &&
                  ((i = c.ast.getLength()),
                  c.ast.down(m.index, b[m.index].name)),
                (p = r.uFrame.length()),
                (u = r.pFrame.length()),
                r.uFrame.push(),
                r.pFrame.push(),
            ...
            x &&
              (a &&
                (r.state === o.NOMATCH
                  ? c.ast.setLength(i)
                  : c.ast.up(m.index, y.name, s, r.phraseLength)),
              (r.pFrame = f),
              r.state === o.NOMATCH
                ? (r.uFrame.pop(p), r.pFrame.pop(u))
                : y.isBkr &&
                  (r.pFrame.savePhrase(y.lower, s, r.phraseLength),
                  r.uFrame.savePhrase(y.lower, s, r.phraseLength)));
          },
          G = function (e, t, s) {
            if (t.phraseLength > s) {
              let r = `${l}opUDT(${e.name}): callback function error: `;
              throw Error(
                (r += `sysData.phraseLength: ${t.phraseLength} must be <= remaining chars: ${s}`)
              );
            }
            switch (t.state) {
              case o.ACTIVE:
                throw Error(
                  `${l}opUDT(${e.name}): callback function return error. ACTIVE state not allowed.`
                );
              case o.EMPTY:
                if (!1 === e.empty)
                  throw Error(
                    `${l}opUDT(${e.name}): callback function return error. May not return EMPTY.`
                  );
                t.phraseLength = 0;
                break;
              case o.MATCH:
              ...
              default:
                throw Error(
                  `${l}opUDT(${e.name}): callback function return error. Unrecognized return state: ${t.state}`
                );
            }
          },
          V = function (e, t, s) {
            ...
            let A = !I();
            A &&
              ((a = c.ast && c.ast.udtDefined(f.index)) &&
                ((i = b.length + f.index),
                (r = c.ast.getLength()),
                c.ast.down(i, g.name)),
              (l = s.uFrame.length()),
            ...
            m[f.index](s, d, t, T),
              ...
              A &&
                (a &&
                  (s.state === o.NOMATCH
                    ? c.ast.setLength(r)
                    : c.ast.up(i, g.name, t, s.phraseLength)),
                (s.pFrame = u),
                s.state === o.NOMATCH
                  ? (s.uFrame.pop(l), s.pFrame.pop(p))
                  : g.isBkr &&
                    (s.pFrame.savePhrase(g.lower, t, s.phraseLength),
                    s.uFrame.savePhrase(g.lower, t, s.phraseLength)));
          },
          Y = function (s, a, l) {
            i.push({
          ...
          j = function (e, t, s) {
            ...
            (s.state = o.NOMATCH),
              t < n &&
                r.min <= d[t] &&
                d[t] <= r.max &&
                ((s.state = o.MATCH), (s.phraseLength = 1));
          },
          q = function (e, t, s) {
            let r,
              i = h[e],
              a = i.string.length;
            if (((s.state = o.NOMATCH), t + a <= n)) {
              for (r = 0; r < a; r += 1) if (d[t + r] !== i.string[r]) return;
              (s.state = o.MATCH), (s.phraseLength = a);
            }
          },
          X = function (e, t, s) {
            let r,
            ...
            if (t + l <= n) {
              for (r = 0; r < l; r += 1)
                if (
                  ((i = d[t + r]) >= 65 && i <= 90 && (i += 32),
                  i !== a.string[r])
                )
                  return;
              (s.state = o.MATCH), (s.phraseLength = l);
            }
          },
          W = function (e, t, s) {
            (s.state = o.NOMATCH),
              (s.phraseLength = 0),
              (s.state = 0 === t ? o.EMPTY : o.NOMATCH);
          },
          Z = function (e, t, s) {
            (s.state = o.NOMATCH),
              (s.phraseLength = 0),
              (s.state = t === d.length ? o.EMPTY : o.NOMATCH);
          },
          J = function (e, t, s) {
            let r,
              i,
            ...
            (s.state = o.NOMATCH),
              (l =
                c.index < b.length
                  ? b[c.index].lower
                  : y[c.index - b.length].lower);
            let p =
                c.bkrMode === o.BKR_MODE_PM
                  ? s.pFrame.getPhrase(l)
                  : s.uFrame.getPhrase(l),
              u = c.bkrCase === o.BKR_MODE_CI;
            if (null === p) return;
            let f = p.phraseIndex,
              g = p.phraseLength;
            if (0 === g) {
              ...
              if (u) {
                for (r = 0; r < g; r += 1)
                  if (
                    ...
                    return;
                (s.state = o.MATCH), (s.phraseLength = g);
              } else
                for (r = 0; r < g; r += 1)
                  if ((i = d[t + r]) !== (a = d[f + r])) return;
              (s.state = o.MATCH), (s.phraseLength = g);
            }
          },
          Q = function (t, s, r) {
            switch (
              (i.push({ lookAround: o.LOOKAROUND_BEHIND, anchor: s }),
              e(t + 1, s, r),
              i.pop(),
              (r.phraseLength = 0),
              r.state)
              ...
              case o.NOMATCH:
                ...
                break;
              default:
                throw Error(`opBKA: invalid state ${r.state}`);
            }
          },
          ee = function (t, s, r) {
            switch (
              ...
              case o.NOMATCH:
                ...
                break;
              default:
                throw Error(`opBKN: invalid state ${r.state}`);
            }
          },
          et = function (t, s, r) {
            let n,
          ...
          es = function (t, s, r) {
            let n,
              ...
              d = h[t];
            (i = s), (a = 0), (l = 0);
            let p = r.uFrame.length(),
              u = r.pFrame.length();
            for (
              c.ast && (n = c.ast.getLength());
              !(i <= 0) &&
              (e(t + 1, i, r),
              r.state !== o.NOMATCH &&
                r.state !== o.EMPTY &&
            ...
            r.state === o.EMPTY || l >= d.min
              ? ((r.state = 0 === a ? o.EMPTY : o.MATCH), (r.phraseLength = a))
              : ((r.state = o.NOMATCH),
                (r.phraseLength = 0),
                r.uFrame.pop(p),
                r.pFrame.pop(u),
                c.ast && c.ast.setLength(n));
          },
          er = function (e, t, s) {
            let r = h[e];
            if (((s.state = o.NOMATCH), (s.phraseLength = 0), t > 0)) {
              let e = d[t - 1];
              r.min <= e &&
                e <= r.max &&
                ((s.state = o.MATCH), (s.phraseLength = 1));
          ...
          en = function (e, t, s) {
            let r,
              n = h[e];
            s.state = o.NOMATCH;
            let i = n.string.length,
              a = t - i;
            if (a >= 0) {
              for (r = 0; r < i; r += 1) if (d[a + r] !== n.string[r]) return;
              (s.state = o.MATCH), (s.phraseLength = i);
            }
          },
          ei = function (e, t, s) {
            let r,
          ...
          eo = function (e, t, s) {
            ...
            (s.state = o.NOMATCH),
              ...
              (a =
                l.index < b.length
                  ? b[l.index].lower
                  : y[l.index - b.length].lower);
            let c =
                l.bkrMode === o.BKR_MODE_PM
                  ? s.pFrame.getPhrase(a)
                  : s.uFrame.getPhrase(a),
              p = l.bkrCase === o.BKR_MODE_CI;
            if (null === c) return;
            let u = c.phraseIndex,
              f = c.phraseLength;
            if (0 === f) {
              ...
              if (p) {
                for (r = 0; r < f; r += 1)
                  if (
                    ...
                    return;
                (s.state = o.MATCH), (s.phraseLength = f);
              } else
                for (r = 0; r < f; r += 1)
                  if ((n = d[g + r]) !== (i = d[u + r])) return;
              (s.state = o.MATCH), (s.phraseLength = f);
            }
          };
        e = function (e, t, s) {
          let r = !0,
            n = h[e];
          if ((f += 1) > E)
            throw Error(`parser: maximum number of node hits exceeded: ${E}`);
          if ((p += 1) > u && (u = p) > x)
            throw Error(`parser: maximum parse tree depth exceeded: ${x}`);
          if ((s.refresh(), null !== c.trace)) {
            let e = L();
            c.trace.down(n, s.state, t, s.phraseLength, e.anchor, e.lookAround);
          }
          if (i[i.length - 1].lookAround === o.LOOKAROUND_BEHIND)
            switch (n.type) {
              case o.ALT:
                _(e, t, s);
                break;
          ...
          if (
            (!I() && t + s.phraseLength > A && (A = t + s.phraseLength),
            null !== c.stats && c.stats.collect(n, s),
            null !== c.trace)
          ) {
            let e = L();
            c.trace.up(n, s.state, t, s.phraseLength, e.anchor, e.lookAround);
          }
          return (p -= 1), r;
        };
      };
        ...
        (t.grammar = function () {
          (this.grammarObject = "grammarObject"),
            ...
            (this.rules[0].opcodes[3] = {
              type: 6,
              string: [
                32, 119, 97, 110, 116, 115, 32, 121, 111, 117, 32, 116, 111, 32,
                115, 105, 103, 110, 32, 105, 110, 32, 119, 105, 116, 104, 32,
                121, 111, 117, 114, 32, 69, 116, 104, 101, 114, 101, 117, 109,
                32, 97, 99, 99, 111, 117, 110, 116, 58,
              ],
            }),
            ...
            (this.rules[1].opcodes[0] = {
              type: 6,
              string: [
                69, 120, 112, 105, 114, 97, 116, 105, 111, 110, 32, 84, 105,
                109, 101, 58, 32,
              ],
            }),
            ...
            (this.rules[5].opcodes[3] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[8].opcodes[0] = { type: 3, min: 1, max: 1 / 0 }),
            ...
            (this.rules[11].opcodes[0] = { type: 3, min: 8, max: 1 / 0 }),
            ...
            (this.rules[15].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            (this.rules[15].opcodes[1] = { type: 4, index: 62 }),
            (this.rules[16].opcodes = []),
            (this.rules[16].opcodes[0] = { type: 3, min: 1, max: 1 / 0 }),
            (this.rules[16].opcodes[1] = { type: 4, index: 79 }),
            (this.rules[17].opcodes = []),
            (this.rules[17].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[21].opcodes[2] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[23].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[24].opcodes[5] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[25].opcodes[2] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[28].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[31].opcodes[2] = { type: 3, min: 1, max: 1 / 0 }),
            (this.rules[31].opcodes[3] = { type: 4, index: 80 }),
            (this.rules[31].opcodes[4] = { type: 7, string: [46] }),
            (this.rules[31].opcodes[5] = { type: 3, min: 1, max: 1 / 0 }),
            ...
            (this.rules[33].opcodes[3] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[34].opcodes[4] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[34].opcodes[11] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[42].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[44].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            (this.rules[44].opcodes[1] = { type: 4, index: 79 }),
            (this.rules[45].opcodes = []),
            (this.rules[45].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[46].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[49].opcodes[2] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[50].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[51].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[53].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[55].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            (this.rules[55].opcodes[1] = { type: 4, index: 79 }),
            (this.rules[56].opcodes = []),
            (this.rules[56].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[57].opcodes[5] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[58].opcodes[2] = { type: 3, min: 0, max: 1 / 0 }),
            ...
            (this.rules[60].opcodes[0] = { type: 3, min: 0, max: 1 / 0 }),
            (this.rules[60].opcodes[1] = { type: 4, index: 62 }),
            (this.rules[61].opcodes = []),
            (this.rules[61].opcodes[0] = { type: 3, min: 1, max: 1 / 0 }),
            ...
            (this.rules[70].opcodes[2] = { type: 3, min: 1, max: 1 / 0 }),
    ...
    11224: (e, t, s) => {
      ...
      let r = s(59366),
        n = s(39336),
        i = s(43424);
      function o(e, s = t.defaultRandomSource) {
      ...
      (t.defaultRandomSource = new r.SystemRandomSource()),
        ...
        (t.randomUint32 = function (e = t.defaultRandomSource) {
          let s = o(4, e),
            r = (0, n.readUint32LE)(s);
          return (0, i.wipe)(s), r;
        });
      let a = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
      function l(e, s = a, r = t.defaultRandomSource) {
        if (s.length < 2) throw Error("randomString charset is too short");
        if (s.length > 256) throw Error("randomString charset is too long");
        let n = "",
          c = s.length,
          h = 256 - (256 % c);
        for (; e > 0; ) {
          let t = o(Math.ceil((256 * e) / h), r);
          for (let r = 0; r < t.length && e > 0; r++) {
            let i = t[r];
            i < h && ((n += s.charAt(i % c)), e--);
          }
          (0, i.wipe)(t);
        }
        return n;
      ...
      (t.randomString = l),
        (t.randomStringForEntropy = function (
          ...
          return l(Math.ceil(e / (Math.log(s.length) / Math.LN2)), s, r);
        });
    },
    12394: (e, t, s) => {
      e.exports = function () {
        ...
        let h = function (e, t) {
            return e.lower < t.lower ? -1 : +(e.lower > t.lower);
          },
          d = function (e, t) {
            return e.total < t.total ? 1 : e.total > t.total ? -1 : h(e, t);
          },
          p = function (e, t) {
          ...
          g = function (e, s) {
            switch (((e.total += 1), s)) {
              ...
              default:
                throw Error(
                  `stats.js: collect(): incStat(): unrecognized state: ${s}`
                );
            }
          },
          m = function (e, t) {
            ...
            return (
              s +
              `<tr><td class="${n.CLASS_ACTIVE}">${e}</td><td class="${n.CLASS_EMPTY}">${t.empty}</td><td class="${n.CLASS_MATCH}">${t.match}</td><td class="${n.CLASS_NOMATCH}">${t.nomatch}</td><td class="${n.CLASS_ACTIVE}">${t.total}</td></tr>
`
            );
          },
          b = function () {
          ...
          y = function () {
            ...
            for (let t = 0; t < i.length; t += 1)
              l[t].total > 0 &&
                (e += `<tr><td class="${n.CLASS_ACTIVE}">${l[t].name}</td><td class="${n.CLASS_EMPTY}">${l[t].empty}</td><td class="${n.CLASS_MATCH}">${l[t].match}</td><td class="${n.CLASS_NOMATCH}">${l[t].nomatch}</td><td class="${n.CLASS_ACTIVE}">${l[t].total}</td></tr>
`);
            if (o.length > 0) {
              e +=
              ...
              for (let t = 0; t < o.length; t += 1)
                c[t].total > 0 &&
                  (e += `<tr><td class="${n.CLASS_ACTIVE}">${c[t].name}</td><td class="${n.CLASS_EMPTY}">${c[t].empty}</td><td class="${n.CLASS_MATCH}">${c[t].match}</td><td class="${n.CLASS_NOMATCH}">${c[t].nomatch}</td><td class="${n.CLASS_ACTIVE}">${c[t].total}</td></tr>
`);
            }
            return e;
          };
        (this.validate = function (e) {
          ...
          (this.collect = function (s, r) {
            g(e, r.state, r.phraseLength),
              g(a[s.type], r.state, r.phraseLength),
              s.type === t.RNM && g(l[s.index], r.state, r.phraseLength),
              s.type === t.UDT && g(c[s.index], r.state, r.phraseLength);
          }),
          (this.toHtml = function (e, t) {
            let s = "";
            for (
              s += `<table class="${n.CLASS_STATS}">
`,
                "string" == typeof t &&
                  (s += `<caption>${t}</caption>
`),
                s += `<tr><th class="${n.CLASS_ACTIVE}">ops</th>
`,
                s += `<th class="${n.CLASS_EMPTY}">EMPTY</th>
`,
                s += `<th class="${n.CLASS_MATCH}">MATCH</th>
`,
                s += `<th class="${n.CLASS_NOMATCH}">NOMATCH</th>
`,
                s += `<th class="${n.CLASS_ACTIVE}">totals</th></tr>
`;
              ;
              ...
              if ("index" === e) {
                l.sort(p), c.length > 0 && c.sort(p), (s += b()), (s += y());
                break;
              }
              if ("hits" === e) {
                l.sort(d), c.length > 0 && c.sort(p), (s += b()), (s += y());
                break;
              }
              "alpha" === e &&
                (l.sort(h), c.length > 0 && c.sort(h), (s += b()), (s += y()));
              break;
            }
            return s + "</table>\n";
          }),
          (this.toHtmlPage = function (e, t, s) {
            return r.htmlToPage(this.toHtml(e, t), s);
          });
      };
    },
    14388: (e, t) => {
    ...
    24833: (e, t) => {
      ...
      class s {
        constructor(e, t, s) {
          (this.type = e), (this.expected = t), (this.received = s);
        }
      }
      (t.SiweError = s),
        (function (e) {
          (e.EXPIRED_MESSAGE = "Expired message."),
            ...
            (e.INVALID_ADDRESS = "Invalid address."),
            (e.INVALID_URI = "URI does not conform to RFC 3986."),
            (e.INVALID_NONCE =
              "Nonce size smaller then 8 characters or is not alphanumeric."),
            (e.NOT_YET_VALID_MESSAGE = "Message is not valid yet."),
            (e.INVALID_SIGNATURE =
              "Signature does not match address of the message."),
            (e.INVALID_TIME_FORMAT = "Invalid time format."),
            (e.INVALID_MESSAGE_VERSION = "Invalid message version."),
            (e.UNABLE_TO_PARSE = "Unable to parse the message.");
        })(t.SiweErrorType || (t.SiweErrorType = {}));
    },
    24867: function (e, t, s) {
      "use strict";
      var r =
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.isUri = t.ParsedMessage = void 0);
      let n = s(6144),
        i = s(76460),
        o = r(s(34101)),
        a = new n.grammar();
      class l {
        constructor(e) {
          let t = new o.default.parser();
          (t.callbacks["sign-in-with-ethereum"] = i.cb.signInWithEtherium),
            (t.callbacks.oscheme = i.cb.oscheme),
            (t.callbacks.domain = i.cb.domain),
            (t.callbacks.LF = i.cb.lineno),
            (t.callbacks["ex-title"] = i.cb.exTitle),
            (t.callbacks["nb-title"] = i.cb.nbTitle),
            (t.callbacks["ri-title"] = i.cb.riTitle),
            (t.callbacks["re-title"] = i.cb.reTitle),
            (t.callbacks.address = i.cb.address),
            (t.callbacks.statement = i.cb.statement),
            (t.callbacks["empty-statement"] = i.cb.emptyStatement),
            (t.callbacks.version = i.cb.version),
            (t.callbacks["chain-id"] = i.cb.chainId),
            (t.callbacks.nonce = i.cb.nonce),
            (t.callbacks["issued-at"] = i.cb.issuedAt),
            (t.callbacks["expiration-time"] = i.cb.expirationTime),
            (t.callbacks["not-before"] = i.cb.notBefore),
            (t.callbacks["request-id"] = i.cb.requestId),
            (t.callbacks.uri = i.cb.uri),
            (t.callbacks["uri-r"] = i.cb.uriR),
            (t.callbacks.resource = i.cb.resource),
            (t.callbacks.scheme = i.cb.scheme),
            (t.callbacks["userinfo-at"] = i.cb.userinfo),
            (t.callbacks.host = i.cb.host),
            (t.callbacks["IP-literal"] = i.cb.ipLiteral),
            (t.callbacks.port = i.cb.port),
            (t.callbacks["path-abempty"] = i.cb.pathAbempty),
            (t.callbacks["path-absolute"] = i.cb.pathAbsolute),
            (t.callbacks["path-rootless"] = i.cb.pathRootless),
            (t.callbacks["path-empty"] = i.cb.pathEmpty),
            (t.callbacks.query = i.cb.query),
            (t.callbacks.fragment = i.cb.fragment),
            (t.callbacks.IPv4address = i.cb.ipv4),
            (t.callbacks.nodcolon = i.cb.nodcolon),
            (t.callbacks.dcolon = i.cb.dcolon),
            (t.callbacks.h16 = i.cb.h16),
            (t.callbacks.h16c = i.cb.h16),
            (t.callbacks.h16n = i.cb.h16),
            (t.callbacks.h16cn = i.cb.h16),
            (t.callbacks["dec-octet"] = i.cb.decOctet),
            (t.callbacks["dec-digit"] = i.cb.decDigit);
          let s = {
              errors: [],
              lineno: 1,
              scheme: void 0,
            ...
            r = t.parse(a, 0, e, s),
            n = "";
          for (let e = 0; e < s.errors.length; e += 1) n += s.errors[e] + "\n";
          if (
            (r.success || (n += `Invalid message: ${JSON.stringify(r)}`),
            "" !== n)
          )
            throw Error(n);
          (this.scheme = s.scheme),
            ...
            (this.uriElements = s.uriElements);
        }
      }
      (t.ParsedMessage = l),
        (t.isUri = (e) => {
          ...
          return (
            ...
            (t.callbacks["dec-octet"] = i.cb.decOctet),
            (t.callbacks["dec-digit"] = i.cb.decDigit),
            t.parse(a, "uri-r", e, { errors: [] }).success
          );
        });
    },
    33021: (e, t, s) => {
      ...
      s.r(t),
        s.d(t, {
          ...
          BigNumber: () => l.gH,
          Contract: () => a.Contract,
          ContractFactory: () => a.ContractFactory,
          FixedNumber: () => c.I3,
          Signer: () => n.Signer,
          VoidSigner: () => n.VoidSigner,
          Wallet: () => i.Wallet,
          Wordlist: () => g.b,
          constants: () => h,
          errors: () => d.ErrorCode,
          ethers: () => r,
          getDefaultProvider: () => o.getDefaultProvider,
          logger: () => r.logger,
          providers: () => o,
          utils: () => p,
          version: () => f.r,
    ...
    39336: (e, t, s) => {
      ...
      (t.readInt16BE = function (e, t) {
        ...
        (t.readInt64BE = function (e, t) {
          ...
          var s = o(e, t),
            r = o(e, t + 4);
          return 0x100000000 * s + r - (r >> 31) * 0x100000000;
        }),
        ...
        (t.readInt64LE = function (e, t) {
          void 0 === t && (t = 0);
          var s = l(e, t);
          return 0x100000000 * l(e, t + 4) + s - (s >> 31) * 0x100000000;
        }),
        (t.readUint64LE = function (e, t) {
          void 0 === t && (t = 0);
          var s = c(e, t);
          return 0x100000000 * c(e, t + 4) + s;
        }),
        (t.writeUint64BE = p),
        (t.writeInt64BE = p),
        (t.writeUint64LE = u),
        (t.writeInt64LE = u),
        (t.readUintBE = function (e, t, s) {
          if ((void 0 === s && (s = 0), e % 8 != 0))
            throw Error("readUintBE supports only bitLengths divisible by 8");
          if (e / 8 > t.length - s)
            throw Error(
              "readUintBE: array is too short for the given bitLength"
            );
          for (var r = 0, n = 1, i = e / 8 + s - 1; i >= s; i--)
            (r += t[i] * n), (n *= 256);
          return r;
        }),
        (t.readUintLE = function (e, t, s) {
          if ((void 0 === s && (s = 0), e % 8 != 0))
          ...
          for (var r = 0, n = 1, i = s; i < s + e / 8; i++)
            (r += t[i] * n), (n *= 256);
          return r;
        }),
        (t.writeUintBE = function (e, t, s, n) {
          if (
            (void 0 === s && (s = new Uint8Array(e / 8)),
            void 0 === n && (n = 0),
            e % 8 != 0)
          )
          ...
          for (var i = 1, o = e / 8 + n - 1; o >= n; o--)
            (s[o] = (t / i) & 255), (i *= 256);
          return s;
        }),
        (t.writeUintLE = function (e, t, s, n) {
          if (
            (void 0 === s && (s = new Uint8Array(e / 8)),
            void 0 === n && (n = 0),
            e % 8 != 0)
        ...
        (t.writeFloat32BE = function (e, t, s) {
          return (
            void 0 === t && (t = new Uint8Array(4)),
            void 0 === s && (s = 0),
            new DataView(t.buffer, t.byteOffset, t.byteLength).setFloat32(s, e),
            t
          );
        }),
        (t.writeFloat32LE = function (e, t, s) {
          return (
            void 0 === t && (t = new Uint8Array(4)),
            void 0 === s && (s = 0),
        ...
        (t.writeFloat64BE = function (e, t, s) {
          return (
            void 0 === t && (t = new Uint8Array(8)),
            void 0 === s && (s = 0),
            new DataView(t.buffer, t.byteOffset, t.byteLength).setFloat64(s, e),
            t
          );
        }),
        (t.writeFloat64LE = function (e, t, s) {
          return (
            void 0 === t && (t = new Uint8Array(8)),
            void 0 === s && (s = 0),
    ...
    42947: (e, t, s) => {
      let { Buffer: r } = s(50887),
            ...
            case a:
              if (((e.type = a), t.length >= 2)) {
                if (254 === t[0] && 255 === t[1]) e.bom = 2;
                  ...
                  throw TypeError(
                    `src type: "${a}" specified but BOM is for "${l}"`
                  );
              }
              break;
            case l:
              if (((e.type = l), t.length >= 0))
                if (254 === t[0] && 255 === t[1])
                  throw TypeError(
                    `src type: "${l}" specified but BOM is for "${a}"`
                  );
                else 255 === t[0] && 254 === t[1] && (e.bom = 2);
              break;
            default:
        ...
        M = function (e, t) {
          let s = (function (e) {
            let t = { type: "", base64: !1 },
              s = /^(base64:)?([a-zA-Z0-9]+)$/i.exec(e);
            return (
              s &&
                (s[2] && (t.type = s[2].toUpperCase()),
                s[1] && (t.base64 = !0)),
              t
            );
          })(e.toUpperCase());
          if (s.base64) {
            if (s.type === w)
              throw TypeError(
                `type: "${e} "BASE64:" prefix not allowed with type ${w}`
              );
            if (r.isBuffer(t)) s.data = n.base64.decode(t);
            else if ("string" == typeof t) {
              let e = r.from(t, "ascii");
              s.data = n.base64.decode(e);
            } else
              throw TypeError(
        ...
        L = function (e, t) {
          ...
          let s = (function (e) {
            let t,
              s,
              r = { crlf: !1, lf: !1, base64: !1, type: "" };
            for (;;) {
              if (((s = e), "CRLF:" === (t = e.slice(0, 5)))) {
                (r.crlf = !0), (s = e.slice(5));
                break;
              }
              "LF:" === (t = e.slice(0, 3)) && ((r.lf = !0), (s = e.slice(3)));
              break;
            }
            return (
              1 === (t = s.split(":")).length
          ...
          switch (s.type) {
            ...
            case w:
              if (s.base64)
                throw TypeError(`":BASE64" suffix not allowed with type ${w}`);
              break;
            case u:
              s.type = p;
              break;
        ...
        I = function (e, t) {
          switch (e) {
            case i:
              return n.utf8.encode(t);
            case a:
              return n.utf16be.encode(t);
            case l:
              return n.utf16le.encode(t);
            case h:
              return n.utf32be.encode(t);
            case d:
              return n.utf32le.encode(t);
            case p:
              return n.uint7.encode(t);
            case g:
              return n.uint8.encode(t);
            case y:
              return n.uint16be.encode(t);
            case b:
              return n.uint16le.encode(t);
            case x:
              return n.uint32be.encode(t);
            case A:
              return n.uint32le.encode(t);
            case w:
              return n.string.encode(t);
            case E:
              return n.escaped.encode(t);
            default:
        ...
        $ = function (e) {
          switch (e.type) {
            case i:
              return n.utf8.decode(e.data, e.bom);
            case l:
              return n.utf16le.decode(e.data, e.bom);
            case a:
              return n.utf16be.decode(e.data, e.bom);
            case h:
              return n.utf32be.decode(e.data, e.bom);
            case d:
              return n.utf32le.decode(e.data, e.bom);
            case p:
              return n.uint7.decode(e.data);
            case g:
              return n.uint8.decode(e.data);
            case y:
              return n.uint16be.decode(e.data);
            case b:
              return n.uint16le.decode(e.data);
            case x:
              return n.uint32be.decode(e.data);
            case A:
              return n.uint32le.decode(e.data);
            case w:
              return n.string.decode(e.data);
            case E:
              return n.escaped.decode(e.data);
            default:
      ...
      (t.decode = function (e, t) {
        ...
        (t.encode = function (e, t) {
          ...
          return (
            i.crlf
              ? ((s = n.lineEnds.crlf(t)), (r = I(i.type, s)))
              : i.lf
              ? ((s = n.lineEnds.lf(t)), (r = I(i.type, s)))
              : (r = I(i.type, t)),
            i.base64 && (r = n.base64.encode(r)),
            r
          );
        }),
        (t.convert = function (e, s, r) {
          return t.encode(r, t.decode(e, s));
        });
    },
    43424: (e, t) => {
      "use strict";
    ...
    50005: (e, t, s) => {
      ...
      (t.isEIP55Address = (e) => {
        ...
        let t = `${e}`.toLowerCase().replace("0x", ""),
          s = (0, n.bytesToHex)((0, r.keccak_256)(t)),
          i = "0x";
        for (let e = 0; e < t.length; e++)
          parseInt(s[e], 16) >= 8 ? (i += t[e].toUpperCase()) : (i += t[e]);
        return e === i;
      }),
    ...
    52032: (e, t, s) => {
      e.exports = function () {
        let e = s(58109),
          ...
          m = [],
          b = [],
          y = `<span class="${t.CLASS_LINEEND}">&bull;</span>`,
          T = `<span class="${t.CLASS_LINEEND}">&hellip;</span>`,
          ...
          x = function () {
            ...
            if (0 === t) return void e(!1);
            for (let t in o.filter.operators) {
              let s = t.toUpperCase();
              if ("<ALL>" === s) return void e(!0);
              if ("<NONE>" === s) return void e(!1);
            }
            for (let t in (e(!1), o.filter.operators)) {
              let e = t.toUpperCase();
              if ("ALT" === e) m[n.ALT] = !0 === o.filter.operators[t];
              else if ("CAT" === e) m[n.CAT] = !0 === o.filter.operators[t];
              else if ("REP" === e) m[n.REP] = !0 === o.filter.operators[t];
              else if ("AND" === e) m[n.AND] = !0 === o.filter.operators[t];
              else if ("NOT" === e) m[n.NOT] = !0 === o.filter.operators[t];
              else if ("TLS" === e) m[n.TLS] = !0 === o.filter.operators[t];
              else if ("TBS" === e) m[n.TBS] = !0 === o.filter.operators[t];
              else if ("TRG" === e) m[n.TRG] = !0 === o.filter.operators[t];
              else if ("BKR" === e) m[n.BKR] = !0 === o.filter.operators[t];
              else if ("BKA" === e) m[n.BKA] = !0 === o.filter.operators[t];
              else if ("BKN" === e) m[n.BKN] = !0 === o.filter.operators[t];
              else if ("ABG" === e) m[n.ABG] = !0 === o.filter.operators[t];
              else if ("AEN" === e) m[n.AEN] = !0 === o.filter.operators[t];
              else
                throw Error(
                  `${i}initOpratorFilter: '${t}' not a valid operator name. Must be <all>, <none>, alt, cat, rep, tls, tbs, trg, and, not, bkr, bka or bkn`
                );
            }
          },
          E = function () {
            let e,
              ...
              s = function (e) {
                (m[n.RNM] = e), (m[n.UDT] = e);
                let t = f.length + g.length;
                b.length = 0;
                for (let s = 0; s < t; s += 1) b.push(e);
              },
              r = [];
            for (t = 0; t < f.length; t += 1) r.push(f[t].lower);
            for (t = 0; t < g.length; t += 1) r.push(g[t].lower);
            for (let t in ((b.length = 0), (e = 0), o.filter.rules)) e += 1;
            if (0 === e) return void s(!0);
            for (let e in o.filter.rules) {
              let t = e.toLowerCase();
              if ("<all>" === t) return void s(!0);
            ...
            o.filter.rules)) {
              ...
              if ((t = r.indexOf(s)) < 0)
                throw Error(
                  `${i}initRuleFilter: '${e}' not a valid rule or udt name`
                );
        ...
        (this.traceObject = "traceObject"),
          ...
          (this.setMaxRecords = function (e, t) {
            if (((c = -1), "number" == typeof e && e > 0)) l = Math.ceil(e);
            else {
              l = 0;
              return;
            }
        ...
        let w = function (e) {
            return e.type === n.RNM
              ? !!m[e.type] && !!b[e.index]
              : e.type === n.UDT
              ? !!m[e.type] && !!b[f.length + e.index]
              : m[e.type];
          },
          C = function (e) {
            return -1 === c || !!(e <= c);
          };
        (this.down = function (e, t, s, n, i, o) {
          C(h) &&
            w(e) &&
            (p.push(h),
            (a[r.increment()] = {
        ...
        let k = function () {
          ...
          function l(t, s) {
            ...
            if (s)
              switch (
                ((t.op = { id: s.type, name: e.opcodeToString(s.type) }),
                (t.opData = void 0),
                s.type)
              ) {
                case n.RNM:
                  t.opData = f[s.index].name;
                  break;
                case n.UDT:
                  t.opData = g[s.index].name;
                  break;
                case n.BKR:
                  (r =
                    s.index < f.length
                      ? f[s.index].name
                      : g[s.index - f.length].name),
                    (i = s.bkrCase === n.BKR_MODE_CI ? "%i" : "%s"),
                    (o = s.bkrMode === n.BKR_MODE_UM ? "%u" : "%p"),
                    (t.opData = `\\\\${i}${o}${r}`);
                  break;
                case n.TLS:
                  t.opData = [];
                  for (let e = 0; e < s.string.length; e += 1)
                    t.opData.push(s.string[e]);
                  break;
                case n.TBS:
                  t.opData = [];
                  for (let e = 0; e < s.string.length; e += 1)
          ...
          function p(t, s, r) {
            ...
            return (
              s
                ? ((n.down = !0),
                  (n.state = { id: s.state, name: e.stateToString(s.state) }),
                  (n.phrase = null),
                  l(n, s.opcode))
                : ((n.state = { id: void 0, name: void 0 }),
                  (n.phrase = c()),
                  l(n, void 0)),
              n
            );
          ...
          function m(t, s) {
            s &&
              ((t.up = !0),
              (t.state = { id: s.state, name: e.stateToString(s.state) }),
              (t.phrase = c(s.state, s.phraseIndex, s.phraseLength)),
              t.down || l(t, s.opcode));
          }
          let b = 0,
            y = -1,
          ...
          for (
            A.push(E),
              s = E,
              r.forEach((e) => {
                if (((o = a[e]), x && ((x = !1), o.depth > 0))) {
                  let e = o.dirUp ? o.depth + 1 : o.depth;
                  for (let t = 0; t < e; t += 1)
                    (i = s), (s = p(s, null, t)), A.push(s), i.children.push(s);
                }
                o.dirUp
                  ? (m((s = A.pop()), o), (s = A[A.length - 1]))
                  : ((i = s),
                    (s = p(s, o, o.depth)),
                    A.push(s),
                    i.children.push(s));
          ...
          let w = (t = E.children[0]);
          for (; t && !t.down && !t.up; ) (w = t), (t = t.children[0]);
          ((t = w).leftMost = !0),
            (t.rightMost = !0),
            (function e(t) {
              if (
                ...
                for (let s = 0; s < t.children.length; s += 1)
                  s > 0 && (T += 1),
                    (t.children[s].leftMost = !1),
                    (t.children[s].rightMost = !1),
                    t.leftMost && (t.children[s].leftMost = 0 === s),
                    t.rightMost &&
                      (t.children[s].rightMost = s === t.children.length - 1),
                    e(t.children[s]);
              y -= 1;
            })(t),
            (t.branch = 0);
          let C = {};
          C.string = [];
          for (let e = 0; e < u.length; e += 1) C.string[e] = u[e];
          C.rules = [];
          for (let e = 0; e < f.length; e += 1) C.rules[e] = f[e].name;
          C.udts = [];
          for (let e = 0; e < g.length; e += 1) C.udts[e] = g[e].name;
          return (
            (C.id = {}),
            (C.id.ALT = { id: n.ALT, name: "ALT" }),
            (C.id.CAT = { id: n.CAT, name: "CAT" }),
            (C.id.REP = { id: n.REP, name: "REP" }),
            (C.id.RNM = { id: n.RNM, name: "RNM" }),
            (C.id.TLS = { id: n.TLS, name: "TLS" }),
            (C.id.TBS = { id: n.TBS, name: "TBS" }),
            (C.id.TRG = { id: n.TRG, name: "TRG" }),
            (C.id.UDT = { id: n.UDT, name: "UDT" }),
            (C.id.AND = { id: n.AND, name: "AND" }),
            (C.id.NOT = { id: n.NOT, name: "NOT" }),
            (C.id.BKR = { id: n.BKR, name: "BKR" }),
            (C.id.BKA = { id: n.BKA, name: "BKA" }),
            (C.id.BKN = { id: n.BKN, name: "BKN" }),
            (C.id.ABG = { id: n.ABG, name: "ABG" }),
            (C.id.AEN = { id: n.AEN, name: "AEN" }),
            (C.id.ACTIVE = { id: n.ACTIVE, name: "ACTIVE" }),
            (C.id.MATCH = { id: n.MATCH, name: "MATCH" }),
            (C.id.EMPTY = { id: n.EMPTY, name: "EMPTY" }),
            (C.id.NOMATCH = { id: n.NOMATCH, name: "NOMATCH" }),
            (C.treeDepth = d),
            (C.leafNodes = b),
            (C.branchesIncomplete = t.down
              ? t.up
                ? "none"
                : "right"
              : t.up
              ? "left"
              : "both"),
            (C.tree = (function e(t, s) {
              let r,
                n = {};
              if (
                ((n.id = t.id),
                (n.branch = t.branch),
                (n.leftMost = t.leftMost),
                (n.rightMost = t.rightMost),
                (r = t.state.name ? t.state.name : "ACTIVE"),
                (n.state = { id: t.state.id, name: r }),
                (r = t.op.name ? t.op.name : "?"),
                (n.op = { id: t.op.id, name: r }),
              ...
              for (let r = 0; r < t.children.length; r += 1) {
                let i = r !== t.children.length - 1;
                n.children[r] = e(t.children[r], s, i);
              }
              return n;
            })(t, t.depth, !1)),
            C
        ...
        (this.toTree = function (e) {
          ...
          (this.toHtmlPage = function (t, s, r) {
            return e.htmlToPage(this.toHtml(t, s), r);
          });
        let S = function (e, s) {
            let r;
            switch (e) {
              ...
              case 32:
                ...
                break;
              default:
                throw Error(`${i}htmlHeader: unrecognized mode: ${e}`);
            }
            let n = "";
            return (
              (n += `<p>display mode: ${r}</p>
<table class="${t.CLASS_TRACE}">
`),
              "string" == typeof s && (n += `<caption>${s}</caption>`),
              n
            );
          },
          M = function () {
...
`
        ...
        let L = function (e, t) {
            ...
            if (t.type === n.TRG)
              if (16 === e || 32 === e) {
                let r = t.min.toString(16).toUpperCase();
                r.length % 2 != 0 && (r = `0${r}`),
                  (s += 16 === e ? "%x" : "U+"),
                  (s += r),
                  (r = t.max.toString(16).toUpperCase()).length % 2 != 0 &&
                    (r = `0${r}`),
                  (s += `&ndash;${r}`);
              } else s = `%d${t.min.toString(10)}&ndash;${t.max.toString(10)}`;
            return s;
          },
          I = function (e, t) {
            let s = "";
            if (t.type === n.REP)
              if (16 === e) {
                ...
                e.length % 2 != 0 && (e = `0${e}`),
                  (s = `x${e}`),
                  t.max < 1 / 0
                    ? (e = t.max.toString(16).toUpperCase()).length % 2 != 0 &&
                      (e = `0${e}`)
                    : (e = "inf"),
                  (s += `&ndash;${e}`);
              } else
          ...
          $ = function (e, t) {
            let s = "";
            if (t.type === n.TBS) {
              let r = Math.min(t.string.length, 10);
              if (16 === e || 32 === e) {
                s += 16 === e ? "%x" : "U+";
                for (let e = 0; e < r; e += 1) {
                  let r;
                  e > 0 && (s += "."),
                    (r = t.string[e].toString(16).toUpperCase()).length % 2 !=
                      0 && (r = `0${r}`),
                    (s += r);
                }
              } else {
                s = "%d";
                for (let e = 0; e < r; e += 1)
                  e > 0 && (s += "."), (s += t.string[e].toString(10));
              }
              r < t.string.length && (s += T);
            }
            return s;
          },
          v = function (t, s) {
            let r = "";
            if (s.type === n.TLS) {
              let n = Math.min(s.string.length, 5);
              if (16 === t || 10 === t) {
                let e, i, o;
                16 === t ? ((r = "%x"), (o = 16)) : ((r = "%d"), (o = 10));
                for (let t = 0; t < n; t += 1)
                  t > 0 && (r += "."),
                    (i = s.string[t]) >= 97 && i <= 122
                      ? ((e = i - 32),
                        (r += `${e.toString(o)}/${i.toString(
                          o
                        )}`.toUpperCase()))
                      : i >= 65 && i <= 90
                      ? ((e = i),
                      ...
                      : (r += i.toString(o).toUpperCase());
                n < s.string.length && (r += T);
              } else {
                r = '"';
                for (let t = 0; t < n; t += 1) r += e.asciiChars[s.string[t]];
                n < s.string.length && (r += T), (r += '"');
              }
            }
            return r;
          },
          N = function (t, s, r, n, i) {
            if (0 === n) return "";
            let o = "",
              a = i ? "," : "";
            switch (t) {
              case 16:
                o = a + e.charsToHex(s, r, n);
                break;
              case 10:
                if (i) return `,${e.charsToDec(s, r, n)}`;
                o = a + e.charsToDec(s, r, n);
                break;
              case 32:
                o = e.charsToUnicode(s, r, n);
                break;
              default:
                o = e.charsToAsciiHtml(s, r, n);
            }
            return o;
          },
          B = function (e, s, r, i, o, a) {
            let l,
              c,
              h,
              d,
            ...
            return (
              ...
              c > 80
                ? ((c = 80), (u = T), (d = 0))
                : c + d > 80 && ((u = T), (d = 80 - c)),
              c > 0 && ((p += f), (p += N(e, s, l, c, b)), (p += m), (b = !0)),
              d > 0 && ((p += g), (p += N(e, s, h, d, b)), (p += m)),
              p + u
            );
          },
          O = function (e, s, r, i, o, a) {
            let l,
              c,
              h,
              d,
            ...
            switch (r) {
              ...
              case n.NOMATCH:
              case n.ACTIVE:
                (l = i), (c = 0), (h = i), (d = s.length - h);
                break;
              case n.MATCH:
                (l = i), (h = i + (c = o)), (d = s.length - h);
                break;
              default:
                throw Error("unrecognized state");
            }
            return (
              ...
              c > 80
                ? ((c = 80), (u = T), (d = 0))
                : c + d > 80 && ((u = T), (d = 80 - c)),
              c > 0 && ((p += a), (p += N(e, s, l, c, m)), (p += g), (m = !0)),
              d > 0 && ((p += f), (p += N(e, s, h, d, m)), (p += g)),
              p + u
            );
          },
          H = function (s) {
            ...
            return (
              ...
              (m += "<th>operator</th><th>phrase</th></tr>\n"),
              r.forEach((r) => {
                var b, y, T, A;
                let x = a[r];
                switch (
                  ((i = x.thisLine),
                  (l = void 0 !== x.thatLine ? x.thatLine : "--"),
                  (c = !1),
                  (h = !1),
                  (d = !1),
                  x.lookAround === n.LOOKAROUND_AHEAD &&
                    ((c = !0), (d = !0), (p = x.lookAnchor)),
                  (x.opcode.type === n.AND || x.opcode.type === n.NOT) &&
                    ((c = !0), (d = !0), (p = x.phraseIndex)),
                  x.lookAround === n.LOOKAROUND_BEHIND &&
                    ((h = !0), (d = !0), (p = x.lookAnchor)),
                  (x.opcode.type === n.BKA || x.opcode.type === n.BKN) &&
                    ((h = !0), (d = !0), (p = x.phraseIndex)),
                  (m += "<tr>"),
                  (m += `<td>${i}</td><td>${l}</td>`),
                  (m += `<td>${x.phraseIndex}</td>`),
                  (m += `<td>${x.phraseLength}</td>`),
                  (m += `<td>${x.depth}</td>`),
                  (m += "<td>"),
                  x.state)
                ) {
                ...
                if (
                  ...
                  (m += o.indent(x.depth)),
                  c
                    ? (m += `<span class="${t.CLASS_LOOKAHEAD}">`)
                    : h && (m += `<span class="${t.CLASS_LOOKBEHIND}">`),
                  (m += e.opcodeToString(x.opcode.type)),
                  x.opcode.type === n.RNM &&
                    (m += `(${f[x.opcode.index].name}) `),
                  x.opcode.type === n.BKR)
                ) {
                  let e = x.opcode.bkrCase === n.BKR_MODE_CI ? "%i" : "%s",
                    t = x.opcode.bkrMode === n.BKR_MODE_UM ? "%u" : "%p";
                  m += `(\\${e}${t}${f[x.opcode.index].name}) `;
                }
                (x.opcode.type === n.UDT &&
                  (m += `(${g[x.opcode.index].name}) `),
                x.opcode.type === n.TRG && (m += `(${L(s, x.opcode)}) `),
                x.opcode.type === n.TBS && (m += `(${$(s, x.opcode)}) `),
                x.opcode.type === n.TLS && (m += `(${v(s, x.opcode)}) `),
                x.opcode.type === n.REP && (m += `(${I(s, x.opcode)}) `),
                d && (m += "</span>"),
                (m += "</td>"),
                (m += "<td>"),
                h)
                  ? (m += B(s, u, x.state, x.phraseIndex, x.phraseLength, p))
                  : c
                  ? (m +=
                      ((b = u),
                      (y = x.state),
    ...
    58109: (e, t, s) => {
      ...
      (t.htmlToPage = function (e, t) {
        if ("string" != typeof e)
          throw Error(`${a}htmlToPage: input HTML is not a string`);
        let s = "";
        return (
          (s += "<!DOCTYPE html>\n"),
          (s += '<html lang="en">\n'),
          ...
          (s += `<title>${"string" != typeof t ? "htmlToPage" : t}</title>
`),
          (s += "<style>\n"),
          (s += i()),
          (s += "</style>\n"),
...
`),
        ...
        (t.parserResultToHtml = function (e, t) {
          ...
          "string" == typeof t && "" !== t && (i = t),
            (s =
              !0 === e.success
                ? `<span class="${r.CLASS_MATCH}">true</span>`
                : `<span class="${r.CLASS_NOMATCH}">false</span>`),
            (n =
              e.state === o.EMPTY
                ? `<span class="${r.CLASS_EMPTY}">EMPTY</span>`
                : e.state === o.MATCH
                ? `<span class="${r.CLASS_MATCH}">MATCH</span>`
                : e.state === o.NOMATCH
                ? `<span class="${r.CLASS_NOMATCH}">NOMATCH</span>`
                : `<span class="${r.CLASS_NOMATCH}">unrecognized</span>`);
          let a = "";
          return (
            (a += `<table class="${r.CLASS_STATE}">
`),
            i &&
              (a += `<caption>${i}</caption>
`),
...
<td><span class="${r.CLASS_MATCH}">true</span> if the parse succeeded,
 <span class="${r.CLASS_NOMATCH}">false</span> otherwise<br><i>NOTE: for success, entire string must be matched</i></td></tr>
<tr><td>parser state</td><td>${n}</td>
<td><span class="${r.CLASS_EMPTY}">EMPTY</span>, <span class="${r.CLASS_MATCH}">MATCH</span> or 
<span class="${r.CLASS_NOMATCH}">NOMATCH</span></td></tr>
...
`)
        ...
        (t.charsToString = function (e, t, s) {
          let r, i;
          if ("number" == typeof t) {
          ...
          if ("number" == typeof s) {
            if (s <= 0) return "";
            i = s > e.length - r ? e.length : r + s;
          } else i = e.length;
          return r < i
            ? n.encode("UTF16LE", e.slice(r, i)).toString("utf16le")
            : "";
        }),
        (t.stringToChars = function (e) {
          return n.decode("STRING", e);
        }),
        ...
        (t.charsToDec = function (e, t, s) {
          let r = "";
          if (!Array.isArray(e))
            throw Error(`${a}charsToDec: input must be an array of integers`);
          let n = l(e.length, t, s);
          if (n.end > n.beg) {
            r += e[n.beg];
            for (let t = n.beg + 1; t < n.end; t += 1) r += `,${e[t]}`;
          }
          return r;
        }),
        (t.charsToHex = function (e, s, r) {
          let n = "";
          if (!Array.isArray(e))
            throw Error(`${a}charsToHex: input must be an array of integers`);
          let i = l(e.length, s, r);
          if (i.end > i.beg) {
            n += `\\x${t.charToHex(e[i.beg])}`;
            for (let s = i.beg + 1; s < i.end; s += 1)
              n += `,\\x${t.charToHex(e[s])}`;
          }
          return n;
        }),
        (t.charsToHtmlEntities = function (e, t, s) {
          let r = "";
          if (!Array.isArray(e))
            throw Error(`${a}charsToHex: input must be an array of integers`);
          let n = l(e.length, t, s);
          if (n.end > n.beg)
            for (let t = n.beg; t < n.end; t += 1)
              r += `&#x${e[t].toString(16)};`;
          return r;
        }),
        (t.charsToUnicode = function (e, s, r) {
          let n = "";
          if (!Array.isArray(e))
            throw Error(
              `${a}charsToUnicode: input must be an array of integers`
            );
          let i = l(e.length, s, r);
          if (i.end > i.beg)
            for (let s = i.beg; s < i.end; s += 1) {
              var o;
              +(((o = e[s]) >= 55296 && o <= 57343) || o > 1114111)
                ? (n += ` U+${t.charToHex(e[s])}`)
                : (n += `&#${e[s]};`);
            }
          return n;
        }),
        (t.charsToJsUnicode = function (e, s, r) {
          let n = "";
          if (!Array.isArray(e))
            throw Error(
              `${a}charsToJsUnicode: input must be an array of integers`
            );
          let i = l(e.length, s, r);
          if (i.end > i.beg) {
            n += `\\u${t.charToHex(e[i.beg])}`;
            for (let s = i.beg + 1; s < i.end; s += 1)
              n += `,\\u${t.charToHex(e[s])}`;
          }
          return n;
        }),
        (t.charsToAscii = function (e, s, r) {
          let n = "";
          if (!Array.isArray(e))
            throw Error(`${a}charsToAscii: input must be an array of integers`);
          let i = l(e.length, s, r);
          for (let s = i.beg; s < i.end; s += 1) {
            let r = e[s];
            r >= 32 && r <= 126
        ...
        (t.charsToAsciiHtml = function (e, s, n) {
          let i;
          if (!Array.isArray(e))
            throw Error(
              `${a}charsToAsciiHtml: input must be an array of integers`
            );
          let o = "",
            c = l(e.length, s, n);
          for (let s = c.beg; s < c.end; s += 1)
            (i = e[s]) < 32 || 127 === i
              ? (o += `<span class="${r.CLASS_CTRLCHAR}">${t.asciiChars[i]}</span>`)
              : i > 127
              ? (o += `<span class="${r.CLASS_CTRLCHAR}">U+${t.charToHex(
                  i
                )}</span>`)
              : (o += t.asciiChars[i]);
          return o;
    ...
    60295: (e) => {
      e.exports = function () {
        ...
        (this.init = function (s) {
          ...
          (this.getListIndex = function (s) {
            return -1 === e || s < 0 || s > e || e - s >= t ? -1 : (s + t) % t;
          }),
          (this.forEach = function (s) {
            if (-1 !== e) {
              if (e < t) {
                for (let t = 0; t <= e; t += 1) s(t, t);
                return;
              }
              for (let r = e - t + 1; r <= e; r += 1) s((r + t) % t, r);
            }
          });
      };
    },
      ...
      class a {
          ...
          if ("string" == typeof e) {
            ...
            (this.scheme = null == e ? void 0 : e.scheme),
              ...
              "string" == typeof this.chainId &&
                (this.chainId = (0, r.parseIntegerNumber)(this.chainId)),
              (this.nonce = this.nonce || (0, o.generateNonce)()),
              new r.ParsedMessage(this.prepareMessage());
        }
        toMessage() {
          let e = this.scheme ? `${this.scheme}://${this.domain}` : this.domain,
            t = `${e} wants you to sign in with your Ethereum account:`,
            s = `URI: ${this.uri}`,
            r = [t, this.address].join("\n"),
            n = `Version: ${this.version}`;
          this.nonce || (this.nonce = (0, o.generateNonce)());
          let i = [s, n, "Chain ID: " + this.chainId, `Nonce: ${this.nonce}`];
          if (
            ((this.issuedAt = this.issuedAt || new Date().toISOString()),
            i.push(`Issued At: ${this.issuedAt}`),
            this.expirationTime)
          ) {
            let e = `Expiration Time: ${this.expirationTime}`;
            i.push(e);
          }
          this.notBefore && i.push(`Not Before: ${this.notBefore}`),
            this.requestId && i.push(`Request ID: ${this.requestId}`),
            this.resources &&
              i.push(
          ...
          let a = i.join("\n");
          return (
            (r = [r, this.statement].join("\n\n")),
            void 0 !== this.statement && (r += "\n"),
            [r, a].join("\n")
          );
        }
        prepareMessage() {
        ...
        async verify(e, t = { suppressExceptions: !1 }) {
          return new Promise((s, r) => {
            ...
            let h,
              d,
              p = (e) => (t.suppressExceptions ? s(e) : r(e)),
              u = (0, o.checkInvalidKeys)(e, i.VerifyParamsKeys);
            u.length > 0 &&
              p({
                success: !1,
                data: this,
                error: Error(
                  `${u.join(", ")} is/are not valid key(s) for VerifyParams.`
                ),
              });
            let f = (0, o.checkInvalidKeys)(t, i.VerifyOptsKeys);
            f.length > 0 &&
              p({
                success: !1,
                data: this,
                error: Error(
                  `${f.join(", ")} is/are not valid key(s) for VerifyOpts.`
                ),
              });
            let { signature: g, scheme: m, domain: b, nonce: y, time: T } = e;
            m &&
              m !== this.scheme &&
              p({
                success: !1,
                data: this,
                error: new i.SiweError(
                  i.SiweErrorType.SCHEME_MISMATCH,
                  m,
                  this.scheme
                ),
              }),
              b &&
                ...
                p({
                  ...
                  data: this,
                  error: new i.SiweError(
                    i.SiweErrorType.DOMAIN_MISMATCH,
                    b,
                    this.domain
                  ),
                }),
              y &&
                ...
                p({
                  ...
                  data: this,
                  error: new i.SiweError(
                    i.SiweErrorType.NONCE_MISMATCH,
                    y,
                    this.nonce
                  ),
                });
            let A = new Date(T || new Date());
            if (this.expirationTime) {
              ...
              A.getTime() >= e.getTime() &&
                p({
                  ...
                  data: this,
                  error: new i.SiweError(
                    i.SiweErrorType.EXPIRED_MESSAGE,
                    `${A.toISOString()} < ${e.toISOString()}`,
                    `${A.toISOString()} >= ${e.toISOString()}`
                  ),
                });
            }
            if (this.notBefore) {
              ...
              A.getTime() < e.getTime() &&
                p({
                  ...
                  data: this,
                  error: new i.SiweError(
                    i.SiweErrorType.NOT_YET_VALID_MESSAGE,
                    `${A.toISOString()} >= ${e.toISOString()}`,
                    `${A.toISOString()} < ${e.toISOString()}`
                  ),
                });
            ...
            try {
              h = this.prepareMessage();
            } catch (e) {
              p({ success: !1, data: this, error: e });
            }
            try {
              d = (0, n.verifyMessage)(h, g);
            } catch (e) {
              console.error(e);
            }
            if (d === this.address) return s({ success: !0, data: this });
            {
              let r = (0, o.checkContractWalletSignature)(this, g, t.provider)
                .then((e) =>
                  e
                    ? { success: !0, data: this }
                    : {
                        ...
                        data: this,
                        error: new i.SiweError(
                          i.SiweErrorType.INVALID_SIGNATURE,
                          d,
              ...
              Promise.all([
                ...
                (c =
                  null ==
                  (l =
                    null == (a = null == t ? void 0 : t.verificationFallback)
                      ? void 0
                      : a.call(t, e, t, this, r))
                    ? void 0
                    : l.then((e) => e))
                ...
                if (t)
                  if (t.success) return s(t);
                  else p(t);
                else {
                  if (e.success) return s(e);
                  p(e);
                }
              });
            }
    ...
    63579: (e, t, s) => {
      ...
      class n {
        ...
        randomBytes(e) {
          ...
          for (let e = 0; e < s.length; e++) s[e] = t[e];
          return (0, r.wipe)(t), s;
        }
      }
        ...
        (this.callbacks = []),
          ...
          (this.init = function (e, t, s) {
            ...
            (h.length = 0),
              ...
              (o = s);
            let u = [];
            for (p = 0; p < n.length; p += 1) u.push(n[p].lower);
            for (p = 0; p < i.length; p += 1) u.push(i[p].lower);
            for (p = 0, a = n.length + i.length; p < a; p += 1)
              (l[p] = !1), (c[p] = null);
            for (let e in r.callbacks) {
              let t = e.toLowerCase();
              if ((p = u.indexOf(t)) < 0)
                throw Error(`ast.js: init: node '${e}' not a rule or udt name`);
              "function" == typeof r.callbacks[e] &&
                ((l[p] = !0), (c[p] = r.callbacks[e])),
                !0 === r.callbacks[e] && (l[p] = !0);
            }
          }),
          ...
          (this.udtDefined = function (e) {
            return !1 !== l[n.length + e];
          }),
          (this.down = function (t, s) {
            let r = d.length;
            return (
              h.push(r),
              d.push({
          ...
          (this.translate = function (t) {
            ...
            for (let n = 0; n < d.length; n += 1)
              (s = c[(r = d[n]).callbackIndex]),
                r.state === e.SEM_PRE
                  ? null !== s &&
                    s(e.SEM_PRE, o, r.phraseIndex, r.phraseLength, t) ===
                      e.SEM_SKIP &&
                    (n = r.thatIndex)
                  : null !== s &&
                    s(e.SEM_POST, o, r.phraseIndex, r.phraseLength, t);
          }),
          (this.setLength = function (e) {
            (d.length = e),
              e > 0 ? (h.length = d[e - 1].stack) : (h.length = 0);
          }),
          (this.getLength = function () {
            return d.length;
          }),
          (this.toXml = function (s) {
            let r = t.charsToDec,
              n = "decimal integer character codes";
            if ("string" == typeof s && s.length >= 3) {
              let e = s.slice(0, 3).toLowerCase();
              "asc" === e
                ? ((r = t.charsToAscii),
                  (n = "ASCII for printing characters, hex for non-printing"))
                : "hex" === e
                ? ((r = t.charsToHex),
                  (n = "hexadecimal integer character codes"))
                : "uni" === e &&
                  ((r = t.charsToUnicode),
                  (n = "Unicode UTF-32 integer character codes"));
            }
            let i = "",
              a = 0;
            return (
...
`),
              ...
              d.forEach((t) => {
                t.state === e.SEM_PRE
                  ? ((a += 1),
                    (i += p(a)),
                    (i += `<node name="${t.name}" index="${t.phraseIndex}" length="${t.phraseLength}">
`),
                    (i += p(a + 2)),
                    (i += r(o, t.phraseIndex, t.phraseLength)),
                    (i += "\n"))
                  : ((i += p(a)),
                    (i += `</node><!-- name="${t.name}" -->
`),
          ...
          (this.phrases = function () {
            ...
            for (t = 0; t < d.length; t += 1)
              (s = d[t]).state === e.SEM_PRE &&
                (Array.isArray(r[s.name]) || (r[s.name] = []),
                r[s.name].push({
                  index: s.phraseIndex,
                  length: s.phraseLength,
                }));
            return r;
          });
      };
    ...
    69197: (e, t, s) => {
      ...
      "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
        ...
        (t.utf8 = {
          ...
          decode(e, t) {
            let s,
              ...
              h = [];
            for (; c < l; ) {
              for (r = e[c], s = 0xffffffff; ; ) {
                if (r >= 0 && r <= 127) {
                  (s = r), (a = 1);
                  break;
                }
                if ((n = c + 1) < l && r >= 194 && r <= 223) {
                  (s = (function (e, t) {
                    if ((192 & t) != 128) return 0xfffffffd;
                    let s = ((31 & e) << 6) + (63 & t);
                    return s < 128 ? 0xfffffffc : s;
                  })(r, e[n])),
                    (a = 2);
                  break;
                }
                if ((i = c + 2) < l && r >= 224 && r <= 239) {
                  (s = (function (e, t, s) {
                    if ((192 & s) != 128 || (192 & t) != 128) return 0xfffffffd;
                    let r = ((15 & e) << 12) + ((63 & t) << 6) + (63 & s);
                    return r < 2048
                      ? 0xfffffffc
                      : r >= 55296 && r <= 57343
                      ? 0xfffffffe
        ...
        (t.utf16be = {
          encode(e) {
            ...
            for (let r = 0; r < e.length; r += 1)
              if (((t = e[r]) >= 0 && t <= 55295) || (t >= 57344 && t <= 65535))
                i.push((t >> 8) & 255), i.push(255 & t);
              else if (t >= 65536 && t <= 1114111)
                (s = 55296 + ((n = t - 65536) >> 10)),
                  (n = 56320 + (1023 & n)),
                  i.push((s >> 8) & 255),
                  i.push(255 & s),
                  i.push((n >> 8) & 255),
                ...
                throw RangeError(
                  `utf16be.encode: UTF16BE value out of range: char[${r}]: ${t}`
                );
            return r.from(i);
          },
          decode(e, t) {
              ...
              for (;;) {
                if ((n = h + 1) < c) {
                  ...
                  if (
                    ...
                    (s = 65536 + ((o - 55296) << 10) + (a - 56320)), (r = 4);
                    break;
                  }
                }
                throw RangeError(
                  `utf16be.decode: ill-formed UTF16BE byte sequence found: byte[${h}]`
                );
              }
              (l[d++] = s), (h += r);
            }
          ...
          encode(e) {
            ...
            for (let r = 0; r < e.length; r += 1)
              if (((t = e[r]) >= 0 && t <= 55295) || (t >= 57344 && t <= 65535))
                ...
                throw RangeError(
                  `utf16le.encode: UTF16LE value out of range: char[${r}]: ${t}`
                );
            return r.from(i);
          },
          decode(e, t) {
            ...
            for (; h < c; ) {
              for (;;) {
                ...
                throw RangeError(
                  `utf16le.decode: ill-formed UTF16LE byte sequence found: byte[${h}]`
                );
              }
              (l[d++] = s), (h += r);
            }
        ...
        (t.uint7 = {
          encode(e) {
            let t = r.alloc(e.length);
            for (let s = 0; s < e.length; s += 1) {
              if (e[s] > 127)
                throw RangeError(
                  `uint7.encode: UINT7 character code out of range: char[${s}]: ${e[s]}`
                );
              t[s] = e[s];
            }
            return t;
          ...
          decode(e) {
            ...
            for (let s = 0; s < e.length; s += 1) {
              if (e[s] > 127)
                throw RangeError(
                  `uint7.decode: UINT7 character code out of range: byte[${s}]: ${e[s]}`
                );
              t[s] = e[s];
            }
            return t;
        ...
        (t.uint8 = {
          encode(e) {
            ...
            for (let s = 0; s < e.length; s += 1) {
              if (e[s] > 255)
                throw RangeError(
                  `uint8.encode: UINT8 character code out of range: char[${s}]: ${e[s]}`
                );
              t[s] = e[s];
            }
            return t;
        ...
        (t.string = {
          ...
          decode: (e) => t.utf16le.decode(r.from(e, "utf16le"), 0),
        }),
        (t.escaped = {
          encode(e) {
            let t = [];
            for (let s = 0; s < e.length; s += 1) {
              let i = e[s];
              if (96 === i) t.push(i), t.push(i);
              else if (10 === i) t.push(i);
              else if (i >= 32 && i <= 126) t.push(i);
              else {
                let e = "";
                if (i >= 0 && i <= 31) e += `\`x${n[i]}`;
                else if (i >= 127 && i <= 255) e += `\`x${n[i]}`;
                else if (i >= 256 && i <= 65535)
                  e += `\`u${n[(i >> 8) & 255]}${n[255 & i]}`;
                else if (i >= 65536 && i <= 0xffffffff) {
                  e += "`u{";
                  let t = (i >> 24) & 255;
                  t > 0 && (e += n[t]),
                    (e += `${
                      n[(i >> 16) & 255] + n[(i >> 8) & 255] + n[255 & i]
                    }}`);
                } else
                  throw Error(
            ...
            for (; a < o; ) {
              for (;;) {
                ...
                if (120 === e[t]) {
                  if (
                    (s = (function (e, t, s) {
                      let r = { char: null, nexti: e + 2, error: !0 };
                      return (
                        e + 1 < t &&
                          n(s[e]) &&
                          n(s[e + 1]) &&
                          ((r.char = parseInt(
                            String.fromCodePoint(s[e], s[e + 1]),
                            16
                          )),
                          Number.isNaN(r.char) || (r.error = !1)),
                        r
                      );
                    })(t + 1, o, e)).error
                  )
                    break;
                  i.push(s.char), (a = s.nexti), (r = !1);
                  break;
                }
                if (117 === e[t]) {
                  if (123 === e[t + 1]) {
                    if (
                      (s = (function (e, t, s) {
                        let r = { char: null, nexti: e + 4, error: !0 },
                          i = "";
                        for (; e < t && n(s[e]); )
                          (i += String.fromCodePoint(s[e])), (e += 1);
                        return (
                          (r.char = parseInt(i, 16)),
                          125 !== s[e] ||
                            Number.isNaN(r.char) ||
                            (r.error = !1),
                          (r.nexti = e + 1),
              ...
              if (r)
                throw Error(
                  `escaped.decode: ill-formed escape sequence at buf[${a}]`
                );
            }
            return i;
          },
        ...
        (t.lineEnds = {
          crlf(e) {
            ...
            for (; s < e.length; )
              switch (e[s]) {
                case 13:
                  s + 1 < e.length && 10 === e[s + 1] ? (s += 2) : (s += 1),
                    t.push(13),
                    t.push(10);
                  break;
                case 10:
                  t.push(13), t.push(10), (s += 1);
                  break;
                default:
                  t.push(e[s]), (s += 1);
              }
        ...
        (t.base64 = {
          ...
          decode(e) {
            ...
            let i = (function (e) {
                ...
                for (let r = 0; r < e.length; r += 1) {
                  ...
                  for (; 32 !== n && 9 !== n && 10 !== n && 13 !== n; ) {
                    ...
                    throw RangeError(
                      `base64.decode: invalid character buf[${r}]: ${n}`
                    );
                  }
                }
                if (t.length % 4 > 0)
                ...
                switch (s) {
                  ...
                  default:
                    throw RangeError(
                      `base64.decode: more than two tail characters found: ${s}`
                    );
                }
                return { tail: s, buf: r.from(t) };
              })(e),
              { tail: o } = i,
              a = i.buf,
              l = a.length / 4,
            ...
            o > 0 && (l -= 1), (s = 0), (t = 0);
            for (let e = 0; e < l; e += 1)
              (n = (a[t++] << 18) + (a[t++] << 12) + (a[t++] << 6) + a[t++]),
                (c[s++] = (n >> 16) & 255),
                (c[s++] = (n >> 8) & 255),
                (c[s++] = 255 & n);
            return (
              1 === o &&
                ((n = (a[t++] << 18) + (a[t++] << 12) + (a[t] << 6)),
                (c[s++] = (n >> 16) & 255),
                (c[s] = (n >> 8) & 255)),
              2 === o &&
                ((n = (a[t++] << 18) + (a[t++] << 12)),
...
${i}`),
                ...
                String.fromCharCode(e[n + 1]),
                String.fromCharCode(e[n + 2]),
                String.fromCharCode(e[n + 3])
              );
            }
            return t;
          },
    ...
    76460: function (e, t, s) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.cb = void 0);
      let n = r(s(34101)),
        i = n.default.utils,
        o = n.default.ids,
        a = s(50005),
        ...
        c = (e) => {
          let t = l.exec(e);
          if (!t) return !1;
          let s = new Date(t.groups.date).toISOString(),
            r = l.exec(s);
      ...
      t.cb = {
        ...
        lineno: function (e, t, s, r) {
          e.state === o.MATCH && (r.lineno += 1);
        },
        exTitle: function (e, t, s, r) {
          e.state === o.NOMATCH && (r.lineno -= 1);
        },
        nbTitle: function (e, t, s, r) {
          e.state === o.NOMATCH && (r.lineno -= 1);
        },
        riTitle: function (e, t, s, r) {
          e.state === o.NOMATCH && (r.lineno -= 1);
        },
        reTitle: function (e, t, s, r) {
          e.state === o.MATCH
            ? (r.resources = [])
            : e.state === o.NOMATCH && (r.lineno -= 1);
        },
        oscheme: function (e, t, s, r) {
          e.state === o.MATCH &&
            (r.scheme = i.charsToString(t, s, e.phraseLength - 3));
        },
        domain: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.domain = i.charsToString(t, s, e.phraseLength);
              break;
            case o.EMPTY:
              r.errors.push(`line ${r.lineno}: domain cannot be empty`);
              break;
            case o.NOMATCH:
              r.errors.push(`line ${r.lineno}: invalid domain`);
          }
        },
        address: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              (r.address = i.charsToString(t, s, e.phraseLength)),
                (0, a.isEIP55Address)(r.address) ||
                  r.errors.push(
                    `line ${r.lineno}: invalid EIP-55 address - ${r.address}`
                  );
              break;
            case o.NOMATCH:
        ...
        statement: function (e, t, s, r) {
          e.state === o.MATCH &&
            (r.statement = i.charsToString(t, s, e.phraseLength));
        },
        emptyStatement: function (e, t, s, r) {
          e.state === o.MATCH && (r.statement = "");
        },
        version: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.version = i.charsToString(t, s, e.phraseLength);
              break;
            case o.NOMATCH:
              r.errors.push(`line ${r.lineno}: invalid version`);
          }
        },
        nonce: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.nonce = i.charsToString(t, s, e.phraseLength);
              break;
            case o.NOMATCH:
              r.errors.push(`line ${r.lineno}: invalid nonce`);
          }
        },
        issuedAt: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              (r.issuedAt = i.charsToString(t, s, e.phraseLength)),
                c(r.issuedAt) ||
                  r.errors.push(
                    `line ${r.lineno}: invalid issued-at date time semantics`
                  );
              break;
            case o.NOMATCH:
              r.errors.push(
                `line ${r.lineno}: invalid issued-at date time syntax`
              );
          }
        },
        expirationTime: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              (r.expirationTime = i.charsToString(t, s, e.phraseLength)),
                c(r.expirationTime) ||
                  r.errors.push(
                    `line ${r.lineno}: invalid expiration-time date time semantics`
                  );
              break;
            case o.NOMATCH:
              r.errors.push(
                `line ${r.lineno}: invalid expiration-time date time syntax`
              );
          }
        },
        notBefore: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              (r.notBefore = i.charsToString(t, s, e.phraseLength)),
                c(r.notBefore) ||
                  r.errors.push(
                    `line ${r.lineno}: invalid not-before date time semantics`
                  );
              break;
            case o.NOMATCH:
              r.errors.push(
                `line ${r.lineno}: invalid not-before date time syntax`
              );
          }
        },
        requestId: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.requestId = i.charsToString(t, s, e.phraseLength);
              break;
            case o.EMPTY:
              r.requestId = "";
              break;
        ...
        chainId: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.chainId = (0, a.parseIntegerNumber)(
                i.charsToString(t, s, e.phraseLength)
              );
              break;
            case o.NOMATCH:
        ...
        uriR: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.uriR = i.charsToString(t, s, e.phraseLength);
              break;
            case o.NOMATCH:
              r.errors.push(`line ${r.lineno}: invalid resource URI`);
          }
        },
        resource: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
        ...
        scheme: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.uriElements.scheme = i.charsToString(t, s, e.phraseLength);
              break;
            case o.NOMATCH:
              r.errors.push(`line ${r.lineno}: invalid URI scheme`);
          }
        },
        userinfo: function (e, t, s, r) {
          e.state === o.MATCH &&
            (r.uriElements.userinfo = i.charsToString(
              t,
              s,
              e.phraseLength - 1
            ));
        },
        host: function (e, t, s, r) {
          switch (e.state) {
            case o.ACTIVE:
              r.iplit = !1;
              break;
            case o.MATCH:
              r.iplit
                ? (r.uriElements.host = i.charsToString(
                    t,
                    s + 1,
                    e.phraseLength - 2
                  ))
                : (r.uriElements.host = i.charsToString(t, s, e.phraseLength));
              break;
            case o.EMPTY:
              r.uriElements.host = "";
              break;
        ...
        ipLiteral: function (e, t, s, r) {
          e.state === o.MATCH && (r.iplit = !0);
        },
        port: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.uriElements.port = (0, a.parseIntegerNumber)(
                i.charsToString(t, s, e.phraseLength)
              );
              break;
            case o.EMPTY:
        ...
        pathAbempty: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.uriElements.path = i.charsToString(t, s, e.phraseLength);
              break;
            case o.EMPTY:
              r.uriElements.path = "";
              break;
        ...
        pathAbsolute: function (e, t, s, r) {
          e.state === o.MATCH &&
            (r.uriElements.path = i.charsToString(t, s, e.phraseLength));
        },
        pathRootless: function (e, t, s, r) {
          e.state === o.MATCH &&
            (r.uriElements.path = i.charsToString(t, s, e.phraseLength));
        },
        pathEmpty: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
            case o.NOMATCH:
              r.errors.push(
                `line ${r.lineno}: invalid URI - path-empty must be empty`
              );
              break;
            case o.EMPTY:
              r.uriElements.path = "";
        ...
        query: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.uriElements.query = i.charsToString(t, s, e.phraseLength);
              break;
            case o.EMPTY:
              r.uriElements.query = "";
              break;
        ...
        fragment: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.uriElements.fragment = i.charsToString(t, s, e.phraseLength);
              break;
            case o.EMPTY:
        ...
        uri: function (e, t, s, r) {
          switch (e.state) {
            case o.MATCH:
              r.uri = i.charsToString(t, s, e.phraseLength);
              break;
            case o.EMPTY:
            case o.NOMATCH:
        ...
        ipv4: function (e, t, s, r) {
          e.state === o.MATCH && (r.ipv4 = !0);
        },
        h16: function (e, t, s, r) {
          e.state === o.MATCH && (r.h16count += 1);
        },
        nodcolon: function (e, t, s, r) {
          switch (e.state) {
            case o.ACTIVE:
            ...
            case o.MATCH:
              r.ipv4
                ? 6 === r.h16count
                  ? (e.state = o.MATCH)
                  : ((e.state = o.NOMATCH), (e.phraseLength = 0))
                : 8 === r.h16count
                ? (e.state = o.MATCH)
                : ((e.state = o.NOMATCH), (e.phraseLength = 0));
          }
        },
        dcolon: function (e, t, s, r) {
          switch (e.state) {
            case o.ACTIVE:
              (r.h16count = 0), (r.ipv4 = !1);
              break;
        ...
        decDigit: function (e, t, s, r) {
          e.state === o.MATCH && (r.octet = 10 * r.octet + t[s] - 48);
        },
      };
    },
    83228: function (e, t, s) {
      "use strict";
      var r =
          (this && this.__createBinding) ||
          (Object.create
      ...
      Object.defineProperty(t, "ParsedMessage", {
        enumerable: !0,
        get: function () {
          return i.ParsedMessage;
        },
      });
      let o = s(24867);
      Object.defineProperty(t, "isUri", {
        enumerable: !0,
        get: function () {
          return o.isUri;
        },
    ...
    91847: (e, t, s) => {
      ...
      let r = s(33021),
        ...
        o = null;
      try {
        (n = r.ethers.utils.verifyMessage),
          (i = r.ethers.utils.hashMessage),
          (o = r.ethers.utils.getAddress);
      } catch (e) {
        (n = r.ethers.verifyMessage),
          (i = r.ethers.hashMessage),
          (o = r.ethers.getAddress);
      }
      (t.verifyMessage = n), (t.hashMessage = i), (t.getAddress = o);
    },
    94645: (e, t, s) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      let r = s(11224),
        ...
        a =
          /^(?<date>[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))[Tt]([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(.[0-9]+)?(([Zz])|([+|-]([01][0-9]|2[0-3]):[0-5][0-9]))$/;
      (t.checkContractWalletSignature = async (e, t, s) => {
        if (!s) return !1;
        let r = new n.Contract(e.address, o, s),
          a = (0, i.hashMessage)(e.prepareMessage());
        return (await r.isValidSignature(a, t)) === "0x1626ba7e";
      }),
        (t.generateNonce = () => {
          let e = (0, r.randomStringForEntropy)(96);
