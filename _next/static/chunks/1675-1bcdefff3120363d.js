try {
  !(function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "9b136be0-ef27-48a6-af57-4163f3b46a48"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-9b136be0-ef27-48a6-af57-4163f3b46a48"));
  })();
} catch (e) {}
("use strict");
    ...
    91675: (e, t, r) => {
        ...
        let c = e + "CollectionSlot",
          ...
          p = f.forwardRef((e, t) => {
            let { scope: r, children: i } = e,
              s = n(c, r),
              l = (0, o.s)(t, s.collectionRef);
            return (0, a.jsx)(d, { ref: l, children: i });
          });
        p.displayName = c;
        let y = e + "CollectionItemSlot",
          ...
          w = f.forwardRef((e, t) => {
            ...
            return (
              f.useEffect(
                () => (
                  u.itemMap.set(l, { ref: l, ...s }),
                  () => void u.itemMap.delete(l)
                )
              ),
              (0, a.jsx)(v, { ...{ [g]: "" }, ref: h, children: i })
            );
          });
        return (
          (w.displayName = y),
          [
            { Provider: l, Slot: p, ItemSlot: w },
            function (t) {
              let r = n(e + "CollectionConsumer", t);
      ...
      (l = new WeakMap()),
        class e extends Map {
          ...
          insert(e, t, r) {
            ...
            for (let e = o; e < a; e++)
              if (o === e) {
                ...
                let r = c[d ? e : e - 1],
                  s = i;
                (i = this.get(r)), this.delete(r), this.set(r, s);
              }
            return this;
          }
          with(t, r, i) {
            let s = new e(this);
            return s.insert(t, r, i), s;
          }
          before(e) {
            let t = s(this, l).indexOf(e) - 1;
            if (!(t < 0)) return this.entryAt(t);
          }
          setBefore(e, t, r) {
            let i = s(this, l).indexOf(e);
            return -1 === i ? this : this.insert(i, t, r);
          }
          after(e) {
            let t = s(this, l).indexOf(e);
          ...
          clear() {
            return n(this, l, []), super.clear();
          }
          delete(e) {
            let t = super.delete(e);
            return t && s(this, l).splice(s(this, l).indexOf(e), 1), t;
          }
          deleteAt(e) {
            let t = this.keyAt(e);
          ...
          filter(t, r) {
            let i = [],
              s = 0;
            for (let e of this)
              Reflect.apply(t, r, [e, s, this]) && i.push(e), s++;
            return new e(i);
          }
          map(t, r) {
            let i = [],
              s = 0;
            for (let e of this)
              i.push([e[0], Reflect.apply(t, r, [e, s, this])]), s++;
            return new e(i);
          }
          reduce() {
            ...
            let [i, s] = t,
              n = 0,
              l = null != s ? s : this.at(0);
            for (let e of this)
              (l =
                0 === n && 1 === t.length
                  ? e
                  : Reflect.apply(i, this, [l, e, n, this])),
                n++;
            return l;
          }
          reduceRight() {
            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++)
              t[r] = arguments[r];
            let [i, s] = t,
              n = null != s ? s : this.at(-1);
            for (let e = this.size - 1; e >= 0; e--) {
              let r = this.at(e);
              n =
                e === this.size - 1 && 1 === t.length
                  ? r
                  : Reflect.apply(i, this, [n, r, e, this]);
            }
            return n;
          }
          toSorted(t) {
          ...
          constructor(e) {
            super(e),
              (function (e, t, r) {
                ...
                t.set(e, r);
              })(this, l, { writable: !0, value: void 0 }),
              n(this, l, [...super.keys()]),
              d.set(this, !0);
          }
        };
